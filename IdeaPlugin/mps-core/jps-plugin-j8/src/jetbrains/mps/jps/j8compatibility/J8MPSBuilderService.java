...
// if MPSBuilderService is changed (e.g. overrides another method), this class should be changed accordingly
public class J8MPSBuilderService extends BuilderService {
  ...
  public List<? extends ModuleLevelBuilder> createModuleLevelBuilders() {
    ...
    synchronized (this) {
      if (myDelegate == null) {
        myDelegate = new MPSBuilderService();
      }
    }
    return ((MPSBuilderService) myDelegate).createModuleLevelBuilders();
  }
}
