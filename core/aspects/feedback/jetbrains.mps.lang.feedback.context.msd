...
<solution name="jetbrains.mps.lang.feedback.context" uuid="9e98f4e2-decf-4e97-bf80-9109e8b759aa" moduleVersion="0">
  <compileInIDEA />
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/lib/mps-context.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
