...
<solution name="jetbrains.mps.lang.feedback.problem.legacy-constraints" uuid="aaaaf3e2-decf-4e97-bf80-9109eab759ee" moduleVersion="0">
  <compileInIDEA />
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/lib/mps-messages-for-legacy-constraints.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
