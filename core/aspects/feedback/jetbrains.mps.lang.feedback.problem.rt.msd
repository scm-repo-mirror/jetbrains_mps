...
<solution name="jetbrains.mps.lang.feedback.problem.rt" uuid="3f98f4e2-decf-4e97-bf80-9109e8b759ab" moduleVersion="0">
  <compileInIDEA />
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/lib/mps-problem.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
