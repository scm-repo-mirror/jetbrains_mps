...
<solution name="jetbrains.mps.lang.feedback.problem.rules" uuid="0a98f3e2-decf-4e97-bf80-9109eccc59bb" moduleVersion="0">
  <compileInIDEA />
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/lib/mps-messages-for-rules.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
