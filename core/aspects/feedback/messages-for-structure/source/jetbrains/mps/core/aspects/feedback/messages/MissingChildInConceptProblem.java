...
@Immutable
public final class MissingChildInConceptProblem implements Problem {
  private static final ProblemKind KIND = PredefinedStructureProblemKind.MISSING_CHILD;
  private final ProblemId myId;
  private final SNodeReference mySourceNode;

  public MissingChildInConceptProblem(@NotNull SAbstractConcept concept,
