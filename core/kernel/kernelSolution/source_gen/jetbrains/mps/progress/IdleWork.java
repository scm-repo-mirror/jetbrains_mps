...
public interface IdleWork {
  ...
  class Support {
    ...
    public static IdleWork execute(Runnable runnable, Executor executor) {
      return new ExecutableWork(runnable, executor);
    }
  }
  ...
  class ExecutableWork implements IdleWork {
    private final Runnable myRunnable;
    private Executor myExecutor;
    public ExecutableWork(Runnable runnable, Executor executor) {
      this.myRunnable = runnable;
