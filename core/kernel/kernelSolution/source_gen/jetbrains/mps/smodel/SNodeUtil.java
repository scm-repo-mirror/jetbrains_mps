...
public final class SNodeUtil {
  ...
  public static final SAbstractConcept concept_PropertyAttribute = AUX_ccev63.PropertyAttribute_d001db89;
  public static final SAbstractConcept concept_LinkAttribute = AUX_ccev63.LinkAttribute_d001db6f;


  /**
   * for typesystem usages
   */
  public static final SConcept concept_VoidType = AUX_ccev63.VoidType_d96d05c9;
  public static final SConcept concept_SNodeType = AUX_ccev63.SNodeType_dcb080ab;
  public static final SConcept concept_RuntimeErrorType = AUX_ccev63.RuntimeErrorType_7182948c;
  ...
  public static final SAbstractConcept concept_IType = AUX_ccev63.IType_3efc1c4b;
  public static final SConcept concept_TypeAnnotated = AUX_ccev63.TypeAnnotated_8852bcd8;
   ...
   */
  public static final SConcept concept_Classifier = AUX_ccev63.Classifier_4b7e553;
  public static final SInterfaceConcept concept_IMemberContainer = AUX_ccev63.IMemberContainer_166f7222;
  public static final SConcept concept_BaseMethodDeclaration = AUX_ccev63.BaseMethodDeclaration_9dbf9acb;
  public static final SConcept concept_InstanceMethodDeclaration = AUX_ccev63.InstanceMethodDeclaration_9dbf9b2b;
  public static final SConcept concept_StaticMethodDeclaration = AUX_ccev63.StaticMethodDeclaration_9cd8c445;
  public static final SConcept concept_ConstructorDeclaration = AUX_ccev63.ConstructorDeclaration_9dbf9ae8;
  /**
  ...
  public static String getPresentation(SNode node) {
    try {
      return ((String) BHReflection.invoke0(node, AUX_ccev63.BaseConcept_bc2351f, SMethodTrimmedId.create("getPresentation", null, "hEwIMiw")));
    } catch (Throwable t) {
      return node.getName();
    }
  }
  public static String getDetailedPresentation(SNode node) {
    return ((String) (String) BHReflection.invoke0(node, AUX_ccev63.BaseConcept_bc2351f, SMethodTrimmedId.create("getDetailedPresentation", null, "22G2W3WJ92t")));
  }
  /**
   * 
  ...
  public static boolean isDefaultSubstitutable(SAbstractConcept concept) {
    // 1 use in mbeddr 
    return !(concept.isAbstract()) && !(SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(concept), AUX_ccev63.IDontSubstituteByDefault_37c138f6));
  }
  public static int getMetaLevel(SNode node) {
    return ((int) (Integer) BHReflection.invoke0(node, AUX_ccev63.BaseConcept_bc2351f, SMethodTrimmedId.create("getMetaLevel", null, "3t0v3yFOD1A")));
  }
  public static boolean isInstanceOfConceptDeclaration(SNode node) {
    if (node == null) {
      return false;
    }
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.ConceptDeclaration_cb225da8);
  }
  public static boolean isInstanceOfInterfaceConceptDeclaration(SNode node) {
    if (node == null) {
      return false;
    }
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.InterfaceConceptDeclaration_efdf2bc9);
  }
  public static boolean isInstanceOfAbstractConceptDeclaration(SNode node) {
    ...
    return c.equals(AUX_ccev63.ConceptDeclaration_cb225da8) || c.equals(AUX_ccev63.InterfaceConceptDeclaration_efdf2bc9) || c.equals(AUX_ccev63.AbstractConceptDeclaration_ec74828f);
  }
  ...
  public static SContainmentLink getChildLink(SNode attribute) {
    return ((SContainmentLink) (SContainmentLink) BHReflection.invoke0(SNodeOperations.cast(attribute, AUX_ccev63.ChildAttribute_96496d6c), AUX_ccev63.ChildAttribute_96496d6c, SMethodTrimmedId.create("getLink", AUX_ccev63.ChildAttribute_96496d6c, "BpxLfMirzf")));
  }
  public static SProperty getProperty(SNode attribute) {
    return ((SProperty) (SProperty) BHReflection.invoke0(SNodeOperations.cast(attribute, AUX_ccev63.PropertyAttribute_d001db89), AUX_ccev63.PropertyAttribute_d001db89, SMethodTrimmedId.create("getProperty", AUX_ccev63.PropertyAttribute_d001db89, "1avfQ4BBzOo")));
  }
  ...
  public static boolean isInstanceOfLinkDeclaration(SNode node) {
    ...
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.LinkDeclaration_ce818bfc);
  }
  public static boolean isInstanceOfPropertyDeclaration(SNode node) {
    if (node == null) {
      return false;
    }
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.PropertyDeclaration_ce818bfd);
  }
  ...
  public static boolean isInstanceOfPrimitiveDataTypeDeclaration(SNode node) {
    ...
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.PrimitiveDataTypeDeclaration_44a77975);
  }
  public static boolean isInstanceOfEnumerationDataTypeDeclaration(SNode node) {
    if (node == null) {
      return false;
    }
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.EnumerationDataTypeDeclaration_Old_9e6b98ad);
  }
  public static boolean isInstanceOfConstrainedStringDataTypeDeclaration(SNode node) {
    if (node == null) {
      return false;
    }
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.ConstrainedDataTypeDeclaration_a3b6ab44);
  }

  public static boolean getLinkDeclaration_IsReference(SNode link) {
    return SEnumOperations.isMember(SPropertyOperations.getEnum(link, MetaAdapterFactory.getProperty(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086aL, 0xf980556927L, "metaClass")), 0xfc6f4e95b8L);
  }
  public static boolean getLinkDeclaration_IsExactlyOneMultiplicity(SNode link) {
    return SEnumOperations.isMember(SPropertyOperations.getEnum(link, MetaAdapterFactory.getProperty(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086aL, 0xf98054bb04L, "sourceCardinality")), 0xfc6f3944c4L);
  }
  public static boolean getLinkDeclaration_IsAtLeastOneMultiplicity(SNode link) {
    return SEnumOperations.isMember(SPropertyOperations.getEnum(link, MetaAdapterFactory.getProperty(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086aL, 0xf98054bb04L, "sourceCardinality")), 0xfc6f3944c4L) || SEnumOperations.isMember(SPropertyOperations.getEnum(link, MetaAdapterFactory.getProperty(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086aL, 0xf98054bb04L, "sourceCardinality")), 0xfc6f3944c6L);
  }
  ...
  public static boolean isSideTransformInfo(SNode node) {
    return SNodeOperations.getConcept(node).equals(AUX_ccev63.SideTransformInfo_88337662);
  }
  ...
  public static SReferenceLink getLink(SNode attribute) {
    return ((SReferenceLink) (SReferenceLink) BHReflection.invoke0(SNodeOperations.cast(attribute, AUX_ccev63.LinkAttribute_d001db6f), AUX_ccev63.LinkAttribute_d001db6f, SMethodTrimmedId.create("getLink", AUX_ccev63.LinkAttribute_d001db6f, "1avfQ4BEFo6")));
  }
  ...
  private static final class AUX_ccev63 {
    ...
    /*package*/ static final SInterfaceConcept IDontSubstituteByDefault_37c138f6 = MetaAdapterFactory.getInterfaceConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x19796fa16a19888bL, "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault");
