...
@GeneratedClass(nodeId = "4636646692093260007", model = "r:d76e16ee-a528-4ca0-b2d6-9eed9a9b1d1c(jetbrains.mps.kotlin.stubs.smodel.metadata)")
public class KtAnnotationParser {
  private final KtReadContext context;


  public KtAnnotationParser(KtReadContext ctx) {
    context = ctx;
  }

  public void addInto(KmAnnotation annotation, SNode into) {
    SNode node = context.createClassReference(annotation.getClassName(), ClassStereotype::createKotlinAnnotation);
  ...
  private SNode valueOf(KmAnnotationArgument arg) {
    if (arg instanceof KmAnnotationArgument.LiteralValue) {
      ...
      SNode expression = context.createClassReference(subAnnotation.getClassName(), ClassStereotype::createKotlinNestedAnnotation);
  ...
  private SNode classTypeOf(String type) {
    return context.createClassReference(type, ClassStereotype::createKotlinType);
  }
