...
public class KtPropertyVisitor {
  public static SNode parseProperty(final KmProperty property, final String locationName, final KtReadContext context) {
    ...
    // Parameters
    SLinkOperations.setTarget(node, LINKS.visibility$vnSV, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(KtAttributes.getVisibility(Attributes.getVisibility(property)))));
    SLinkOperations.setTarget(node, LINKS.inheritance$TFvr, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(KtAttributes.getModality(Attributes.getModality(property)))));
    // TODO member kind?
    SPropertyOperations.assign(node, PROPS.isConstant$zvIz, Attributes.isConst(property));
    SPropertyOperations.assign(node, PROPS.isReadonly$jzqd, !(Attributes.isVar(property)));
    SPropertyOperations.assign(node, PROPS.isLateInit$qFSS, Attributes.isLateinit(property));
    ...
    context.withTypeParameters(property.getTypeParameters(), node, null, (constraints, typeParametersIds) -> {
      ...
      if (setterParameter != null) {
        ...
        final SNode parameter = SLinkOperations.setNewChild(setter, LINKS.parameter$J_aM, null);
