...
public class ProjectStructureBuilder {
  ...
  public SNode convertLanguage() {
    ...
    fillModule(result);
    if (mySourceModule.getOutputPath() != null) {
      SPropertyOperations.assign(result, PROPS.genPath$GNZ6, mySourceModule.getOutputPath().getPath());
    }
    if (myFile != null) {
  ...
  private SNode convertSolution() {
    ...
    fillModule(result);
    if (mySourceModule.getOutputPath() != null) {
      SPropertyOperations.assign(result, PROPS.outputPath$ljii, mySourceModule.getOutputPath().getPath());
    }
    if (myFile != null) {
  ...
  private void fillModule(SNode module) {
    ...
    SPropertyOperations.assign(module, PROPS.compileInMPS$2Q_X, jmf != null && jmf.getCompile() == JavaModuleFacet.Compile.MPS);
    if (jmf != null) {
  ...
  protected void collectModels(SNode module) {
    for (SModel m : Sequence.fromIterable(((Iterable<SModel>) mySourceModule.getModels())).sort((it) -> SModelOperations.getModelName(it), true)) {
