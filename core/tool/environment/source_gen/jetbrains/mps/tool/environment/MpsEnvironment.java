...
public final class MpsEnvironment extends EnvironmentBase {
  ...
  public void init() {
    // please don't use j.m.bl.logging language in this class
    Logger.getLogger(getClass()).info("Creating MPS environment");
  ...
  public Project createEmptyProject() {
    checkInitialized();
    Logger.getLogger(getClass()).info("Creating an empty project");
