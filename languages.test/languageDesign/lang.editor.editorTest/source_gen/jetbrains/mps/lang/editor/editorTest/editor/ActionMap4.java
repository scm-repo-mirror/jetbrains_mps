...
public class ActionMap4 {
  ...
  public static void setDefinedCellActions(EditorCell editorCell, SNode node, EditorContext context) {
    ...
    ActionMap2.setDefinedCellActions(editorCell, node, context);
    ActionMap3.setDefinedCellActions(editorCell, node, context);
  ...
  public static void setDefinedCellActionsOfType(EditorCell editorCell, SNode node, EditorContext context, CellActionType actionType) {
    ...
    ActionMap2.setDefinedCellActionsOfType(editorCell, node, context, actionType);
    ActionMap3.setDefinedCellActionsOfType(editorCell, node, context, actionType);
