...
/*package*/ class MenuTraceChildCellMenu_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public static class ReplaceWith_MenuTraceChildCellMenu_cellMenu_i2boga_b0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    ...
    public SAbstractConcept getReplacementConcept() {
      return CONCEPTS.MenuTraceChildCellMenu$eK;
    }
    @Override
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.name$LXND;
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new childSingleRoleHandler_i2boga_e0(myNode, LINKS.child$O76w, getEditorContext());
  ...
  private static class childSingleRoleHandler_i2boga_e0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.child$O76w, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.child$O76w, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new AggregationCellContext(myNode, child, LINKS.child$O76w, CONCEPTS.MenuTraceGrandChildCellMenu$Pk), new SubstituteInfoPartExt[]{new MenuTraceChildCellMenu_child_cellMenu_i2boga_a0e0(), new MenuTraceChildCellMenu_child_cellMenu_i2boga_b0e0(), new MenuTraceChildCellMenu_child_cellMenu_i2boga_c0e0(), new MenuTraceChildCellMenu_child_cellMenu_i2boga_d0e0(), new SChildSubstituteInfoPartEx(editorCell)}));
      }
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.child$O76w);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.child$O76w));
      try {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept MenuTraceChildCellMenu$eK = MetaAdapterFactory.getConcept(0x81f0abb8d71e4d13L, 0xa0c1d2291fbb28b7L, 0x13376377600dd75eL, "jetbrains.mps.lang.editor.editorTest.structure.MenuTraceChildCellMenu");
  ...
  private static final class PROPS {
    /*package*/ static final SProperty name$LXND = MetaAdapterFactory.getProperty(0x81f0abb8d71e4d13L, 0xa0c1d2291fbb28b7L, 0x13376377600dd75eL, 0x1337637760212dbeL, "name");
  }

  private static final class LINKS {
    /*package*/ static final SContainmentLink child$O76w = MetaAdapterFactory.getContainmentLink(0x81f0abb8d71e4d13L, 0xa0c1d2291fbb28b7L, 0x13376377600dd75eL, 0x133763776010fa10L, "child");
  }
}
