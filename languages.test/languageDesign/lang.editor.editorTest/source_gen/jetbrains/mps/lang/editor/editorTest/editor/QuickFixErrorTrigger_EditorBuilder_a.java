...
/*package*/ class QuickFixErrorTrigger_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public QuickFixErrorTrigger_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_fqpat6_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_fqpat6_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.message$y0Ww;
