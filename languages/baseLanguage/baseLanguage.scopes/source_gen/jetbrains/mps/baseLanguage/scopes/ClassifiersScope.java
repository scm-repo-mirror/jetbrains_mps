...
public class ClassifiersScope extends FilteringScope {
  private static final Logger LOG = LogManager.getLogger(ClassifiersScope.class);
  ...
  private SNode resolveImpl(@NotNull SModel contextModel, @Nullable SNode contextClassifier, @NotNull String refText) {
    ...
    if (refText.indexOf('[') == 0) {
      if (LOG.isEnabledFor(Level.ERROR)) {
        LOG.error(String.format("'[model]Classifier' to represent reference target is an old hack, remove %s", refText));
      }
      return null;
    }
    // end of hack
