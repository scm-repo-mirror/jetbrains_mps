...
public class MethodSignature implements Signature {
  ...
  public static String getStringSignature(SNode method, Map<SNode, SNode> typeByTypeVariable) {
    ...
    result.append(SPropertyOperations.getString(method, PROPS.name$MnvL));
    result.append('(');
    for (SNode parm : SLinkOperations.getChildren(method, LINKS.parameter$5xBj)) {
      SNode type = SLinkOperations.getTarget(parm, LINKS.type$a1UY);
