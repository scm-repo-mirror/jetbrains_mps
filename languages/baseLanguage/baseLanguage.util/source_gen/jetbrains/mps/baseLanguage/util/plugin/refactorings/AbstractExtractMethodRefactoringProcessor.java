...
public class AbstractExtractMethodRefactoringProcessor implements IExtractMethodRefactoringProcessor {
  ...
  public SNode getContainerReturnType() {
    ...
    if (SNodeOperations.isInstanceOf(containerMethod, CONCEPTS.ConceptFunction$mf)) {
      return TypecheckingFacade.getFromContext().coerceType(ConceptFunction__BehaviorDescriptor.getExpectedReturnType_idhEwIGRD.invoke(SNodeOperations.cast(containerMethod, CONCEPTS.ConceptFunction$mf)), CONCEPTS.Type$bu);
    }
    return null;
  }
