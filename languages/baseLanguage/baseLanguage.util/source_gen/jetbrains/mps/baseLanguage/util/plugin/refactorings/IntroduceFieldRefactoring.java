...
public class IntroduceFieldRefactoring extends AbstractIntroduceFieldRefactoring {
  ...
  public SNode doRefactoring() {
    ...
    Classifier__BehaviorDescriptor.insertInBestPlace_id7exmRT6rEUA.invoke(classConcept, newDeclaration);
    ...
    if (getExpression() != null) {
      ...
      if (this.myFieldInitialization == FieldInitializationPlace.CONSTRUCTOR) {
        ...
        if (Sequence.fromIterable(ClassConcept__BehaviorDescriptor.constructors_id4_LVZ3pCvsd.invoke(declaration)).isEmpty()) {
  ...
  private void createTheFirstConstructor(SNode classConcept) {
    ...
    Classifier__BehaviorDescriptor.insertInBestPlace_id7exmRT6rEUA.invoke(classConcept, c);
  }
