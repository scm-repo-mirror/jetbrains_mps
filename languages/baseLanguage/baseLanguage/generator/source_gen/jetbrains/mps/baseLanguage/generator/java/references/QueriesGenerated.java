...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static boolean rule_Condition_0_2(final BaseMappingRuleContext _context) {
    if (SLinkOperations.getTarget(_context.getNode(), LINKS.variableDeclaration$N1XG) == null) {
      return false;
    }
    return LocalDeclarationToReferenceMarker.isMarked(_context, SLinkOperations.getTarget(_context.getNode(), LINKS.variableDeclaration$N1XG));
  }
  public static boolean rule_Condition_0_3(final BaseMappingRuleContext _context) {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(_context.getNode(), LINKS.lValue$splI), CONCEPTS.GenericLValueExpression$8r);
  }
  ...
  public static boolean rule_Condition_1_0(final BaseMappingRuleContext _context) {
    SNode decl = SLinkOperations.getTarget(_context.getNode(), LINKS.variableDeclaration$N1XG);
    return SNodeOperations.isInstanceOf(decl, CONCEPTS.LocalVariableDeclaration$41) || SNodeOperations.isInstanceOf(decl, CONCEPTS.ParameterDeclaration$RG);
  }
  public static boolean rule_Condition_1_1(final BaseMappingRuleContext _context) {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.FieldReferenceOperation$fU);
  }
  ...
  public static boolean rule_Condition_3_1(final BaseMappingRuleContext _context) {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(_context.getNode(), LINKS.expression$uRUg), CONCEPTS.GenericLValueExpression$8r);
  }
  public static Object propertyMacro_GetValue_0_0(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL);
  }
  public static Object propertyMacro_GetValue_0_1(final PropertyMacroContext _context) {
    return _context.createIndexedName("_" + SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SNodeOperations.getParent(_context.getNode()), true);
  }
  public static Object propertyMacro_GetValue_1_0(final PropertyMacroContext _context) {
    return _context.createIndexedName("_ref_" + SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.variableDeclaration$N1XG), PROPS.name$MnvL), null, false);
  }
  public static Object propertyMacro_GetValue_1_1(final PropertyMacroContext _context) {
    return _context.createIndexedName("_ref_" + SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.FieldReferenceOperation$fU), LINKS.fieldDeclaration$H7Ag), PROPS.name$MnvL), null, false);
  }
  ...
  public static Object referenceMacro_GetReferent_0_0(final ReferenceMacroContext _context) {
    return ((SLinkOperations.getTarget(_context.getNode(), LINKS.initializer$2twD) != null) ? VaraibleTypeUtil.toLocalVariableCons(SLinkOperations.getTarget(_context.getNode(), LINKS.type$a1UY)) : VaraibleTypeUtil.toLocalVariableConsNoInit(SLinkOperations.getTarget(_context.getNode(), LINKS.type$a1UY)));
  }
  public static Object referenceMacro_GetReferent_0_1(final ReferenceMacroContext _context) {
    return _context.getOutputNodeByInputNodeAndMappingLabel(SLinkOperations.getTarget(_context.getNode(), LINKS.variableDeclaration$N1XG), "LocalVariable_AsReference");
  }
  public static Object referenceMacro_GetReferent_0_2(final ReferenceMacroContext _context) {
    return VaraibleTypeUtil.getVariableGetter(SLinkOperations.getTarget(_context.getNode(), LINKS.type$VAx9));
  }
  ...
  public static Object referenceMacro_GetReferent_6_1(final ReferenceMacroContext _context) {
    return VaraibleTypeUtil.toLocalVariableCons(SLinkOperations.getTarget(_context.getNode(), LINKS.type$a1UY));
  }
  public static boolean ifMacro_Condition_0_0(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(((SNode) _context.getVariable("var:lvalue")), LINKS.assignValueExression$XV8v) != null);
  }
  public static boolean ifMacro_Condition_0_1(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(_context.getNode(), LINKS.getValueExpression$czp4) != null);
  }
  public static SNode sourceNodeQuery_0_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.expr$KVqL);
  }
  public static SNode sourceNodeQuery_0_1(final SourceSubstituteMacroNodeContext _context) {
    return VaraibleTypeUtil.toLocalVariableClassType(SLinkOperations.getTarget(_context.getNode(), LINKS.type$a1UY));
  }
  ...
  public static SNode sourceNodeQuery_0_3(final SourceSubstituteMacroNodeContext _context) {
    return VaraibleTypeUtil.getTypeParameter(SLinkOperations.getTarget(_context.getNode(), LINKS.type$a1UY));
  }
  ...
  public static SNode sourceNodeQuery_0_5(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(((SNode) _context.getVariable("var:lvalue")), LINKS.referenceExpression$lnFv);
  }
  ...
  public static SNode sourceNodeQuery_0_7(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(((SNode) _context.getVariable("var:lvalue")), LINKS.assignValueExression$XV8v);
  }
  public static SNode sourceNodeQuery_0_8(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.referenceExpression$lnFv);
  }
  public static SNode sourceNodeQuery_0_9(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.getValueExpression$czp4);
  }
  public static SNode sourceNodeQuery_0_10(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SNodeOperations.as(SNodeOperations.getParent(SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.GenericLValueExpression$8r, false, false)), CONCEPTS.AssignmentExpression$SE), LINKS.rValue$spNK);
  }
  ...
  public static SNode sourceNodeQuery_1_11(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.array$tTQe);
  }
  public static SNode sourceNodeQuery_1_12(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.index$LbBP);
  }
  ...
  public static SNode sourceNodeQuery_5_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.expression$uRUg);
  }
  ...
  public static SNode weavingRule_ContextQuery_0_0(final WeavingMappingRuleContext _context) {
    return _context.getCopiedOutputNodeForInputNode(SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(_context.getNode()), CONCEPTS.BaseMethodDeclaration$kD), LINKS.body$5xQk));
  }
  ...
  public static Object varMacro_Value_0_0(final TemplateVarContext _context) {
    return SNodeOperations.as(SLinkOperations.getTarget(_context.getNode(), LINKS.lValue$splI), CONCEPTS.GenericLValueExpression$8r);
  }
  public static Object varMacro_Value_1_0(final TemplateVarContext _context) {
    return (SNode) Type__BehaviorDescriptor.getBoxedType_idhEwIzNC.invoke(SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(_context.getNode()), CONCEPTS.Type$bu));
  }
  ...
  public static Object varMacro_Value_1_2(final TemplateVarContext _context) {
    return SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(_context.getNode(), LINKS.operand$w6IR)), CONCEPTS.Type$bu);
  }
