...
public class ClassifierResolveUtils {
  /*package*/ static SConcept anonymousClassConcept = AUX_8z6r2b.AnonymousClass_e4a73f97;
  ...
  private static String getNestedName(SNode classifier) {
    ...
    if (SNodeOperations.isInstanceOf(parent, AUX_8z6r2b.Classifier_4b7e553)) {
      return getNestedName(SNodeOperations.cast(parent, AUX_8z6r2b.Classifier_4b7e553)) + '.' + name;
    }
    return name;
  }
  private static Iterable<SNode> getClassifiersInModel(SModel model) {
    return ListSequence.fromList(SModelOperations.nodes(model, AUX_8z6r2b.Classifier_4b7e553)).where(new IWhereFilter<SNode>() {
  ...
  /*package*/ static SNode resolve(@NotNull String refText, @NotNull SNode contextClassifier, boolean includeAncestors) {
    ...
    Iterable<SNode> pathToRoot = SNodeOperations.getNodeAncestors(contextClassifier, AUX_8z6r2b.Classifier_4b7e553, true);
    ...
    SNode javaImports = AttributeOperations.getAttribute(root, new IAttributeDescriptor.NodeAttribute(AUX_8z6r2b.JavaImports_af71158f));
    ...
    for (Object thing : javaImportedThings) {
      ...
      Iterable<SNode> roots = (thing instanceof SModel ? SModelOperations.roots(((SModel) thing), AUX_8z6r2b.Classifier_4b7e553) : SNodeOperations.ofConcept(SLinkOperations.getChildren(SNodeOperations.cast(((SNode) thing), AUX_8z6r2b.Classifier_4b7e553), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, 0x4a9a46de59132803L, "member")), AUX_8z6r2b.Classifier_4b7e553));
  ...
  public static Iterable<SNode> getImmediateNestedClassifiers(SNode clas) {
    return SNodeOperations.ofConcept(SLinkOperations.getChildren(clas, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, 0x4a9a46de59132803L, "member")), AUX_8z6r2b.Classifier_4b7e553);
  }
  public static Iterable<SNode> getPathToRoot(SNode clas) {
    // TODO make more precise: take role into consideration 
    return SNodeOperations.getNodeAncestors(clas, AUX_8z6r2b.Classifier_4b7e553, true);
  }
  ...
  private static Iterable<SNode> getAncestors(SNode clas) {
    ...
    while (QueueSequence.fromQueue(queue).isNotEmpty()) {
      ...
      if (SNodeOperations.isInstanceOf(claz, SNodeOperations.asSConcept(anonymousClassConcept))) {
        QueueSequence.fromQueue(queue).addLastElement(SLinkOperations.getTarget(SNodeOperations.cast(claz, AUX_8z6r2b.AnonymousClass_e4a73f97), MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x1107e0cb103L, 0x1107e0fd2a0L, "classifier")));

      } else if (SNodeOperations.isInstanceOf(claz, AUX_8z6r2b.ClassConcept_e2711824)) {
        SNode classConcept = SNodeOperations.cast(claz, AUX_8z6r2b.ClassConcept_e2711824);
    ...
    for (int p = k - 1; p >= 0; p--) {
      ...
      for (SModel m : Sequence.fromIterable(models)) {
        ...
        for (SNode r : m.getRootNodes()) {
          if (!(SNodeOperations.isInstanceOf(r, AUX_8z6r2b.Classifier_4b7e553))) {
            continue;
          }
          if (className.equals(SPropertyOperations.getString(SNodeOperations.cast(r, AUX_8z6r2b.Classifier_4b7e553), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")))) {
            cls = SNodeOperations.cast(r, AUX_8z6r2b.Classifier_4b7e553);
          }
        }
        if ((cls == null)) {
          continue;
  ...
  public static Iterable<SNode> staticImportedMethods(SNode imports) {
    return SNodeOperations.ofConcept(staticImportedThings(AUX_8z6r2b.StaticMethodDeclaration_9cd8c445, imports), AUX_8z6r2b.StaticMethodDeclaration_9cd8c445);
  }
  public static Iterable<SNode> staticImportedFields(SNode imports) {
    return SNodeOperations.ofConcept(staticImportedThings(AUX_8z6r2b.StaticFieldDeclaration_9649293d, imports), AUX_8z6r2b.StaticFieldDeclaration_9649293d);
  }
  ...
  private static final class AUX_8z6r2b {
