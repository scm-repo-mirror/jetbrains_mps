...
/*package*/ class ExtractMethodWithOutputVariable extends ExtractMethodFromStatementsRefactoring {
  ...
  public void replaceMatch(MethodMatch match, SNode methodDeclaration) {
    ...
    if ((this.myDeclarationStatement != null)) {
      ...
      SLinkOperations.setTarget(newStatement, LINKS.expression$5L7M, _quotation_createNode_n3576q_a0b0a2a5(methodCall, VariableDeclaration__BehaviorDescriptor.createReference_idhEwJfME.invoke(this.myOutputVariable)));
