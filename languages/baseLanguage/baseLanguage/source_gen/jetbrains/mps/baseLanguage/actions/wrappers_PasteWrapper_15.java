...
public final class wrappers_PasteWrapper_15 implements PasteWrapper {
  ...
  public SAbstractConcept getSourceConcept() {
    return AUX_yqi1hu.BaseMethodDeclaration_9dbf9acb;
  }
  @Override
  public SAbstractConcept getTargetConcept() {
    return AUX_yqi1hu.DefaultClassifierMethodDeclaration_85f81215;
  }
  @Override
  public SNode wrap(SNode sourceNode) {
    SNode method = SNodeFactoryOperations.createNewNode(AUX_yqi1hu.DefaultClassifierMethodDeclaration_85f81215, null);
    ...
    SLinkOperations.setTarget(SNodeOperations.cast(method, AUX_yqi1hu.IVisible_84badc76), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x112670d273fL, 0x112670d886aL, "visibility"), (SNodeOperations.isInstanceOf(sourceNode, AUX_yqi1hu.IVisible_84badc76) ? SLinkOperations.getTarget(SNodeOperations.cast(sourceNode, AUX_yqi1hu.IVisible_84badc76), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x112670d273fL, 0x112670d886aL, "visibility")) : SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10af9586f0cL, "jetbrains.mps.baseLanguage.structure.PrivateVisibility"))));
    // [MM] what about supers? 
    ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(method, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b1fcL, 0xf8cc56b1ffL, "body")), AUX_yqi1hu.ThisNodeExpression_70062b2e, false, new SAbstractConcept[]{})).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        SNodeOperations.replaceWithNewChild(it, AUX_yqi1hu.ThisClassifierExpression_b632a0cf);
      }
    });
    ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(method, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b1fcL, 0xf8cc56b1ffL, "body")), AUX_yqi1hu.ThisConceptExpression_8a7f749d, false, new SAbstractConcept[]{})).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        SNodeOperations.replaceWithNewChild(it, AUX_yqi1hu.ThisClassifierExpression_b632a0cf);
      }
    });
    ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(method, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b1fcL, 0xf8cc56b1ffL, "body")), AUX_yqi1hu.ThisExpression_a046bcfc, false, new SAbstractConcept[]{})).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        SNodeOperations.replaceWithNewChild(it, AUX_yqi1hu.ThisClassifierExpression_b632a0cf);
      }
    });
    AttributeOperations.setAttribute(method, new IAttributeDescriptor.NodeAttribute(AUX_yqi1hu.MethodDocComment_a2b8d4a1), AttributeOperations.getAttribute(sourceNode, new IAttributeDescriptor.NodeAttribute(AUX_yqi1hu.MethodDocComment_a2b8d4a1)));
    return method;
  }
