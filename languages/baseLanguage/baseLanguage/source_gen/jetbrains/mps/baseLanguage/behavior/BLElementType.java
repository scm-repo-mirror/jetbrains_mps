...
public enum BLElementType {
  ...
  FIELD() {
    public boolean accept(SNode target) {
      return SNodeOperations.isInstanceOf(target, CONCEPTS.FieldDeclaration$ie) || SNodeOperations.isInstanceOf(target, CONCEPTS.StaticFieldDeclaration$jR) || SNodeOperations.isInstanceOf(target, CONCEPTS.EnumConstantDeclaration$MW);
    }
