...
public final class ClassConcept__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMainMethod_idhEwIClG = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getMainMethod").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hEwIClG").build();
  ...
  public static final SMethod<List<SNode>> getAllSuperClassifiers_id4fAeKISQjDi = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getAllSuperClassifiers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4fAeKISQjDi").build();
  ...
  public static final SMethod<Iterable<SNode>> instanceInitializers_id6Fz0RL3y9UD = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("instanceInitializers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6Fz0RL3y9UD").build();
  public static final SMethod<Iterable<SNode>> staticInitializers_id2I6sE$IuBP7 = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("staticInitializers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2I6sE$IuBP7").build();
  public static final SMethod<Iterable<SNode>> fields_id4_LVZ3pC27C = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("fields").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4_LVZ3pC27C").build();
  public static final SMethod<Iterable<SNode>> staticMethods_id4_LVZ3pCeXr = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("staticMethods").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4_LVZ3pCeXr").build();
  public static final SMethod<Iterable<SNode>> constructors_id4_LVZ3pCvsd = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("constructors").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4_LVZ3pCvsd").build();
  public static final SMethod<Iterable<SNode>> properties_id4_LVZ3pCxYY = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("properties").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4_LVZ3pCxYY").build();
  public static final SMethod<Boolean> canBeStatic_id2L7NFMAtrRg = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("canBeStatic").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2L7NFMAtrRg").build();
  public static final SMethod<SNode> getContextClass_id6WzWPTX2$6q = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getContextClass").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6WzWPTX2$6q").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  ...
  public static final SMethod<Void> addConstructor_id32Td0Ia9Mgr = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("addConstructor").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("32Td0Ia9Mgr").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<Void> markLoadedNodeAsDeprecated_id5H8W9_EDlcn = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("markLoadedNodeAsDeprecated").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5H8W9_EDlcn").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<Boolean> canBeExtendedOrInstantiatedAt_id2YFkRQdLLqk = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("canBeExtendedOrInstantiatedAt").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2YFkRQdLLqk").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
