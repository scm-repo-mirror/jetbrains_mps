...
public final class DotExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final Logger LOG = LogManager.getLogger(DotExpression__BehaviorDescriptor.class);
  ...
  /*package*/ static boolean isLValue_idhEwJgmE(@NotNull SNode __thisNode__) {
    LoggingRuntime.logMsgView(Level.WARN, "AAAAAAAA " + (boolean) IOperation__BehaviorDescriptor.isLValue_idhEwIP$w.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.operation$gs9E)) + ":" + SNodeOperations.getConcept(SLinkOperations.getTarget(__thisNode__, LINKS.operation$gs9E)), DotExpression__BehaviorDescriptor.class, null, null);
