...
public final class StaticFieldReferenceOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getClassifier_id1U0U1G1L440 = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getClassifier").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1U0U1G1L440").build();
  ...
  /*package*/ static Object getCompileTimeConstantValue_idi1LP2xI(@NotNull SNode __thisNode__, SModule module) {
    SNode classifier = StaticFieldReferenceOperation__BehaviorDescriptor.getClassifier_id1U0U1G1L440.invoke(__thisNode__);
    ...
    SModule m = check_j2fiuc_a0e0c(SNodeOperations.getModel(field));
    if (m != null) {
      try {
        final Object c = ReflectionUtil.getConstantValue(m, classifier, SPropertyOperations.getString(field, PROPS.name$MnvL));
        if (c != null) {
          return c;
        }
      } catch (Throwable t) {
    ...
    try {
      return ReflectionUtil.getConstantValue(module, classifier, SPropertyOperations.getString(field, PROPS.name$MnvL));
    } catch (Throwable t) {
      return null;
    }
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((SNode) getClassifier_id1U0U1G1L440(node));
      case 1:
  ...
  private static SModule check_j2fiuc_a0e0c(SModel checkedDotOperand) {
