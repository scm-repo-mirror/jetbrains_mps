...
public class AlternativeType_Constraints extends BaseConstraintsDescriptor {
  public AlternativeType_Constraints() {
    super(CONCEPTS.AlternativeType$aM);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return Objects.equals(link, LINKS.type$uWuc) && SNodeOperations.isInstanceOf(parentNode, CONCEPTS.CatchVariable$6W) && SNodeOperations.hasRole(parentNode, LINKS.throwable$fRlf) && SNodeOperations.isInstanceOf(SNodeOperations.getParent(parentNode), CONCEPTS.MultipleCatchClause$U5);
  }
