...
public class ForeachStatement_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    _context.getBuilder().build((SNode) SLinkOperations.getTarget(_context.getNode(), LINKS.iterable$FCTY));
    ...
    _context.getBuilder().emitWrite(SLinkOperations.getTarget(_context.getNode(), LINKS.variable$4Igk), "r:00000000-0000-4000-0000-011c895902c2(jetbrains.mps.baseLanguage.dataFlow)/1206989539741");
