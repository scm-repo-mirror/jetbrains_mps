...
public class OrExpression_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    ...
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(_context.getNode()), CONCEPTS.IConditional$CG)) {
      NextProgramPoint point = IConditional__BehaviorDescriptor.getNextProgramPoint_id3F8BxGibk8h.invoke(SNodeOperations.cast(SNodeOperations.getParent(_context.getNode()), CONCEPTS.IConditional$CG), _context.getNode(), ((boolean) true));
      if (point != null) {
