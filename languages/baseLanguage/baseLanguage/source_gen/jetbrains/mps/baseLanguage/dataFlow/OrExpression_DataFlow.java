...
public class OrExpression_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    ...
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(_context.getNode()), AUX_jby8oe.IConditional_d904c968)) {
      NextProgramPoint point = IConditional__BehaviorDescriptor.getNextProgramPoint_id3F8BxGibk8h.invoke(SNodeOperations.cast(SNodeOperations.getParent(_context.getNode()), AUX_jby8oe.IConditional_d904c968), _context.getNode(), ((boolean) true));
      if (point != null) {
  ...
  private static final class AUX_jby8oe {
