...
public class RuleNotEqualsExpression implements DataFlowConstructor {
  ...
  public SAbstractConcept getApplicableConcept() {
    return AUX_mhzyev.NotEqualsExpression_8a487ab7;
  }
  public void performActions(Program o, SNode node) {
    ...
    if (!((SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), AUX_mhzyev.IConditional_d904c968)))) {
      return;
    }
    NextProgramPoint point = IConditional__BehaviorDescriptor.getNextProgramPoint_id3F8BxGibk8h.invoke(SNodeOperations.cast(SNodeOperations.getParent(node), AUX_mhzyev.IConditional_d904c968), node, ((boolean) true));
    if (point != null) {
      if (point.willJump()) {
        {
          Object object = node;
    ...
    point = IConditional__BehaviorDescriptor.getNextProgramPoint_id3F8BxGibk8h.invoke(SNodeOperations.cast(SNodeOperations.getParent(node), AUX_mhzyev.IConditional_d904c968), node, ((boolean) false));
    if (point != null) {
      if (point.willJump()) {
        {
          Object object = node;
  ...
  private static final class AUX_mhzyev {
