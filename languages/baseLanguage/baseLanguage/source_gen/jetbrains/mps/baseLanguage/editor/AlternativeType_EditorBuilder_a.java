...
/*package*/ class AlternativeType_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AlternativeType_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_u6hstu_a");
  ...
  private static class alternativeListHandler_u6hstu_a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(alternativeListHandler_u6hstu_a0.this.getNode(), LINKS.alternative$IEPM));
      try {
