...
/*package*/ class AnnotationInstanceValue_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.key$y5Ln;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.key$y5Ln);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_99x6e7_c0(myNode, LINKS.value$Bis, getEditorContext());
