...
/*package*/ class AnnotationInstanceValue_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.key$wMU9;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.key$wMU9);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_99x6e7_c0(myNode, LINKS.value$j1V$, getEditorContext());
