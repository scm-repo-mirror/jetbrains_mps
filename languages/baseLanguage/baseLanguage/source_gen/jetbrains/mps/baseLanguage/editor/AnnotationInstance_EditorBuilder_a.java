...
/*package*/ class AnnotationInstance_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_d5p1uc_a2a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.value$uK2B)).isNotEmpty() || ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(myNode, LINKS.annotation$12Ek), LINKS.method$_DCK)).isNotEmpty();
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.annotation$12Ek;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.annotation$12Ek);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.annotation$12Ek);
    }
    Style style = new StyleImpl();
  ...
  private static class valueListHandler_d5p1uc_b2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(valueListHandler_d5p1uc_b2a.this.getNode(), LINKS.value$uK2B));
      try {
