...
/*package*/ class BaseMethodDeclaration_NameCellComponent_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean _StyleParameter_QueryFunction_8989zw_a0a0() {
    return !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(getNode()), CONCEPTS.ClassConcept$IY)) && (boolean) IDeprecatable__BehaviorDescriptor.isDeprecated_idhOwoPtR.invoke(getNode());
  }
