...
/*package*/ class ClassifierMembers_Component_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  public ClassifierMembers_Component_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private static class memberListHandler_gjudtn_a0 extends RefNodeListHandler {
    ...
    public memberListHandler_gjudtn_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(memberListHandler_gjudtn_a0.this.getNode(), LINKS.member$oYX5));
      try {
