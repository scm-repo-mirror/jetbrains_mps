...
/*package*/ class EnumValuesExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public static class EnumValuesExpression_customReplace_cellMenu_igwct4_a0c0 extends AbstractCellMenuPart_ReplaceNode_Group {
    ...
    public List<?> createParameterObjects(SNode node, IOperationContext operationContext, EditorContext editorContext) {
      return QueriesUtil.replaceNodeMenu_parameterObjects(SLinkOperations.getTarget(node, LINKS.enumClass$8ABG), node);
    }
    ...
    public SNode createReplacementNode_impl(SNode parameterObject, SNode node, SModel model, IOperationContext operationContext, EditorContext editorContext) {
      return QueriesUtil.replaceNodeMenu_createNewNode(SLinkOperations.getTarget(node, LINKS.enumClass$8ABG), parameterObject, node);
    }
