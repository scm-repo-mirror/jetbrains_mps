...
public class ExpressionStatement_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_Include_buu7zc_a0 extends IncludeTransformationMenuTransformationMenuPart {
    ...
    protected TransformationMenuLookup getMenuLookup(TransformationMenuContext _context) {
      ...
      return new DefaultTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), CONCEPTS.Statement$P6);
    }
  ...
  private class TMP_Action_buu7zc_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        SNodeFactoryOperations.replaceWithNewChild(_context.getNode(), CONCEPTS.ReturnStatement$lt);
      }

      @Override
      public boolean canExecute(@NotNull String pattern) {
        return (SLinkOperations.getTarget(_context.getNode(), LINKS.expression$5L7M) == null);
      }
