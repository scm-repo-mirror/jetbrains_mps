...
/*package*/ class FieldDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class annotationListHandler_2sbeba_b0 extends RefNodeListHandler {
    ...
    public SAbstractConcept getChildSConcept() {
      return AUX_2ztw5e.AnnotationInstance_51bc59df;
    }
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_2ztw5e.PropertyAttribute_d001db89);
  ...
  private static final class AUX_2ztw5e {
