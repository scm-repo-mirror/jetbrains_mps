...
/*package*/ class InstanceMethodDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_359zr8_a1c0() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isFinal$I$Qu);
  }
  private boolean nodeCondition_359zr8_a2c0() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isAbstract$cU_H);
  }
  private boolean nodeCondition_359zr8_a3c0() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isSynchronized$PMx);
  }
  private boolean nodeCondition_359zr8_a4c0() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isNative$LADB);
  }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.InstanceMethodDeclaration$An, "jetbrains.mps.baseLanguage.editor.InstanceMethodDeclaration_ApplySideTransforms"));
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new returnTypeSingleRoleHandler_359zr8_f0(myNode, LINKS.returnType$WIkw, getEditorContext());
  ...
  private static class parameterListHandler_359zr8_i0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_359zr8_i0.this.getNode(), LINKS.parameter$WIkZ));
      try {
  ...
  private EditorCell createConstant_6() {
    ...
    style.set(StyleAttributes.SELECTABLE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.InstanceMethodDeclaration$An, "jetbrains.mps.baseLanguage.editor.InstanceMethodDeclaration_ApplySideTransforms_1"));
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell));
    return editorCell;
  }
