...
/*package*/ class InstanceMethodDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class annotationListHandler_359zr8_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_359zr8_b0.this.getNode(), LINKS.annotation$oVP4));
      try {
  ...
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.isFinal$I$Qu;
