...
/*package*/ class LocalVariableDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class annotationListHandler_i0gfbw_a0a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_i0gfbw_a0a.this.getNode(), LINKS.annotation$4YGW));
      try {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new initializerSingleRoleHandler_i0gfbw_b4a(myNode, LINKS.initializer$no3R, getEditorContext());
