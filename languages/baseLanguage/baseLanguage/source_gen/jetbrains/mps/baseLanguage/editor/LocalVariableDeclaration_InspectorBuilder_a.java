...
/*package*/ class LocalVariableDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.isFinal$hIht;
  ...
  private static class annotationListHandler_i0gfbw_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_i0gfbw_d0.this.getNode(), LINKS.annotation$oVP4));
      try {
