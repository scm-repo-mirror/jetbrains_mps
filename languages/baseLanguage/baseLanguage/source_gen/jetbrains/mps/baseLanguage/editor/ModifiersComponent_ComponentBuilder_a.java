...
/*package*/ class ModifiersComponent_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private static class modifiersListHandler_3tjqio_a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(modifiersListHandler_3tjqio_a0.this.getNode(), LINKS.modifiers$m0));
      try {
