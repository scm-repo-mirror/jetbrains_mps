  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, SLinkOperations.getTarget(node, LINKS.expression$eJ92))) {
          return;
        }
        SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.expression$eJ92));
