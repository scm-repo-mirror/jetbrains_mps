...
/*package*/ class SuperConstructorInvocation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    style.set(StyleAttributes.NAVIGATABLE_SREFERENCE, LINKS.constructorDeclaration$M_v7);
    editorCell.getStyle().putAll(style);
  ...
  private static class actualArgumentListHandler_aafbxa_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualArgumentListHandler_aafbxa_c0.this.getNode(), LINKS.actualArgument$$A7L));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink constructorDeclaration$M_v7 = MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x121119ae5ffL, 0x121119ba06aL, "constructorDeclaration");
