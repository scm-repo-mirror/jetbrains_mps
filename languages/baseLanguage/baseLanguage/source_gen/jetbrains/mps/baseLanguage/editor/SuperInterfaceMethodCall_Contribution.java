...
public class SuperInterfaceMethodCall_Contribution extends SubstituteMenuBase {
  public SuperInterfaceMethodCall_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Expression", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697587052859")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Param_73nkqx_a extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
    /*package*/ SMP_Param_73nkqx_a() {
      super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697587052862")));
    }
    @NotNull
    @Override
    ...
    private class SMP_Action_73nkqx_a0 extends SingleItemSubstituteMenuPart {
      ...
      private class Item extends DefaultSubstituteMenuItem {
        ...
        /*package*/ void resetTraceInfo() {
          ...
          updateTraceInfo(description, new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697587052922"));
        }
