...
/*package*/ class SuperMethodCallComponent_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), AUX_z689ji.IMethodCall_ee2c776b, "jetbrains.mps.baseLanguage.editor.AddMethodCallTypeArgument_ext_1"));
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefCell_0() {
    ...
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), AUX_z689ji.IMethodCall_ee2c776b, "jetbrains.mps.baseLanguage.editor.AddMethodCallTypeArgument"));
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfo(editorCell, referenceLink, AUX_z689ji.InstanceMethodDeclaration_9dbf9b2b));
    Iterable<SNode> referenceAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_z689ji.LinkAttribute_d001db6f);
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        ...
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_z689ji.PropertyAttribute_d001db89);
  ...
  private static class actualArgumentListHandler_pxtadd_f0 extends RefNodeListHandler {
    ...
    public SAbstractConcept getChildSConcept() {
      return AUX_z689ji.Expression_4199e28d;
    }
  ...
  private static final class AUX_z689ji {
