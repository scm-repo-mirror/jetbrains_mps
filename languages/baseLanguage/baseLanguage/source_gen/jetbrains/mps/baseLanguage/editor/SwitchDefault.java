  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ...
        SLinkOperations.setTarget(node, LINKS.defaultBlock$QOu8, null);
        if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.case$8PWE)).isNotEmpty()) {
          SelectionUtil.selectLabelCellAnSetCaret(editorContext, ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.case$8PWE)).last(), SelectionManager.LAST_CELL, -1);
        } else {
