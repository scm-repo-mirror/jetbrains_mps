...
/*package*/ class ThisExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_xaaxob_a0() {
    return SNodeOperations.getReference(myNode, LINKS.classConcept$StRd) != null;
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.classConcept$StRd;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.classConcept$StRd);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.classConcept$StRd);
    }
