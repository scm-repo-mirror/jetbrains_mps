...
/*package*/ class ThisExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_xaaxob_a0() {
    return SNodeOperations.getReference(myNode, LINKS.classConcept$Hbij) != null;
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.classConcept$Hbij;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.classConcept$Hbij);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.classConcept$Hbij);
    }
