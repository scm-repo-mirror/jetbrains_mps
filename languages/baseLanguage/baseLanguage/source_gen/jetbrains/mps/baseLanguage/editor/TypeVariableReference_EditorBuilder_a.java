...
/*package*/ class TypeVariableReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.typeVariableDeclaration$6t$W;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.typeVariableDeclaration$6t$W);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.typeVariableDeclaration$6t$W);
    }
