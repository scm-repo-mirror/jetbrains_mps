...
/*package*/ class WhileStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_i9ndrb.PropertyAttribute_d001db89);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new loopLabelSingleRoleHandler_ou8udj_a1a(myNode, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10cb1ac5adeL, 0x50c493bf9555131L, "loopLabel"), getEditorContext());
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), AUX_i9ndrb.AbstractLoopStatement_bb2741d5, "jetbrains.mps.baseLanguage.editor.loopLabelsAndIfStatement"));
    editorCell.setDefaultText("");
  ...
  public static class ReplaceWith_DoWhileStatement_cellMenu_ou8udj_a0c0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    ...
    public SAbstractConcept getReplacementConcept() {
      return AUX_i9ndrb.DoWhileStatement_50b6f79b;
    }
    @Override
  ...
  public static class ReplaceWith_ForStatement_cellMenu_ou8udj_b0c0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    ...
    public SAbstractConcept getReplacementConcept() {
      return AUX_i9ndrb.ForStatement_1eab9ef9;
    }
    @Override
    protected EditorMenuDescriptor createEditorMenuDescriptor(CellContext cellContext, EditorContext editorContext) {
  ...
  public static class ReplaceWith_ForeachStatement_cellMenu_ou8udj_c0c0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    ...
    public SAbstractConcept getReplacementConcept() {
      return AUX_i9ndrb.ForeachStatement_bf20b0bc;
    }
    @Override
    protected EditorMenuDescriptor createEditorMenuDescriptor(CellContext cellContext, EditorContext editorContext) {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new conditionSingleRoleHandler_ou8udj_e0(myNode, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfaa4bf0f2fL, 0xfaa4bf0f30L, "condition"), getEditorContext());
    return provider.createCell();
  }
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new bodySingleRoleHandler_ou8udj_h0(myNode, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10cb1ac5adeL, 0x10cb1ada6e8L, "body"), getEditorContext());
    return provider.createCell();
  }
  ...
  private static final class AUX_i9ndrb {
