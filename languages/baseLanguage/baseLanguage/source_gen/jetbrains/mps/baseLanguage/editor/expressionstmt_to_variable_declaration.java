    ...
    public class TMP_WrapSM_mt5nim_a0a extends WrapSubstituteMenuTransformationMenuPart {
      ...
      private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SubstituteCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          ...
          SelectionUtil.selectLabelCellAnSetCaret(_context.getEditorContext(), SLinkOperations.getTarget(statement, LINKS.localVariableDeclaration$cjR0), "*" + CellIdManager.createPropertyId("name"), -1);
        }
