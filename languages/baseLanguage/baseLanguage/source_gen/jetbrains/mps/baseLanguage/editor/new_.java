...
public class new_ extends SubstituteMenuBase {
  public new_() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "new_", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960802")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Param_1076n_a(), CONCEPTS.GenericNewExpression$Fh));
    return result;
  }

  private class SMP_Param_1076n_a extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
    /*package*/ SMP_Param_1076n_a() {
      super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960804")));
    }
    @NotNull
    @Override
    ...
    private class SMP_Action_1076n_a0 extends SingleItemSubstituteMenuPart {
      ...
      private class Item extends DefaultSubstituteMenuItem {
        ...
        public Item(SubstituteMenuContext context) {
          super(CONCEPTS.GenericNewExpression$Fh, context);
          _context = context;
        }
        ...
        /*package*/ void resetTraceInfo() {
          ...
          updateTraceInfo(description, new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960881"));
        }

        @Nullable
        @Override
        public SNode createNode(@NotNull String pattern) {
          SNode gne = SNodeFactoryOperations.createNewNode(CONCEPTS.GenericNewExpression$Fh, null);
          SLinkOperations.setTarget(gne, LINKS.creator$BsHW, myParameterObject);
          return gne;
        }

        @NotNull
        protected CompletionItemInformation createInformation(String pattern) {
          return new CompletionItemInformation(myParameterObject, CONCEPTS.GenericNewExpression$Fh, getMatchingText(pattern), getDescriptionText(pattern));
        }
        @Nullable
        @Override
