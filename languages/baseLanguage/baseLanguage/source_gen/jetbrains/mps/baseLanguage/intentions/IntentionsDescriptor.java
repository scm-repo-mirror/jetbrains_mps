...
public final class IntentionsDescriptor extends AbstractIntentionAspectDescriptor {
    ...
    switch (conceptIndex.index(cncpt)) {
      ...
      case 22:
        if (true) {
          // concept 
          intentions = new IntentionFactory[1];
          intentions[0] = new ConvertCommentToParagraphs_Intention();
        }
        break;
      case 23:
        if (true) {
      ...
      case 35:
        if (true) {
          // concept 
          intentions = new IntentionFactory[3];
          intentions[0] = new UpdateCommentToSingleLineStructure_Intention();
          intentions[1] = new MergeFollowingSingleLineCommentsIntoMultilineComment_Intention();
  ...
  public Collection<IntentionFactory> getAllIntentions() {
    IntentionFactory[] rv = new IntentionFactory[108];
