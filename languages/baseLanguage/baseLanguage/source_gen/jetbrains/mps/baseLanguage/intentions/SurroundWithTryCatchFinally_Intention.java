  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      for (SNode selectedNode : ListSequence.fromList(selectedNodes)) {
        ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(tryStatement, LINKS.body$lFey), LINKS.statement$pYcS)).addElement(SNodeOperations.getNodeAncestor(selectedNode, CONCEPTS.Statement$ok, true, false));
      }
      ...
      Set<SNode> uncaughtThrowables = StatementList__BehaviorDescriptor.uncaughtThrowables_id2SVUfbZ9Qq1.invoke(SLinkOperations.getTarget(tryStatement, LINKS.body$lFey), ((boolean) false));
      if (SetSequence.fromSet(uncaughtThrowables).isNotEmpty()) {
        ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.catchClause$lKBT)).clear();
        SetSequence.fromSet(uncaughtThrowables).visitAll(new IVisitor<SNode>() {
          public void visit(SNode it) {
            ...
            ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.catchClause$lKBT)).addElement(clause);
          }
        });
      }
      if (ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.catchClause$lKBT)).isEmpty()) {
        SNodeFactoryOperations.addNewChild(tryStatement, LINKS.catchClause$lKBT, CONCEPTS.MultipleCatchClause$U5);
      }
