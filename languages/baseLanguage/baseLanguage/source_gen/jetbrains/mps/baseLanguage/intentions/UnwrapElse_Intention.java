...
public final class UnwrapElse_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  private boolean isVisibleInChild(final SNode node, final SNode childNode, final EditorContext editorContext) {
    return ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(SNodeOperations.getNodeAncestor(childNode, CONCEPTS.IfStatement$pi, false, false), LINKS.ifFalseStatement$Xnu2), null, false, new SAbstractConcept[]{})).contains(childNode);
  }
  @Override
