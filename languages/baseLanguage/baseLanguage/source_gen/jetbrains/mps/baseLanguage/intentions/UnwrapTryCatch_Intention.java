...
public final class UnwrapTryCatch_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    ...
    for (SNode ancestor : ListSequence.fromList(SNodeOperations.getNodeAncestors(selectedNode, null, true))) {
      if (SNodeOperations.isInstanceOf(ancestor, AUX_cj56ns.ITryCatchStatement_bca26107)) {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode body = (SNodeOperations.isInstanceOf(node, AUX_cj56ns.TryStatement_d214e8c2) ? SLinkOperations.getTarget(SNodeOperations.cast(node, AUX_cj56ns.TryStatement_d214e8c2), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10cacebf556L, 0x10cacec83aeL, "body")) : SLinkOperations.getTarget(SNodeOperations.cast(node, AUX_cj56ns.TryCatchStatement_fb61ebd), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10f383e6771L, 0x10f383e83d4L, "body")));

      if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), AUX_cj56ns.StatementList_9dbf9acf)) {
        final SNode statementList = SNodeOperations.cast(SNodeOperations.getParent(node), AUX_cj56ns.StatementList_9dbf9acf);
        final Wrappers._int index = new Wrappers._int(ListSequence.fromList(SLinkOperations.getChildren(statementList, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b200L, 0xf8cc6bf961L, "statement"))).indexOf(SNodeOperations.cast(node, AUX_cj56ns.Statement_9dbf9b0e)));
        ...
        SNode statement = SNodeFactoryOperations.replaceWithNewChild(node, AUX_cj56ns.BlockStatement_8943d110);
  ...
  private static final class AUX_cj56ns {
