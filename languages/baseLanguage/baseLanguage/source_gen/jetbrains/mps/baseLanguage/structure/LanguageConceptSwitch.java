...
public final class LanguageConceptSwitch {
  ...
  public static final int ITryCatchStatement = 141;
  public static final int ITypeApplicable = 142;
  public static final int IValidIdentifier = 143;
  public static final int IVariableAssignment = 144;
  public static final int IVariableDeclaration = 145;
  public static final int IVariableReference = 146;
  public static final int IVisible = 147;
  public static final int IWillBeClassifier = 148;
  public static final int IYetUnresolved = 149;
  public static final int IfStatement = 150;
  public static final int ImplicitAnnotationInstanceValue = 151;
  public static final int ImplicitAnnotationMethodKind = 152;
  public static final int IncompleteLeftParen = 153;
  public static final int IncompleteMemberDeclaration = 154;
  public static final int IncompleteRightParen = 155;
  public static final int InstanceInitializer = 156;
  public static final int InstanceMethodCallOperation = 157;
  public static final int InstanceMethodDeclaration = 158;
  public static final int InstanceOfExpression = 159;
  public static final int IntegerConstant = 160;
  public static final int IntegerLiteral = 161;
  public static final int IntegerType = 162;
  public static final int Interface = 163;
  public static final int IsEmptyOperation = 164;
  public static final int IsNotEmptyOperation = 165;
  public static final int JavaImport = 166;
  public static final int JavaImports = 167;
  public static final int JavaModifier = 168;
  public static final int LeftShiftAssignmentExpression = 169;
  public static final int LessThanExpression = 170;
  public static final int LessThanOrEqualsExpression = 171;
  public static final int LocalInstanceFieldReference = 172;
  public static final int LocalInstanceMethodCall = 173;
  public static final int LocalMethodCall = 174;
  public static final int LocalPropertyReference = 175;
  public static final int LocalStaticFieldReference = 176;
  public static final int LocalStaticMethodCall = 177;
  public static final int LocalToMethodKind = 178;
  public static final int LocalVariableDeclaration = 179;
  public static final int LocalVariableDeclarationStatement = 180;
  public static final int LongLiteral = 181;
  public static final int LongType = 182;
  public static final int LoopLabel = 183;
  public static final int LoopLabelReference = 184;
  public static final int LowerBoundType = 185;
  public static final int MethodDeclaration = 186;
  public static final int MinusAssignmentExpression = 187;
  public static final int MinusExpression = 188;
  public static final int Modifier = 189;
  public static final int MulAssignmentExpression = 190;
  public static final int MulExpression = 191;
  public static final int MultiLineComment = 192;
  public static final int MultipleCatchClause = 193;
  public static final int NPEEqualsExpression = 194;
  public static final int NPENotEqualsExpression = 195;
  public static final int NestedNewExpression = 196;
  public static final int NotEqualsExpression = 197;
  public static final int NotExpression = 198;
  public static final int NullLiteral = 199;
  public static final int NullType = 200;
  public static final int Number = 201;
  public static final int OctalIntegerLiteral = 202;
  public static final int OperationAssignmentExpression = 203;
  public static final int OrAssignmentExpression = 204;
  public static final int OrExpression = 205;
  public static final int ParameterDeclaration = 206;
  public static final int ParenthesizedExpression = 207;
  public static final int PassByRefExpression = 208;
  public static final int PlaceholderMember = 209;
  public static final int PlusAssignmentExpression = 210;
  public static final int PlusExpression = 211;
  public static final int PostfixDecrementExpression = 212;
  public static final int PostfixIncrementExpression = 213;
  public static final int PrefixDecrementExpression = 214;
  public static final int PrefixIncrementExpression = 215;
  public static final int PrimitiveClassExpression = 216;
  public static final int PrimitiveType = 217;
  public static final int PrivateVisibility = 218;
  public static final int Property = 219;
  public static final int PropertyImplementation = 220;
  public static final int PropertyReference = 221;
  public static final int PropertyValueReference = 222;
  public static final int ProtectedVisibility = 223;
  public static final int PublicVisibility = 224;
  public static final int QualifiedReference = 225;
  public static final int QualifiedSuperMethodCall = 226;
  public static final int RemAssignmentExpression = 227;
  public static final int RemExpression = 228;
  public static final int RemarkStatement = 229;
  public static final int ResourceVariable = 230;
  public static final int ReturnStatement = 231;
  public static final int RightShiftAssignmentExpression = 232;
  public static final int SetAccessor = 233;
  public static final int ShiftLeftExpression = 234;
  public static final int ShiftRightExpression = 235;
  public static final int ShiftRightUnsignedExpression = 236;
  public static final int ShortType = 237;
  public static final int SingleLineComment = 238;
  public static final int Statement = 239;
  public static final int StatementCommentPart = 240;
  public static final int StatementList = 241;
  public static final int StaticFieldDeclaration = 242;
  public static final int StaticFieldReference = 243;
  public static final int StaticInitializer = 244;
  public static final int StaticKind = 245;
  public static final int StaticMethodCall = 246;
  public static final int StaticMethodDeclaration = 247;
  public static final int StringBooleanOperation = 248;
  public static final int StringLiteral = 249;
  public static final int StringToken = 250;
  public static final int StringType = 251;
  public static final int StubInitializer = 252;
  public static final int StubStatementList = 253;
  public static final int SubstringExpression = 254;
  public static final int SuperConstructorInvocation = 255;
  public static final int SuperConstructorKind = 256;
  public static final int SuperInerfaceKind = 257;
  public static final int SuperInterfaceMethodCall = 258;
  public static final int SuperMethodCall = 259;
  public static final int SuperMethodKind = 260;
  public static final int SwitchCase = 261;
  public static final int SwitchStatement = 262;
  public static final int SynchronizedStatement = 263;
  public static final int TernaryOperatorExpression = 264;
  public static final int TextCommentPart = 265;
  public static final int ThisConstructorInvocation = 266;
  public static final int ThisConstructorKind = 267;
  public static final int ThisExpression = 268;
  public static final int ThrowStatement = 269;
  public static final int Tokens = 270;
  public static final int TrimOperation = 271;
  public static final int TryCatchStatement = 272;
  public static final int TryFinallyStatement = 273;
  public static final int TryUniversalStatement = 274;
  public static final int Type = 275;
  public static final int TypeAnnotable = 276;
  public static final int TypeDerivable = 277;
  public static final int TypeVariableDeclaration = 278;
  public static final int TypeVariableReference = 279;
  public static final int UnaryMinus = 280;
  public static final int UndefinedType = 281;
  public static final int UnknownConsCall = 282;
  public static final int UnknownDotCall = 283;
  public static final int UnknownLocalCall = 284;
  public static final int UnknownNameRef = 285;
  public static final int UnknownNew = 286;
  public static final int UnresolvedNameReference = 287;
  public static final int UnsignedRightShiftAssignmentExpression = 288;
  public static final int UpperBoundType = 289;
  public static final int UsingStatement = 290;
  public static final int ValueParameter = 291;
  public static final int ValueRef = 292;
  public static final int VariableArityType = 293;
  public static final int VariableDeclaration = 294;
  public static final int VariableReference = 295;
  public static final int Visibility = 296;
  public static final int VoidType = 297;
  public static final int WhileStatement = 298;
  public static final int WildCardType = 299;
  public static final int XorAssignmentExpression = 300;
