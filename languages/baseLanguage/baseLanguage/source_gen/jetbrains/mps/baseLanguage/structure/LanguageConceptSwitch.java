...
public final class LanguageConceptSwitch {
  ...
  public static final int GenericLValueExpression = 99;
  public static final int GenericNewExpression = 100;
  public static final int GetAccessor = 101;
  public static final int GreaterThanExpression = 102;
  public static final int GreaterThanOrEqualsExpression = 103;
  public static final int HasAnnotation = 104;
  public static final int HexIntegerLiteral = 105;
  public static final int IAnonymousClass = 106;
  public static final int IBLDeprecatable = 107;
  public static final int IBinaryLike = 108;
  public static final int IClassifier = 109;
  public static final int IClassifierMember = 110;
  public static final int IClassifierType = 111;
  public static final int IConditional = 112;
  public static final int IContainsStatementList = 113;
  public static final int IControlFlowInterrupter = 114;
  public static final int IExtractMethodAvailable = 115;
  public static final int IFinalWrapper = 116;
  public static final int IGenericType = 117;
  public static final int IHasModifiers = 118;
  public static final int IIncompleteParen = 119;
  public static final int IInternalType = 120;
  public static final int ILocalDeclaration = 121;
  public static final int ILocalReference = 122;
  public static final int ILocalVariableElement = 123;
  public static final int ILocalVariableElementList = 124;
  public static final int IMemberContainer = 125;
  public static final int IMethodCall = 126;
  public static final int IMethodLike = 127;
  public static final int IOperation = 128;
  public static final int IParameter = 129;
  public static final int ISkipsReturn = 130;
  public static final int IStatementListContainer = 131;
  public static final int IStaticContainerForMethods = 132;
  public static final int IThisExpression = 133;
  public static final int ITryCatchStatement = 134;
  public static final int ITypeApplicable = 135;
  public static final int IValidIdentifier = 136;
  public static final int IVariableAssignment = 137;
  public static final int IVariableDeclaration = 138;
  public static final int IVariableReference = 139;
  public static final int IVisible = 140;
  public static final int IWillBeClassifier = 141;
  public static final int IYetUnresolved = 142;
  public static final int IfStatement = 143;
  public static final int ImplicitAnnotationInstanceValue = 144;
  public static final int ImplicitAnnotationMethodKind = 145;
  public static final int IncompleteLeftParen = 146;
  public static final int IncompleteMemberDeclaration = 147;
  public static final int IncompleteRightParen = 148;
  public static final int InstanceInitializer = 149;
  public static final int InstanceMethodCallOperation = 150;
  public static final int InstanceMethodDeclaration = 151;
  public static final int InstanceOfExpression = 152;
  public static final int IntegerConstant = 153;
  public static final int IntegerLiteral = 154;
  public static final int IntegerType = 155;
  public static final int Interface = 156;
  public static final int IsEmptyOperation = 157;
  public static final int IsNotEmptyOperation = 158;
  public static final int JavaImport = 159;
  public static final int JavaImports = 160;
  public static final int JavaModifier = 161;
  public static final int LeftShiftAssignmentExpression = 162;
  public static final int LessThanExpression = 163;
  public static final int LessThanOrEqualsExpression = 164;
  public static final int LocalInstanceFieldReference = 165;
  public static final int LocalInstanceMethodCall = 166;
  public static final int LocalMethodCall = 167;
  public static final int LocalPropertyReference = 168;
  public static final int LocalStaticFieldReference = 169;
  public static final int LocalStaticMethodCall = 170;
  public static final int LocalToMethodKind = 171;
  public static final int LocalVariableDeclaration = 172;
  public static final int LocalVariableDeclarationStatement = 173;
  public static final int LongLiteral = 174;
  public static final int LongType = 175;
  public static final int LoopLabel = 176;
  public static final int LoopLabelReference = 177;
  public static final int LowerBoundType = 178;
  public static final int MethodDeclaration = 179;
  public static final int MinusAssignmentExpression = 180;
  public static final int MinusExpression = 181;
  public static final int Modifier = 182;
  public static final int MulAssignmentExpression = 183;
  public static final int MulExpression = 184;
  public static final int NPEEqualsExpression = 185;
  public static final int NPENotEqualsExpression = 186;
  public static final int NestedNewExpression = 187;
  public static final int NotEqualsExpression = 188;
  public static final int NotExpression = 189;
  public static final int NullLiteral = 190;
  public static final int NullType = 191;
  public static final int Number = 192;
  public static final int OperationAssignmentExpression = 193;
  public static final int OrAssignmentExpression = 194;
  public static final int OrExpression = 195;
  public static final int ParameterDeclaration = 196;
  public static final int ParenthesizedExpression = 197;
  public static final int PassByRefExpression = 198;
  public static final int PlaceholderMember = 199;
  public static final int PlusAssignmentExpression = 200;
  public static final int PlusExpression = 201;
  public static final int PostfixDecrementExpression = 202;
  public static final int PostfixIncrementExpression = 203;
  public static final int PrefixDecrementExpression = 204;
  public static final int PrefixIncrementExpression = 205;
  public static final int PrimitiveClassExpression = 206;
  public static final int PrimitiveType = 207;
  public static final int PrivateVisibility = 208;
  public static final int Property = 209;
  public static final int PropertyImplementation = 210;
  public static final int PropertyReference = 211;
  public static final int PropertyValueReference = 212;
  public static final int ProtectedVisibility = 213;
  public static final int PublicVisibility = 214;
  public static final int QualifiedSuperMethodCall = 215;
  public static final int RemAssignmentExpression = 216;
  public static final int RemExpression = 217;
  public static final int RemarkStatement = 218;
  public static final int ReturnStatement = 219;
  public static final int RightShiftAssignmentExpression = 220;
  public static final int SetAccessor = 221;
  public static final int ShiftLeftExpression = 222;
  public static final int ShiftRightExpression = 223;
  public static final int ShiftRightUnsignedExpression = 224;
  public static final int ShortType = 225;
  public static final int SingleLineComment = 226;
  public static final int Statement = 227;
  public static final int StatementCommentPart = 228;
  public static final int StatementList = 229;
  public static final int StaticFieldDeclaration = 230;
  public static final int StaticFieldReference = 231;
  public static final int StaticInitializer = 232;
  public static final int StaticKind = 233;
  public static final int StaticMethodCall = 234;
  public static final int StaticMethodDeclaration = 235;
  public static final int StringBooleanOperation = 236;
  public static final int StringLiteral = 237;
  public static final int StringToken = 238;
  public static final int StringType = 239;
  public static final int StubStatementList = 240;
  public static final int SubstringExpression = 241;
  public static final int SuperConstructorInvocation = 242;
  public static final int SuperConstructorKind = 243;
  public static final int SuperInerfaceKind = 244;
  public static final int SuperMethodCall = 245;
  public static final int SuperMethodKind = 246;
  public static final int SwitchCase = 247;
  public static final int SwitchStatement = 248;
  public static final int SynchronizedStatement = 249;
  public static final int TernaryOperatorExpression = 250;
  public static final int TextCommentPart = 251;
  public static final int ThisConstructorInvocation = 252;
  public static final int ThisConstructorKind = 253;
  public static final int ThisExpression = 254;
  public static final int ThrowStatement = 255;
  public static final int Tokens = 256;
  public static final int TrimOperation = 257;
  public static final int TryCatchStatement = 258;
  public static final int TryStatement = 259;
  public static final int Type = 260;
  public static final int TypeAnnotable = 261;
  public static final int TypeDerivable = 262;
  public static final int TypeVariableDeclaration = 263;
  public static final int TypeVariableReference = 264;
  public static final int UnaryMinus = 265;
  public static final int UndefinedType = 266;
  public static final int UnknownConsCall = 267;
  public static final int UnknownDotCall = 268;
  public static final int UnknownLocalCall = 269;
  public static final int UnknownNameRef = 270;
  public static final int UnknownNew = 271;
  public static final int UnresolvedNameReference = 272;
  public static final int UnsignedRightShiftAssignmentExpression = 273;
  public static final int UpperBoundType = 274;
  public static final int UsingStatement = 275;
  public static final int ValueParameter = 276;
  public static final int ValueRef = 277;
  public static final int VarType = 278;
  public static final int VariableArityType = 279;
  public static final int VariableDeclaration = 280;
  public static final int VariableReference = 281;
  public static final int Visibility = 282;
  public static final int VoidType = 283;
  public static final int WhileStatement = 284;
  public static final int WildCardType = 285;
  public static final int XorAssignmentExpression = 286;
