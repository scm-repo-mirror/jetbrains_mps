...
public final class LanguageConceptSwitch {
  ...
  public static final int ISkipsReturn = 149;
  public static final int IStatementListContainer = 150;
  public static final int IStaticContainerForMethods = 151;
  public static final int IThisExpression = 152;
  public static final int IThrowCheckedExceptions = 153;
  public static final int ITryCatchStatement = 154;
  public static final int ITypeApplicable = 155;
  public static final int IValidIdentifier = 156;
  public static final int IVariableAssignment = 157;
  public static final int IVariableDeclaration = 158;
  public static final int IVariableReference = 159;
  public static final int IVisible = 160;
  public static final int IWillBeClassifier = 161;
  public static final int IYetUnresolved = 162;
  public static final int IfStatement = 163;
  public static final int ImplicitAnnotationInstanceValue = 164;
  public static final int ImplicitAnnotationMethodKind = 165;
  public static final int IncompleteLeftParen = 166;
  public static final int IncompleteMemberDeclaration = 167;
  public static final int IncompleteRightParen = 168;
  public static final int InferredClassifierType = 169;
  public static final int InferredType = 170;
  public static final int InstanceInitializer = 171;
  public static final int InstanceMethodCallOperation = 172;
  public static final int InstanceMethodDeclaration = 173;
  public static final int InstanceOfExpression = 174;
  public static final int IntegerConstant = 175;
  public static final int IntegerLiteral = 176;
  public static final int IntegerType = 177;
  public static final int Interface = 178;
  public static final int IntersectionType = 179;
  public static final int IsEmptyOperation = 180;
  public static final int IsNotEmptyOperation = 181;
  public static final int JavaImport = 182;
  public static final int JavaImports = 183;
  public static final int JavaModifier = 184;
  public static final int LeftShiftAssignmentExpression = 185;
  public static final int LessThanExpression = 186;
  public static final int LessThanOrEqualsExpression = 187;
  public static final int LocalInstanceFieldReference = 188;
  public static final int LocalInstanceMethodCall = 189;
  public static final int LocalMethodCall = 190;
  public static final int LocalPropertyReference = 191;
  public static final int LocalStaticFieldReference = 192;
  public static final int LocalStaticMethodCall = 193;
  public static final int LocalToMethodKind = 194;
  public static final int LocalVariableDeclaration = 195;
  public static final int LocalVariableDeclarationStatement = 196;
  public static final int LongLiteral = 197;
  public static final int LongType = 198;
  public static final int LoopLabel = 199;
  public static final int LoopLabelReference = 200;
  public static final int LowerBoundType = 201;
  public static final int MethodDeclaration = 202;
  public static final int MinusAssignmentExpression = 203;
  public static final int MinusExpression = 204;
  public static final int Modifier = 205;
  public static final int MulAssignmentExpression = 206;
  public static final int MulExpression = 207;
  public static final int MultiLineComment = 208;
  public static final int MultipleCatchClause = 209;
  public static final int NPEEqualsExpression = 210;
  public static final int NPENotEqualsExpression = 211;
  public static final int NestedNewExpression = 212;
  public static final int NotEqualsExpression = 213;
  public static final int NotExpression = 214;
  public static final int NullLiteral = 215;
  public static final int NullType = 216;
  public static final int Number = 217;
  public static final int OctalIntegerLiteral = 218;
  public static final int OperationAssignmentExpression = 219;
  public static final int OrAssignmentExpression = 220;
  public static final int OrExpression = 221;
  public static final int ParameterDeclaration = 222;
  public static final int ParenthesizedExpression = 223;
  public static final int PassByRefExpression = 224;
  public static final int PlaceholderMember = 225;
  public static final int PlusAssignmentExpression = 226;
  public static final int PlusExpression = 227;
  public static final int PostfixDecrementExpression = 228;
  public static final int PostfixIncrementExpression = 229;
  public static final int PrefixDecrementExpression = 230;
  public static final int PrefixIncrementExpression = 231;
  public static final int PrimitiveClassExpression = 232;
  public static final int PrimitiveType = 233;
  public static final int PrivateVisibility = 234;
  public static final int Property = 235;
  public static final int PropertyImplementation = 236;
  public static final int PropertyReference = 237;
  public static final int PropertyValueReference = 238;
  public static final int ProtectedVisibility = 239;
  public static final int PublicVisibility = 240;
  public static final int QualifiedReference = 241;
  public static final int QualifiedSuperMethodCall = 242;
  public static final int RemAssignmentExpression = 243;
  public static final int RemExpression = 244;
  public static final int RemarkStatement = 245;
  public static final int ResourceVariable = 246;
  public static final int ReturnStatement = 247;
  public static final int RightShiftAssignmentExpression = 248;
  public static final int SetAccessor = 249;
  public static final int ShiftLeftExpression = 250;
  public static final int ShiftRightExpression = 251;
  public static final int ShiftRightUnsignedExpression = 252;
  public static final int ShortType = 253;
  public static final int SingleLineComment = 254;
  public static final int Statement = 255;
  public static final int StatementCommentPart = 256;
  public static final int StatementList = 257;
  public static final int StaticFieldDeclaration = 258;
  public static final int StaticFieldReference = 259;
  public static final int StaticFieldReferenceOperation = 260;
  public static final int StaticInitializer = 261;
  public static final int StaticKind = 262;
  public static final int StaticMethodCall = 263;
  public static final int StaticMethodCallOperation = 264;
  public static final int StaticMethodDeclaration = 265;
  public static final int StringBooleanOperation = 266;
  public static final int StringLiteral = 267;
  public static final int StringToken = 268;
  public static final int StringType = 269;
  public static final int StubInitializer = 270;
  public static final int StubStatementList = 271;
  public static final int SubstringExpression = 272;
  public static final int SuperConstructorInvocation = 273;
  public static final int SuperConstructorKind = 274;
  public static final int SuperInerfaceKind = 275;
  public static final int SuperInterfaceMethodCall = 276;
  public static final int SuperMethodCall = 277;
  public static final int SuperMethodKind = 278;
  public static final int SwitchCase = 279;
  public static final int SwitchCaseExtension = 280;
  public static final int SwitchStatement = 281;
  public static final int SynchronizedStatement = 282;
  public static final int TernaryOperatorExpression = 283;
  public static final int TextCommentPart = 284;
  public static final int ThisConstructorInvocation = 285;
  public static final int ThisConstructorKind = 286;
  public static final int ThisExpression = 287;
  public static final int ThrowStatement = 288;
  public static final int Tokens = 289;
  public static final int TrimOperation = 290;
  public static final int TryCatchStatement = 291;
  public static final int TryFinallyStatement = 292;
  public static final int TryUniversalStatement = 293;
  public static final int Type = 294;
  public static final int TypeAnnotable = 295;
  public static final int TypeDerivable = 296;
  public static final int TypeVariableDeclaration = 297;
  public static final int TypeVariableReference = 298;
  public static final int UnaryMinus = 299;
  public static final int UndefinedType = 300;
  public static final int UnionType = 301;
  public static final int UnknownConsCall = 302;
  public static final int UnknownDotCall = 303;
  public static final int UnknownInstanceMethodCall = 304;
  public static final int UnknownLocalCall = 305;
  public static final int UnknownNameRef = 306;
  public static final int UnknownNew = 307;
  public static final int UnresolvedNameReference = 308;
  public static final int UnsignedRightShiftAssignmentExpression = 309;
  public static final int UpperBoundType = 310;
  public static final int UsingStatement = 311;
  public static final int ValueParameter = 312;
  public static final int ValueRef = 313;
  public static final int VariableArityType = 314;
  public static final int VariableDeclaration = 315;
  public static final int VariableReference = 316;
  public static final int Visibility = 317;
  public static final int VoidType = 318;
  public static final int WhileStatement = 319;
  public static final int WildCardType = 320;
  public static final int XorAssignmentExpression = 321;
