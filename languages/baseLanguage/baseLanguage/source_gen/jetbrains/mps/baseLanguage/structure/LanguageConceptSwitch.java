...
public final class LanguageConceptSwitch {
  ...
  public static final int InstanceInitializer = 168;
  public static final int InstanceMethodCallOperation = 169;
  public static final int InstanceMethodDeclaration = 170;
  public static final int InstanceOfExpression = 171;
  public static final int IntegerConstant = 172;
  public static final int IntegerLiteral = 173;
  public static final int IntegerType = 174;
  public static final int Interface = 175;
  public static final int IntersectionType = 176;
  public static final int IsEmptyOperation = 177;
  public static final int IsNotEmptyOperation = 178;
  public static final int JavaImport = 179;
  public static final int JavaImports = 180;
  public static final int JavaModifier = 181;
  public static final int LeftShiftAssignmentExpression = 182;
  public static final int LessThanExpression = 183;
  public static final int LessThanOrEqualsExpression = 184;
  public static final int LocalInstanceFieldReference = 185;
  public static final int LocalInstanceMethodCall = 186;
  public static final int LocalMethodCall = 187;
  public static final int LocalPropertyReference = 188;
  public static final int LocalStaticFieldReference = 189;
  public static final int LocalStaticMethodCall = 190;
  public static final int LocalToMethodKind = 191;
  public static final int LocalVariableDeclaration = 192;
  public static final int LocalVariableDeclarationStatement = 193;
  public static final int LongLiteral = 194;
  public static final int LongType = 195;
  public static final int LoopLabel = 196;
  public static final int LoopLabelReference = 197;
  public static final int LowerBoundType = 198;
  public static final int MethodDeclaration = 199;
  public static final int MinusAssignmentExpression = 200;
  public static final int MinusExpression = 201;
  public static final int Modifier = 202;
  public static final int MulAssignmentExpression = 203;
  public static final int MulExpression = 204;
  public static final int MultiLineComment = 205;
  public static final int MultipleCatchClause = 206;
  public static final int NPEEqualsExpression = 207;
  public static final int NPENotEqualsExpression = 208;
  public static final int NestedNewExpression = 209;
  public static final int NotEqualsExpression = 210;
  public static final int NotExpression = 211;
  public static final int NullLiteral = 212;
  public static final int NullType = 213;
  public static final int Number = 214;
  public static final int OctalIntegerLiteral = 215;
  public static final int OperationAssignmentExpression = 216;
  public static final int OrAssignmentExpression = 217;
  public static final int OrExpression = 218;
  public static final int ParameterDeclaration = 219;
  public static final int ParenthesizedExpression = 220;
  public static final int PassByRefExpression = 221;
  public static final int PlaceholderMember = 222;
  public static final int PlusAssignmentExpression = 223;
  public static final int PlusExpression = 224;
  public static final int PostfixDecrementExpression = 225;
  public static final int PostfixIncrementExpression = 226;
  public static final int PrefixDecrementExpression = 227;
  public static final int PrefixIncrementExpression = 228;
  public static final int PrimitiveClassExpression = 229;
  public static final int PrimitiveType = 230;
  public static final int PrivateVisibility = 231;
  public static final int Property = 232;
  public static final int PropertyImplementation = 233;
  public static final int PropertyReference = 234;
  public static final int PropertyValueReference = 235;
  public static final int ProtectedVisibility = 236;
  public static final int PublicVisibility = 237;
  public static final int QualifiedReference = 238;
  public static final int QualifiedSuperMethodCall = 239;
  public static final int RemAssignmentExpression = 240;
  public static final int RemExpression = 241;
  public static final int RemarkStatement = 242;
  public static final int ResourceVariable = 243;
  public static final int ReturnStatement = 244;
  public static final int RightShiftAssignmentExpression = 245;
  public static final int SetAccessor = 246;
  public static final int ShiftLeftExpression = 247;
  public static final int ShiftRightExpression = 248;
  public static final int ShiftRightUnsignedExpression = 249;
  public static final int ShortType = 250;
  public static final int SingleLineComment = 251;
  public static final int Statement = 252;
  public static final int StatementCommentPart = 253;
  public static final int StatementList = 254;
  public static final int StaticFieldDeclaration = 255;
  public static final int StaticFieldReference = 256;
  public static final int StaticFieldReferenceOperation = 257;
  public static final int StaticInitializer = 258;
  public static final int StaticKind = 259;
  public static final int StaticMethodCall = 260;
  public static final int StaticMethodCallOperation = 261;
  public static final int StaticMethodDeclaration = 262;
  public static final int StringBooleanOperation = 263;
  public static final int StringLiteral = 264;
  public static final int StringToken = 265;
  public static final int StringType = 266;
  public static final int StubInitializer = 267;
  public static final int StubStatementList = 268;
  public static final int SubstringExpression = 269;
  public static final int SuperConstructorInvocation = 270;
  public static final int SuperConstructorKind = 271;
  public static final int SuperInerfaceKind = 272;
  public static final int SuperInterfaceMethodCall = 273;
  public static final int SuperMethodCall = 274;
  public static final int SuperMethodKind = 275;
  public static final int SwitchCase = 276;
  public static final int SwitchCaseExtension = 277;
  public static final int SwitchStatement = 278;
  public static final int SynchronizedStatement = 279;
  public static final int TernaryOperatorExpression = 280;
  public static final int TextCommentPart = 281;
  public static final int ThisConstructorInvocation = 282;
  public static final int ThisConstructorKind = 283;
  public static final int ThisExpression = 284;
  public static final int ThrowStatement = 285;
  public static final int Tokens = 286;
  public static final int TrimOperation = 287;
  public static final int TryCatchStatement = 288;
  public static final int TryFinallyStatement = 289;
  public static final int TryUniversalStatement = 290;
  public static final int Type = 291;
  public static final int TypeAnnotable = 292;
  public static final int TypeDerivable = 293;
  public static final int TypeVariableDeclaration = 294;
  public static final int TypeVariableReference = 295;
  public static final int UnaryMinus = 296;
  public static final int UndefinedType = 297;
  public static final int UnionType = 298;
  public static final int UnknownConsCall = 299;
  public static final int UnknownDotCall = 300;
  public static final int UnknownInstanceMethodCall = 301;
  public static final int UnknownLocalCall = 302;
  public static final int UnknownNameRef = 303;
  public static final int UnknownNew = 304;
  public static final int UnresolvedNameReference = 305;
  public static final int UnsignedRightShiftAssignmentExpression = 306;
  public static final int UpperBoundType = 307;
  public static final int UsingStatement = 308;
  public static final int ValueParameter = 309;
  public static final int ValueRef = 310;
  public static final int VariableArityType = 311;
  public static final int VariableDeclaration = 312;
  public static final int VariableReference = 313;
  public static final int Visibility = 314;
  public static final int VoidType = 315;
  public static final int WhileStatement = 316;
  public static final int WildCardType = 317;
  public static final int XorAssignmentExpression = 318;
