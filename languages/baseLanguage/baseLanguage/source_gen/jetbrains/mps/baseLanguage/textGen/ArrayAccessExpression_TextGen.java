...
public class ArrayAccessExpression_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.appendNode(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.array$L7S$));
    tgs.append("[");
    tgs.appendNode(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.index$JFzt));
    tgs.append("]");
  }
