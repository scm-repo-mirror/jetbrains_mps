...
public class ReturnStatement_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.indent();
    tgs.append("return");
    if ((SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.expression$eJ92) != null)) {
      tgs.append(" ");
      tgs.appendNode(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.expression$eJ92));
    }
    tgs.append(";");
