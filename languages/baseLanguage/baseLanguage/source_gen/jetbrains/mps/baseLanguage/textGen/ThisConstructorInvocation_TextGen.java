...
public class ThisConstructorInvocation_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    if (tgs.needPositions()) {
      tgs.fillPositionInfo(TraceableConcept__BehaviorDescriptor.getTraceableProperty_id4pl5GY7LKmH.invoke(SNodeOperations.cast(ctx.getPrimaryInput(), AUX_4fkatk.TraceableConcept_228d6872)));
    }
  }

  private static final class AUX_4fkatk {
