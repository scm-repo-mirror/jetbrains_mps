...
public class ThisExpression_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    if ((SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.classConcept$Hbij) != null)) {
      tgs.append(SPropertyOperations.getString(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.classConcept$Hbij), PROPS.name$tAp1));
      tgs.append(".this");
    } else {
      tgs.append("this");
    }
