...
public class AddMissingParensToNotExpression_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    ...
    SLinkOperations.setTarget(parens, LINKS.expression$TlhM, SLinkOperations.getTarget(SNodeOperations.cast(node, CONCEPTS.NotExpression$Pc), LINKS.expression$sv_H));
    SLinkOperations.setTarget(SNodeOperations.cast(node, CONCEPTS.NotExpression$Pc), LINKS.expression$sv_H, parens);
  }
