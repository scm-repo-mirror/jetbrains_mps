...
public class Add_NotNullAnnotation_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    ...
    SLinkOperations.setPointer(instance, LINKS.annotation$12Ek, new SNodePointer("3f233e7f-b8a6-46d2-a57f-795d56775243/java:org.jetbrains.annotations(Annotations/)", "~NotNull"));
    ListSequence.fromList(SLinkOperations.getChildren(((SNode) Add_NotNullAnnotation_QuickFix.this.getField("method")[0]), LINKS.annotation$K49I)).addElement(instance);
  }
