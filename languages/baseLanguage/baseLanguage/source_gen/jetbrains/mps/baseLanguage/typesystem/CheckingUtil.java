...
public class CheckingUtil {
  private static final Logger LOG = Logger.getLogger(CheckingUtil.class);
  public CheckingUtil() {
  }
  ...
  public static boolean isValidByteOrShortExpression(SNode expectedType, SNode expr) {
    ...
    try {
      ...
      if (LOG.isWarningLevel()) {
        LOG.warning("Unable to obtain a compile time constant for " + SNodeOperations.present(expr) + ". Resorting to default.");
      }
      return false;
    }
  }
