...
public class MakeVariableFinal_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SPropertyOperations.set(SLinkOperations.getTarget(((SNode) MakeVariableFinal_QuickFix.this.getField("varRef")[0]), LINKS.variableDeclaration$2ky6), PROPS.isFinal$hIht, true);
  }
