...
public class ReplaceClassAntiquotationWithClassifierType_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SNode expression = SLinkOperations.getTarget(((SNode) ReplaceClassAntiquotationWithClassifierType_QuickFix.this.getField("antiquotation")[0]), LINKS.expression$kIm0);
    ...
    SNode referenceAntiquotation = AttributeOperations.createAndSetAttrbiute(classifierType, new IAttributeDescriptor.LinkAttribute(CONCEPTS.ReferenceAntiquotation$WH, LINKS.classifier$pQ_R), CONCEPTS.ReferenceAntiquotation$WH);
    SLinkOperations.setTarget(referenceAntiquotation, LINKS.expression$kIm0, expression);
  }
