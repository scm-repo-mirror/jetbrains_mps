...
public class TurnStaticMethodCallOperationToInstanceMethodCall_QuickFix extends QuickFix_Runtime {
  public TurnStaticMethodCallOperationToInstanceMethodCall_QuickFix() {
    super(new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "6973834013063127785"));
  }
  public void execute(SNode node) {
    ...
    SNode n = SLinkOperations.getTarget(SNodeOperations.as(node, CONCEPTS.StaticMethodCallOperation$Uo), LINKS.baseMethodDeclaration$pyYw);
    SLinkOperations.setTarget(call, LINKS.baseMethodDeclaration$pyYw, SNodeOperations.as(n, CONCEPTS.InstanceMethodDeclaration$39));
