...
public class check_CaughtWasThrown_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode catchClause, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SNodeOperations.isInstanceOf(caughtType, AUX_r5g8rc.ClassifierType_42700403)) {
      SNode caughtClassifier = SLinkOperations.getTarget(SNodeOperations.cast(caughtType, AUX_r5g8rc.ClassifierType_42700403), MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"));
          ...
          SNode matchedNode_13ophr_b0a1a1a = SNodeOperations.getParent(catchClause);
          {
            boolean matches_13ophr_a1a0b0b0 = false;
            {
              ...
              if (matchingNode_13ophr_a1a0b0b0 != null) {
                matches_13ophr_a1a0b0b0 = matchingNode_13ophr_a1a0b0b0.getConcept().isSubConceptOf(AUX_r5g8rc.TryCatchStatement_fb61ebd);
              }
            }
            if (matches_13ophr_a1a0b0b0) {
              ...
              boolean matches_13ophr_b1a0b0b0 = false;
              {
                ...
                if (matchingNode_13ophr_b1a0b0b0 != null) {
                  matches_13ophr_b1a0b0b0 = matchingNode_13ophr_b1a0b0b0.getConcept().isSubConceptOf(AUX_r5g8rc.TryStatement_d214e8c2);
                }
              }
  ...
  public SAbstractConcept getApplicableConcept() {
    return AUX_r5g8rc.CatchClause_870e8b84;
  }
  ...
  private static final class AUX_r5g8rc {
