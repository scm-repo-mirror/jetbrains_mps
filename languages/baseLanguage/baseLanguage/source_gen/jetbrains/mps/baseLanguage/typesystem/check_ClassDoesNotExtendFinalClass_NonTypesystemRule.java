...
public class check_ClassDoesNotExtendFinalClass_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode classConcept, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if ((superclass != null)) {
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(superclass, LINKS.classifier$pQ_R), CONCEPTS.ClassConcept$IY) && SPropertyOperations.getBoolean(SNodeOperations.cast(SLinkOperations.getTarget(superclass, LINKS.classifier$pQ_R), CONCEPTS.ClassConcept$IY), PROPS.isFinal$dzaH)) {
        {
