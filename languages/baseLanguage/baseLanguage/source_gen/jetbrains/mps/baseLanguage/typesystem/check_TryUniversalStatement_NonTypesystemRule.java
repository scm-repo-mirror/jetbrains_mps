...
public class check_TryUniversalStatement_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode tryStatement, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (!(ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.resource$hgXi)).isNotEmpty() || ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.catchClause$Q4F)).isNotEmpty() || (SLinkOperations.getTarget(tryStatement, LINKS.finallyClause$KUl) != null))) {
