...
public class typeOf_TernaryOperator_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode toe, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(toe, LINKS.condition$nwNI);
    ...
    {
      final SNode iftrue = typeCheckingContext.typeOf(SLinkOperations.getTarget(toe, LINKS.ifTrue$Tg0R), "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "3096905448806653315", true);
      typeCheckingContext.whenConcrete(iftrue, new Runnable() {
        public void run() {
          {
            final SNode iffalse = typeCheckingContext.typeOf(SLinkOperations.getTarget(toe, LINKS.ifFalse$Wbma), "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "3096905448806666273", true);
  ...
  private static SNode _quotation_createNode_n8o2jn_a1a0c0a0b() {
