...
public class typeof_FieldReferenceOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
...

    {
      ...
      typeCheckingContext.whenConcrete(OT, new Runnable() {
        public void run() {
          ...
          if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(OT), AUX_7hlfbz.IGenericType_d5d80471) && SNodeOperations.isInstanceOf(fieldType, AUX_7hlfbz.IGenericType_d5d80471)) {
            Map<SNode, SNode> subs = MapSequence.fromMap(new HashMap<SNode, SNode>());
            IGenericType__BehaviorDescriptor.collectGenericSubstitutions_id3zZky3wF74h.invoke(SNodeOperations.cast(typeCheckingContext.getExpandedNode(OT), AUX_7hlfbz.IGenericType_d5d80471), subs);
            fieldType = IGenericType__BehaviorDescriptor.expandGenerics_id3zZky3wFPhu.invoke(SNodeOperations.cast(fieldType, AUX_7hlfbz.IGenericType_d5d80471), subs);
          }
  ...
  public SAbstractConcept getApplicableConcept() {
    return AUX_7hlfbz.FieldReferenceOperation_fc8d5dda;
  }
  ...
  private static final class AUX_7hlfbz {
