...
public class ConstantValue_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ConstantValue_Constraints(ConstraintsDescriptorInitContext initContext) {
    ...
    record(new ClassName_PD(this));
    record(new RD1(this));
  }

  /*package*/ static final class ClassName_PD extends BasePropertyConstraintsDescriptor {
    public ClassName_PD(ConstraintsDescriptor container) {
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.constant$fw$M, container, true, false);
    }
    @Nullable
    @Override
