...
/*package*/ class PrimitiveTypeDescriptor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class extendsListHandler_7ntfj2_d0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.extends$HFCu;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.PrimitiveTypeRef$bm;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(extendsListHandler_7ntfj2_d0.this.getNode(), LINKS.extends$HFCu));
      try {
