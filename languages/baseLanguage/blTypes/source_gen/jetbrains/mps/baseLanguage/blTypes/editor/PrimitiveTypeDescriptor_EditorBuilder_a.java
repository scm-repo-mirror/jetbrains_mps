...
/*package*/ class PrimitiveTypeDescriptor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class extendsListHandler_7ntfj2_d0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.extends$OHQI;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.PrimitiveTypeRef$pA;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(extendsListHandler_7ntfj2_d0.this.getNode(), LINKS.extends$OHQI));
      try {
