...
public class IMemberOperation_Constraints extends BaseConstraintsDescriptor {
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.member$oLt6, container, true, false);
    }
    @Nullable
    @Override
    public ReferenceScopeProvider getScopeProvider() {
      return new BaseScopeProvider() {
        ...
        public Scope createScope(final ReferenceConstraintsContext _context) {
          ...
          {
            SNode coercedNode_dyvyal_d0b0a0a0b2 = TypecheckingFacade.getFromContext().coerceType(TypecheckingFacade.getFromContext().getTypeOf(operand), CONCEPTS.BaseClassifierType$S7);
            if (coercedNode_dyvyal_d0b0a0a0b2 != null) {
              for (SNode member : ListSequence.fromList(BaseClassifierType__BehaviorDescriptor.getMembers_idhEwINC$.invoke(coercedNode_dyvyal_d0b0a0a0b2, enclosingNode))) {
