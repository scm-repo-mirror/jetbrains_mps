...
/*package*/ class DefaultClassifierMethodDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_77c6be_a9a() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.throwsItem$gr7e)).isNotEmpty();
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new returnTypeSingleRoleHandler_77c6be_e0(myNode, LINKS.returnType$WIkw, getEditorContext());
  ...
  private static class parameterListHandler_77c6be_h0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_77c6be_h0.this.getNode(), LINKS.parameter$WIkZ));
      try {
  ...
  private EditorCell createConstant_2() {
    ...
    style.set(StyleAttributes.SELECTABLE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.DefaultClassifierMethodDeclaration$ZH, "jetbrains.mps.baseLanguage.classifiers.editor.DefaultClassifierMethodDeclaration_ApplySideTransforms"));
    editorCell.setDefaultText("");
  ...
  private static class throwsItemListHandler_77c6be_b9a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(throwsItemListHandler_77c6be_b9a.this.getNode(), LINKS.throwsItem$gr7e));
      try {
        EditorCell emptyCell = null;
