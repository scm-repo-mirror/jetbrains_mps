...
public class SubstituteMembersInsideOfClassifier_Contribution extends SubstituteMenuBase {
  public SubstituteMembersInsideOfClassifier_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Expression", new SNodePointer("r:00000000-0000-4000-0000-011c89590370(jetbrains.mps.baseLanguage.classifiers.editor)", "1741258697587053520")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_c574em_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    private class SMP_Param_c574em_a0 extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
      /*package*/ SMP_Param_c574em_a0() {
        super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c89590370(jetbrains.mps.baseLanguage.classifiers.editor)", "1741258697587053664")));
      }
      @NotNull
      @Override
      protected List<SubstituteMenuItem> createItems(SNode parameter, SubstituteMenuContext context) {
        return new SMP_Action_c574em_a0a(parameter).createItems(context);
      }
      @Nullable
      @Override
      ...
      private class SMP_Action_c574em_a0a extends SingleItemSubstituteMenuPart {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          /*package*/ void resetTraceInfo() {
            ...
            updateTraceInfo(description, new SNodePointer("r:00000000-0000-4000-0000-011c89590370(jetbrains.mps.baseLanguage.classifiers.editor)", "1741258697587053701"));
          }
