...
<model ref="r:158a0fcf-bdbc-4dde-85d2-af0cae5e3720(closures.sandbox.adapters)">
  ...
  <node concept="3HP615" id="7IuYOnZLDCv">
    <property role="TrG5h" value="InterfaceAdapterDemo" />
    <node concept="3clFb_" id="7IuYOnZLDDt" role="jymVt">
      <property role="TrG5h" value="calc" />
      <node concept="37vLTG" id="7IuYOnZLDDu" role="3clF46">
        <property role="TrG5h" value="s" />
        <node concept="16syzq" id="7IuYOnZLDDv" role="1tU5fm">
          <ref role="16sUi3" node="7IuYOnZLDIV" resolve="P" />
        </node>
      </node>
      <node concept="3Tm1VV" id="7IuYOnZLDDw" role="1B3o_S" />
      <node concept="3clFbS" id="7IuYOnZLDDx" role="3clF47" />
      <node concept="16syzq" id="7IuYOnZLDDy" role="3clF45">
        <ref role="16sUi3" node="7IuYOnZLDI1" resolve="R" />
      </node>
    </node>
    <node concept="2tJIrI" id="7IuYOnZLEbE" role="jymVt" />
    <node concept="3_nuBB" id="7IuYOnZLDDz" role="jymVt">
      <node concept="37vLTG" id="7IuYOnZLDD$" role="3clF46">
        <property role="TrG5h" value="foo" />
        <node concept="16syzq" id="7IuYOnZLDD_" role="1tU5fm">
          <ref role="16sUi3" node="7IuYOnZLDIV" resolve="P" />
        </node>
      </node>
      <node concept="16syzq" id="7IuYOnZLDDA" role="3clF45">
        <ref role="16sUi3" node="7IuYOnZLDI1" resolve="R" />
      </node>
      <node concept="3Tm1VV" id="7IuYOnZLDDB" role="1B3o_S" />
      <node concept="3clFbS" id="7IuYOnZLDDC" role="3clF47">
        <node concept="3clFbF" id="7IuYOnZLDMv" role="3cqZAp">
          <node concept="1rXfSq" id="7IuYOnZLDMu" role="3clFbG">
            <ref role="37wK5l" node="7IuYOnZLDDt" resolve="calc" />
            <node concept="37vLTw" id="7IuYOnZLDPc" role="37wK5m">
              <ref role="3cqZAo" node="7IuYOnZLDD$" resolve="foo" />
            </node>
          </node>
        </node>
      </node>
      <node concept="2JFqV2" id="7IuYOnZLDKh" role="2frcjj" />
    </node>
    <node concept="3Tm1VV" id="7IuYOnZLDCw" role="1B3o_S" />
    <node concept="16euLQ" id="7IuYOnZLDI1" role="16eVyc">
      <property role="TrG5h" value="R" />
    </node>
    <node concept="16euLQ" id="7IuYOnZLDIV" role="16eVyc">
      <property role="TrG5h" value="P" />
    </node>
  </node>
</model>
