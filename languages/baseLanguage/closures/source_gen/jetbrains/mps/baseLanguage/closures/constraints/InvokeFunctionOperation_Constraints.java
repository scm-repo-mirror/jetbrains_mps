...
public class InvokeFunctionOperation_Constraints extends BaseConstraintsDescriptor {
  public InvokeFunctionOperation_Constraints() {
    super(AUX_eiq9fr.InvokeFunctionOperation_7fb1c3cd);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return SNodeOperations.isInstanceOf(parentNode, AUX_eiq9fr.DotExpression_97ed08d8) && (TypecheckingFacade.getFromContext().strongCoerceType(TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(SNodeOperations.cast(parentNode, AUX_eiq9fr.DotExpression_97ed08d8), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, 0x116b46a4416L, "operand"))), AUX_eiq9fr.FunctionType_27eadd12) != null);
  }
  ...
  private static final class AUX_eiq9fr {
