...
public class CompactInvokeFunctionExpression_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    _context.getBuilder().build((SNode) SLinkOperations.getTarget(_context.getNode(), LINKS.function$vcpr));
    for (SNode p : SLinkOperations.getChildren(_context.getNode(), LINKS.parameter$GNIj)) {
