...
public final class UpdateRuntimeUtil_MigrationScript extends BaseMigrationScript {
  ...
  public UpdateRuntimeUtil_MigrationScript() {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring() {
      ...
      public SAbstractConcept getApplicableConcept() {
        return AUX_6fj2xh.StaticMethodDeclaration_9cd8c445;
      }
      @Override
      ...
      public void doUpdateInstanceNode(SNode node) {
        ...
        for (SNode ifc : SNodeOperations.ofConcept(SLinkOperations.getChildren(fncls, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, 0x4a9a46de59132803L, "member")), AUX_6fj2xh.Interface_bca2069)) {
          ListSequence.fromList(SLinkOperations.getChildren(ssw, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10ef02a8c6aL, 0x10ef02edcafL, "case"))).addElement(_quotation_createNode_tdy3l4_a0a0a11a0a(SPropertyOperations.getString(ifc, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")), NodePointer__BehaviorDescriptor.create_id4nxIQVL$eu9.invoke(SNodeOperations.asSConcept(AUX_6fj2xh.NodePointer_a7ab22d1), SNodeOperations.getModel(node), ifc.getReference())));
        }
      }
      @Override
  ...
  private static final class AUX_6fj2xh {
