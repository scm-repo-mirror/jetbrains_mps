...
public final class UpdateRuntimeUtil_MigrationScript extends BaseMigrationScript {
  ...
  private static SNode _quotation_createNode_tdy3l4_a0a0a11a0a(Object parameter_1, Object parameter_2) {
    ...
    quotedNode_3.addChild(LINKS.expression$zuuG, quotedNode_4);
    ...
    if (quotedNode_8 != null) {
      quotedNode_7.addChild(LINKS.ref$Xkjz, SNodeOperations.copyIfNecessary(quotedNode_8));
    }
    quotedNode_6.addChild(LINKS.expression$EsbK, quotedNode_7);
    quotedNode_5.addChild(LINKS.statement$WHn8, quotedNode_6);
    quotedNode_3.addChild(LINKS.body$2Ve6, quotedNode_5);
    return quotedNode_3;
  }
