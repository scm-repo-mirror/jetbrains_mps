...
public abstract class AbstractSequence<T> implements ISequence<T>, Iterable<T> {
  ...
  @Override
  public ISequence<T> where(_FunctionTypes._return_P1_E0<? extends Boolean, ? super T> filter) {
    return new FilteringSequence<T>(this, filter);
  }
  @Override
  public T findFirst(_FunctionTypes._return_P1_E0<? extends Boolean, ? super T> filter) {
    return where(filter).first();
  }
  @Override
  public T findLast(_FunctionTypes._return_P1_E0<? extends Boolean, ? super T> filter) {
    return where(filter).last();
  }
  @Override
  public boolean any(_FunctionTypes._return_P1_E0<? extends Boolean, ? super T> filter) {
    return where(filter).isNotEmpty();
  }
  @Override
  public boolean all(_FunctionTypes._return_P1_E0<? extends Boolean, ? super T> filter) {
    return where(new NegateWhereFilter<T>(filter)).isEmpty();
  }
  @Override
  public <U> ISequence<U> translate(_FunctionTypes._return_P1_E0<? extends Iterable<U>, ? super T> translator) {
    return new TranslatingSequence<T, U>(this, translator);
  }
  @Override
  public <U> ISequence<U> select(_FunctionTypes._return_P1_E0<? extends U, ? super T> selector) {
  ...
  @Override
  public ISequence<T> sort(_FunctionTypes._return_P1_E0<? extends Comparable<?>, ? super T> selector, boolean ascending) {
    return new SortingSequence<T>(this, new SelectComparator<T>(selector), ascending);
  }
  @Override
  public ISequence<T> alsoSort(_FunctionTypes._return_P1_E0<? extends Comparable<?>, ? super T> selector, boolean ascending) {
  ...
  @Override
  public void visitAll(_FunctionTypes._void_P1_E0<? super T> visitor) {
