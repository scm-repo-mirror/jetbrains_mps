...
public final class DequeType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getAbstractCreators_id6A07P3f4z36(@NotNull SNode __thisNode__, SModel targetModel) {
    ...
    ListSequence.fromList(res).addElement(_quotation_createNode_kzauu3_a0a1a0(SLinkOperations.getTarget(__thisNode__, LINKS.elementType$_rAN)));
  ...
  /*package*/ static boolean canBeCoerced_id476YRQvP9l3(@NotNull SNode __thisNode__, SAbstractConcept c) {
    if (CONCEPTS.LinkedListType$qf.equals(c) || CONCEPTS.ListType$LR.equals(c) || CONCEPTS.StackType$C4.equals(c) || CONCEPTS.QueueType$iX.equals(c) || CONCEPTS.SetType$g6.equals(c) || CONCEPTS.SortedSetType$7K.equals(c) || CONCEPTS.MapType$h0.equals(c) || CONCEPTS.SortedMapType$AZ.equals(c)) {
      return false;
    }
    return true;
  }
