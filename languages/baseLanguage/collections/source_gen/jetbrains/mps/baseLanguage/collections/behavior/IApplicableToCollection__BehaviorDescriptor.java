...
public final class IApplicableToCollection__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_7v3wkh.IApplicableToCollection_ec2fb0a5;
  ...
  /*package*/ static List<SNode> getApplicableTypes_id5cL0w3DYzxf(@NotNull SAbstractConcept __thisConcept__) {
    List<SNode> result = IApplicableToNothing__BehaviorDescriptor.getApplicableTypes_id5cL0w3DYzxf.invokeSuper(__thisConcept__, AUX_7v3wkh.IApplicableToCollection_ec2fb0a5);
  ...
  private static final class AUX_7v3wkh {
    /*package*/ static final SInterfaceConcept IApplicableToCollection_ec2fb0a5 = MetaAdapterFactory.getInterfaceConcept(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x53310200e8d9eef7L, "jetbrains.mps.baseLanguage.collections.structure.IApplicableToCollection");
  }
}
