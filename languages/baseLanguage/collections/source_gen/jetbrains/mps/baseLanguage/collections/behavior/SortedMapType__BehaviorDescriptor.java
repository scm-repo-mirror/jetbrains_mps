...
public final class SortedMapType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getAbstractCreators_id6A07P3f4z36(@NotNull SNode __thisNode__, SModel targetModel) {
    ...
    ListSequence.fromList(result).addElement(_quotation_createNode_zek8do_a0a1a0(SLinkOperations.getTarget(__thisNode__, LINKS.keyType$y2c1), SLinkOperations.getTarget(__thisNode__, LINKS.valueType$BtC4)));
