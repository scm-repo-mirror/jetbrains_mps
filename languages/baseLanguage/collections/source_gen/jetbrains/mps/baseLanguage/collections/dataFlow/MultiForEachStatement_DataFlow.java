...
public class MultiForEachStatement_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    for (SNode it : ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.forEach$kHDy))) {
      _context.getBuilder().build((SNode) SLinkOperations.getTarget(it, LINKS.input$kNHx));
      _context.getBuilder().build((SNode) SLinkOperations.getTarget(it, LINKS.variable$lhww));
    }
