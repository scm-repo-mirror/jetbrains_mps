...
public class MultiForEachStatement_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    for (SNode it : ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.forEach$_P5u))) {
      _context.getBuilder().build((SNode) SLinkOperations.getTarget(it, LINKS.input$_PhZ));
      _context.getBuilder().build((SNode) SLinkOperations.getTarget(it, LINKS.variable$_Qfw));
    }
