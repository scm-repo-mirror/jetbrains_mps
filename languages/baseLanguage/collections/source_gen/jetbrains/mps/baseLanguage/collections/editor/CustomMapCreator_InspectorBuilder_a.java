...
/*package*/ class CustomMapCreator_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.containerDeclaration$q3D;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.containerDeclaration$q3D);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.containerDeclaration$q3D);
    }
