...
/*package*/ class ForEachVariable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_hjufxn.PropertyAttribute_d001db89);
  ...
  public static class ForEachVariable_name_postfixCellMenu_ufuydf_a0a0 extends AbstractCellMenuPart_PropertyPostfixHints {
    ...
    public List<String> getPostfixes(SNode node, IOperationContext operationContext, EditorContext editorContext) {
      ...
      if (SNodeOperations.isInstanceOf(TypecheckingFacade.getFromContext().getTypeOf(node), AUX_hjufxn.Type_4199e276)) {
        ListSequence.fromList(postfixes).addSequence(ListSequence.fromList(Type__BehaviorDescriptor.getVariableSuffixes_idhEwIzNo.invoke(SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(node), AUX_hjufxn.Type_4199e276))));
      }
      return postfixes;
    }
  }

  private static final class AUX_hjufxn {
