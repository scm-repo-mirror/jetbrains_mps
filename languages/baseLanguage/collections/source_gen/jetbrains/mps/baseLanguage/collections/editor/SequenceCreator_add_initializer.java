...
public class SequenceCreator_add_initializer extends KeyMapImpl {
  ...
  public static class SequenceCreator_add_initializer_Action0 extends KeyMapActionImpl {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, AUX_z85ifc.SequenceCreator_f5b71339))) {
        return false;
      }
    ...
    private void execute_internal(final EditorContext editorContext, final SNode node, final List<SNode> selectedNodes) {
      SNodeFactoryOperations.setNewChild(node, MetaAdapterFactory.getContainmentLink(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x11d14c97b16L, 0x11d14ca1317L, "initializer"), AUX_z85ifc.ClosureLiteral_6eeca0d3);
    }
  ...
  private static final class AUX_z85ifc {
