...
public class check_CustomContainerCreator_elementType_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode ccc, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SLinkOperations.getTarget(ccc, LINKS.elementType$WxmV);
    if (!(ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(ccc, LINKS.containerDeclaration$nqf8), LINKS.typeVariableDeclaration$Lipp)).count() <= 1 && ((ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(ccc, LINKS.containerDeclaration$nqf8), LINKS.typeVariableDeclaration$Lipp)).count() == 1) == (SLinkOperations.getTarget(ccc, LINKS.elementType$WxmV) != null)))) {
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.CustomContainerCreator$gu;
  }
