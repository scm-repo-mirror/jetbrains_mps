...
public class java_util_Map_extends_map_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  private static SNode _quotation_createNode_cwf9bn_a0a0a0a0e() {
    ...
    quotedNode_1.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_1, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.util(JDK/)"), facade.createNodeId("~Map")));
    ...
    quotedNode_1.addChild(LINKS.parameter$dQne, quotedNode_3);
    return quotedNode_1;
  }
