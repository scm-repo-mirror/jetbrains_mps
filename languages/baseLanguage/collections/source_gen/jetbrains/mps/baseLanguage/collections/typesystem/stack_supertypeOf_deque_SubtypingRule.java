...
public class stack_supertypeOf_deque_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode dequeType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return _quotation_createNode_9c4fxh_a0a1(SLinkOperations.getTarget(dequeType, LINKS.elementType$V7ow));
  }
  ...
  private static SNode _quotation_createNode_9c4fxh_a0a1(Object parameter_1) {
    ...
    quotedNode_2 = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, "jetbrains.mps.baseLanguage.collections"), 0x5e6446aa46ee5eecL, "StackType")).getResult();
