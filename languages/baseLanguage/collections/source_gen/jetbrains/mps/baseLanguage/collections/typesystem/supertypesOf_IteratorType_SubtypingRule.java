...
public class supertypesOf_IteratorType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode iteratorType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return _quotation_createNode_3m2hv_a0a1(SLinkOperations.getTarget(iteratorType, LINKS.elementType$69it));
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.IteratorType$QR;
  }
  ...
  private static SNode _quotation_createNode_3m2hv_a0a1(Object parameter_1) {
    ...
    quotedNode_2.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_2, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.util(JDK/)"), facade.createNodeId("~Iterator")));
