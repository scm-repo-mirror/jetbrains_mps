...
public class supertypesOf_QueueType_ClassiType_Queue_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode queueType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return _quotation_createNode_1k31p3_a0a1(SLinkOperations.getTarget(queueType, LINKS.elementType$_rAN));
  }
  ...
  private static SNode _quotation_createNode_1k31p3_a0a1(Object parameter_1) {
    ...
    quotedNode_2.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), facade.createNodeReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.util(JDK/)/~Queue"));
