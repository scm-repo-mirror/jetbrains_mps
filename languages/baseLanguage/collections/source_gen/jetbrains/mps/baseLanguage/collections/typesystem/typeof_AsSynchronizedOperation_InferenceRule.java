...
public class typeof_AsSynchronizedOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode aso, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode ELEMENT_typevar_4611582986551020949 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_cpvb10_a0a0c0b0b(typeCheckingContext.getRepresentative(ELEMENT_typevar_4611582986551020949)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "7668447476859120352", true), false, true, _info_12389875345);
    }
    {
  ...
  public SAbstractConcept getApplicableConcept() {
    return AUX_cpvb10.AsSynchronizedOperation_ec062fb3;
  }
  ...
  private static SNode _quotation_createNode_cpvb10_a0a0c0b0b(Object parameter_1) {
  ...
  private static final class AUX_cpvb10 {
    /*package*/ static final SConcept AsSynchronizedOperation_ec062fb3 = MetaAdapterFactory.getConcept(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x3fffa24b059bcd85L, "jetbrains.mps.baseLanguage.collections.structure.AsSynchronizedOperation");
  }
}
