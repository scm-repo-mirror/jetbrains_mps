...
public class typeof_FoldRightOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(operation, LINKS.seed$VTSv);
  ...
  private static SNode _quotation_createNode_tdnv4o_a1a0c0a0f0b(Object parameter_1, Object parameter_2, Object parameter_3) {
    ...
    if (quotedNode_5 != null) {
      quotedNode_4.addChild(LINKS.parameterType$odu6, SNodeOperations.copyIfNecessary(quotedNode_5));
    }
    quotedNode_6 = (SNode) parameter_2;
    if (quotedNode_6 != null) {
      quotedNode_4.addChild(LINKS.parameterType$odu6, SNodeOperations.copyIfNecessary(quotedNode_6));
    }
    quotedNode_7 = (SNode) parameter_3;
    if (quotedNode_7 != null) {
      quotedNode_4.addChild(LINKS.resultType$ln42, SNodeOperations.copyIfNecessary(quotedNode_7));
    }
    return quotedNode_4;
  }
