...
public class typeof_GetEnumeratorOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode emunerator, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode elementType_typevar_1237549347223 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_jit5ug_a0a0c0b0b(typeCheckingContext.getRepresentative(elementType_typevar_1237549347223)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1237549347226", true), false, false, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1237549347244", true), (SNode) _quotation_createNode_jit5ug_a1a0c0c0b(typeCheckingContext.getRepresentative(elementType_typevar_1237549347223)), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return AUX_jit5ug.GetEnumeratorOperation_38aeccff;
  }
  ...
  private static SNode _quotation_createNode_jit5ug_a0a0c0b0b(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_jit5ug_a1a0c0c0b(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
  ...
  private static final class AUX_jit5ug {
    /*package*/ static final SConcept GetEnumeratorOperation_38aeccff = MetaAdapterFactory.getConcept(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x12023af43bdL, "jetbrains.mps.baseLanguage.collections.structure.GetEnumeratorOperation");
  }
}
