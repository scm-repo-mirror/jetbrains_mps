...
public class typeof_PutAllOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    final SNode VALUE_typevar_1240906971637 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_fb8qny_a0a0c0c0b(typeCheckingContext.getRepresentative(KEY_typevar_1240906967388), typeCheckingContext.getRepresentative(VALUE_typevar_1240906971637)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240906975191", true), false, true, _info_12389875345);
    }
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240907069153", true), (SNode) _quotation_createNode_fb8qny_a1a0c0e0b(), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return AUX_fb8qny.PutAllOperation_3af37a00;
  }
  ...
  private static SNode _quotation_createNode_fb8qny_a0a0c0c0b(Object parameter_1, Object parameter_2) {
  ...
  private static SNode _quotation_createNode_fb8qny_a1a0c0a0d0b(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
  ...
  private static SNode _quotation_createNode_fb8qny_a1a0c0e0b() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static final class AUX_fb8qny {
    /*package*/ static final SConcept PutAllOperation_3af37a00 = MetaAdapterFactory.getConcept(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x120ebcea0f9L, "jetbrains.mps.baseLanguage.collections.structure.PutAllOperation");
  }
}
