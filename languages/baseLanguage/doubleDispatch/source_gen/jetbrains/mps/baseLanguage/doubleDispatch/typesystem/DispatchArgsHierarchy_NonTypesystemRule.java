        ...
        for (SNode m : Sequence.fromIterable(err.getMethods())) {
          {
            ...
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(ListSequence.fromList(SLinkOperations.getChildren(m, LINKS.parameter$qsax)).first(), msg, "r:7a94bb66-9653-4830-af67-903eb2cfbd29(jetbrains.mps.baseLanguage.doubleDispatch.typesystem)", "7139749370073616981", null, errorTarget);
          }
        }
      }
    }
