...
public class ReturnBlockDocTag_Constraints extends BaseConstraintsDescriptor {
  public ReturnBlockDocTag_Constraints() {
    super(AUX_ej62q3.ReturnBlockDocTag_643ca086);
  }
  ...
  private static boolean staticCanBeAChild(final SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    if (!(SNodeOperations.isInstanceOf(parentNode, AUX_ej62q3.MethodDocComment_a2b8d4a1))) {
      return false;
    }

    if (ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.as(parentNode, AUX_ej62q3.BaseDocComment_a28e0b95), MetaAdapterFactory.getContainmentLink(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x4a3c146b7fae70d3L, 0x4ab5c2019ddc99f3L, "tags"))).all(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !(SNodeOperations.isInstanceOf(it, AUX_ej62q3.ReturnBlockDocTag_643ca086)) || Objects.equals(it, node);
      }
    })) {
      SNode returnType = SLinkOperations.getTarget(SNodeOperations.getNodeAncestor(parentNode, AUX_ej62q3.BaseMethodDeclaration_9dbf9acb, false, false), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b1fcL, 0xf8cc56b1fdL, "returnType"));
      return !(((returnType != null) && SNodeOperations.isInstanceOf(returnType, AUX_ej62q3.VoidType_d96d05c9)));
    }
    return false;
  }
  ...
  private static final class AUX_ej62q3 {
