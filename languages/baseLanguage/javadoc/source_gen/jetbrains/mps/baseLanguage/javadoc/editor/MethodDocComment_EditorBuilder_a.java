...
/*package*/ class MethodDocComment_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class bodyListHandler_ls0i5e_b0a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(bodyListHandler_ls0i5e_b0a.this.getNode(), LINKS.body$ULZO));
      try {
  ...
  private static class tagsListHandler_ls0i5e_d0a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(tagsListHandler_ls0i5e_d0a.this.getNode(), LINKS.tags$LJD$));
      try {
        EditorCell emptyCell = null;
  ...
  private boolean nodeCondition_ls0i5e_a5e0a() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.param$pEic)).isNotEmpty();
  }
  private boolean nodeCondition_ls0i5e_a6e0a() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.throwsTag$3WQN)).isNotEmpty();
  }
  ...
  private static class authorListHandler_ls0i5e_b4a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(authorListHandler_ls0i5e_b4a0.this.getNode(), LINKS.author$VPpR));
      try {
        EditorCell emptyCell = null;
  ...
  private static class sinceListHandler_ls0i5e_c4a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sinceListHandler_ls0i5e_c4a0.this.getNode(), LINKS.since$UGOw));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static class versionListHandler_ls0i5e_d4a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(versionListHandler_ls0i5e_d4a0.this.getNode(), LINKS.version$UGOZ));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static class seeListHandler_ls0i5e_e4a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(seeListHandler_ls0i5e_e4a0.this.getNode(), LINKS.see$fbTt));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static class paramListHandler_ls0i5e_f4a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(paramListHandler_ls0i5e_f4a0.this.getNode(), LINKS.param$pEic));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static class throwsTagListHandler_ls0i5e_g4a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(throwsTagListHandler_ls0i5e_g4a0.this.getNode(), LINKS.throwsTag$3WQN));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new deprecatedSingleRoleHandler_ls0i5e_h4a0(myNode, LINKS.deprecated$UGSR, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new returnSingleRoleHandler_ls0i5e_i4a0(myNode, LINKS.return$3XgX, getEditorContext());
    return provider.createCell();
  }
  private static class returnSingleRoleHandler_ls0i5e_i4a0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.return$3XgX, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.return$3XgX, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.return$3XgX);
      }
      Style style = new StyleImpl();
      new JavaDocStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
      style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.return$3XgX));
      try {
