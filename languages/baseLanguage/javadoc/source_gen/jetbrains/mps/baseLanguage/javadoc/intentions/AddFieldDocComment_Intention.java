...
public final class AddFieldDocComment_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return ((AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute(AUX_vdl2ja.FieldDocComment_200d971a)) == null) ? "Add Documentation Comment" : "Remove Documentation Comment");
    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      DocCommentHelper.addJavadocLangIfMissing(node);

      if ((AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute(AUX_vdl2ja.FieldDocComment_200d971a)) == null)) {
        SNodeFactoryOperations.setNewAttribute(node, new IAttributeDescriptor.NodeAttribute(AUX_vdl2ja.FieldDocComment_200d971a), AUX_vdl2ja.FieldDocComment_200d971a);
        SNode line = SNodeFactoryOperations.addNewChild(AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute(AUX_vdl2ja.FieldDocComment_200d971a)), MetaAdapterFactory.getContainmentLink(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x4a3c146b7fae70d3L, 0x757ba20a4c87f96eL, "body"), AUX_vdl2ja.CommentLine_7c8f6780);
        SNode firstPart = SNodeFactoryOperations.addNewChild(line, MetaAdapterFactory.getContainmentLink(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x757ba20a4c87f96cL, 0x7c7f5b2f3199028dL, "part"), AUX_vdl2ja.TextCommentLinePart_b468bde4);
        SelectionUtil.selectCell(editorContext, firstPart, SelectionManager.FIRST_CELL);
      } else {
        AttributeOperations.setAttribute(node, new IAttributeDescriptor.NodeAttribute(AUX_vdl2ja.FieldDocComment_200d971a), null);
      }
    }
    @Override
  ...
  private static final class AUX_vdl2ja {
