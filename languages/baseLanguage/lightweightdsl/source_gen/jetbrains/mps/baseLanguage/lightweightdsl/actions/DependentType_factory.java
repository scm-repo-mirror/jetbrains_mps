...
public class DependentType_factory {
  public static class NodeFactory_9097849371504700258 implements NodeFactory {
    public void setup(SNode newNode, SNode sampleNode, SNode enclosingNode, SModel model) {
      SLinkOperations.setTarget(newNode, LINKS.getter$fwSw, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xfd3920347849419dL, 0x907112563d152375L, 0x1174bed3125L, "jetbrains.mps.baseLanguage.closures.structure.ClosureLiteral")));
      ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(newNode, LINKS.getter$fwSw), LINKS.parameter$uR6p)).addElement(_quotation_createNode_6hmkle_a0a1a0a());
      SLinkOperations.setTarget(SLinkOperations.getTarget(newNode, LINKS.getter$fwSw), LINKS.body$e5Do, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b200L, "jetbrains.mps.baseLanguage.structure.StatementList")));
    }
