...
/*package*/ class CustomMemberDescriptor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.cncpt$gpR2;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.cncpt$gpR2);
    }
  ...
  private static class modifierListHandler_601f61_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(modifierListHandler_601f61_d0.this.getNode(), LINKS.modifier$3mgr));
      try {
