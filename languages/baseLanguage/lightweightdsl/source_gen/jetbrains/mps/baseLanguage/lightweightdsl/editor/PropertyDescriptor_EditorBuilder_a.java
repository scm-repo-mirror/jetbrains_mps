...
/*package*/ class PropertyDescriptor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.type$hcaF;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.type$hcaF);
    }
  ...
  private static class modifierListHandler_ram8ac_f0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(modifierListHandler_ram8ac_f0.this.getNode(), LINKS.modifier$3mgr));
      try {
