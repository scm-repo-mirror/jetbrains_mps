...
/*package*/ class PrintStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new textExpressionListHandler_nmgex1_c0(myNode, getEditorContext());
  ...
  private static class textExpressionListHandler_nmgex1_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.textExpression$SldK;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(textExpressionListHandler_nmgex1_c0.this.getNode(), LINKS.textExpression$SldK));
      try {
