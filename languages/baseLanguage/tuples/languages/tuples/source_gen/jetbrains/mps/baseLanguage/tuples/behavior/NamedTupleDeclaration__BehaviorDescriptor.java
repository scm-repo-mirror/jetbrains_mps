...
public final class NamedTupleDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> allExtends_id2ItBWjOSZqc = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("allExtends").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2ItBWjOSZqc").build();
  ...
  public static final SMethod<Void> markLoadedNodeAsDeprecated_id5H8W9_ECA0g = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("markLoadedNodeAsDeprecated").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5H8W9_ECA0g").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
