...
public class IndexedTupleLiteral_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    if (_context.getNode() == SLinkOperations.getTarget(SNodeOperations.as(SNodeOperations.getParent(_context.getNode()), CONCEPTS.BaseAssignmentExpression$oO), LINKS.lValue$J0D4)) {
      for (SNode mbr : SLinkOperations.getChildren(_context.getNode(), LINKS.component$zxvz)) {
        _context.getBuilder().emitWrite(SLinkOperations.getTarget(SNodeOperations.as(mbr, CONCEPTS.VariableReference$sQ), LINKS.variableDeclaration$2ky6), "r:584f574a-ff70-48d8-8e32-f847d7f18b78(jetbrains.mps.baseLanguage.tuples.dataFlow)/1238857003685");
      }
    } else {
      for (SNode mbr : SLinkOperations.getChildren(_context.getNode(), LINKS.component$zxvz)) {
