...
/*package*/ class NamedTupleDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new annotationListHandler_955wzk_b0(myNode, getEditorContext());
  ...
  private static class annotationListHandler_955wzk_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_955wzk_b0.this.getNode(), LINKS.annotation$K49I));
      try {
