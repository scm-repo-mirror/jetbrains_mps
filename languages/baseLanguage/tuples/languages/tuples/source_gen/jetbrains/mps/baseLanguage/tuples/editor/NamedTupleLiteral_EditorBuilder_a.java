...
/*package*/ class NamedTupleLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class componentRefListHandler_ulpguu_b0 extends RefNodeListHandler {
    ...
    public componentRefListHandler_ulpguu_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.componentRef$hTGc;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.NamedTupleComponentReference$e7;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(componentRefListHandler_ulpguu_b0.this.getNode(), LINKS.componentRef$hTGc));
      try {
