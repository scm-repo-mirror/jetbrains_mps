...
<solution name="MPS.IDEA" uuid="498d89d2-c2e9-11e2-ad49-6cf049e62fe5" compileInMPS="false">
  ...
  <models>
    <modelRoot contentPath="${platform_lib}" type="java_classes">
      ...
      <!-- -->
      <sourceRoot location="netty-buffer-4.1.52.Final.jar" />
      <sourceRoot location="netty-codec-4.1.52.Final.jar" />
      <sourceRoot location="netty-codec-http-4.1.52.Final.jar" />
      <sourceRoot location="netty-common-4.1.52.Final.jar" />
      <sourceRoot location="netty-handler-4.1.52.Final.jar" />
      <sourceRoot location="netty-resolver-4.1.52.Final.jar" />
      <sourceRoot location="netty-transport-4.1.52.Final.jar" />
  ...
  <stubModelEntries>
    ...
    <!-- aka 'idea jars' -->
    <stubModelEntry path="${platform_lib}/netty-buffer-4.1.52.Final.jar" />
    <stubModelEntry path="${platform_lib}/netty-codec-4.1.52.Final.jar" />
    <stubModelEntry path="${platform_lib}/netty-codec-http-4.1.52.Final.jar" />
    <stubModelEntry path="${platform_lib}/netty-common-4.1.52.Final.jar" />
    <stubModelEntry path="${platform_lib}/netty-handler-4.1.52.Final.jar" />
    <stubModelEntry path="${platform_lib}/netty-resolver-4.1.52.Final.jar" />
    <stubModelEntry path="${platform_lib}/netty-transport-4.1.52.Final.jar" />
