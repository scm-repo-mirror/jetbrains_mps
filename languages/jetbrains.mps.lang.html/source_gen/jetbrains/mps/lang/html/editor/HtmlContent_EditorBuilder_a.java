...
/*package*/ class HtmlContent_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public HtmlContent_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_cveden_a");
  ...
  private EditorCell createError_0() {
    ...
    editorCell.setCellId("Error_cveden_a0");
