...
public final class CopyPasteHandlers__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getBaseConceptCollection_id4$$3zrO3UBG(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.preProcessor$PoVC)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        ListSequence.fromList(result).addElement(SLinkOperations.getTarget(it, LINKS.concept$S8ZE));
      }
    });
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.postProcessor$PoV9)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        ListSequence.fromList(result).addElement(SLinkOperations.getTarget(it, LINKS.concept$5ARp));
      }
    });
    return result;
  }
  /*package*/ static void setBaseConcept_id5r_35Ihc58c(@NotNull SNode __thisNode__, SNode baseConcept) {
    ...
    SLinkOperations.setTarget(pastePostProcessor, LINKS.concept$5ARp, baseConcept);
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.postProcessor$PoV9)).addElement(pastePostProcessor);
    String name = SModelUtil.getDeclaringLanguage(baseConcept).getModuleName();
    SPropertyOperations.set(__thisNode__, PROPS.name$tAp1, NameUtil.shortNameFromLongName(name) + "_CopyPasteHandlers");
  }
