...
/*package*/ class ConceptCondition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.concept$xYyM;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.concept$xYyM);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.concept$xYyM);
    }
  ...
  private EditorCell createProperty_1() {
    ...
    try {
      ...
      editorCell.getStyle().putAll(style);
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new PropertyCellContext(myNode, property), new SubstituteInfoPartExt[]{new ConceptCondition_name_postfixCellMenu_hrb2do_a0e0(), new SChildSubstituteInfoPartEx(editorCell)}));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.PropertyAttribute$Gb);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
  ...
  public static class ConceptCondition_name_postfixCellMenu_hrb2do_a0e0 extends AbstractCellMenuPart_PropertyPostfixHints {
    ...
    protected List<String> getPostfixes(SNode node, EditorContext editorContext) {
      List<String> result;
      if ((SLinkOperations.getTarget(node, LINKS.concept$xYyM) != null) && SPropertyOperations.getString(SLinkOperations.getTarget(node, LINKS.concept$xYyM), PROPS.name$MnvL) != null) {
        String name = NameUtil.decapitalize(SPropertyOperations.getString(SLinkOperations.getTarget(node, LINKS.concept$xYyM), PROPS.name$MnvL));
