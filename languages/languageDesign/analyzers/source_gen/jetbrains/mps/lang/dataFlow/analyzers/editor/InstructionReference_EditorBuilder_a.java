...
/*package*/ class InstructionReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.instruction$19qt;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.instruction$19qt);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.instruction$19qt);
    }
  ...
  private static class argumentListHandler_o0r2rr_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argumentListHandler_o0r2rr_c0.this.getNode(), LINKS.argument$12B0));
      try {
