...
public class typeof_AnalyzerFunParameterProgramState_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode _quotation_createNode_hgy1cg_a1a0c0a0b() {
    ...
    quotedNode_1.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_1, facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.lang.dataFlow.framework(MPS.Core/)"), facade.createNodeId("~ProgramState")));
    return quotedNode_1;
  }
