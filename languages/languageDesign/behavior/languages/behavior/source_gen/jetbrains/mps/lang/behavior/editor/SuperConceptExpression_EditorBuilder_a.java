...
/*package*/ class SuperConceptExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_ee6gw3_a1a() {
    return (SLinkOperations.getTarget(myNode, LINKS.superConcept$nNkw) != null);
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.superConcept$nNkw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.superConcept$nNkw);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.superConcept$nNkw);
    }
