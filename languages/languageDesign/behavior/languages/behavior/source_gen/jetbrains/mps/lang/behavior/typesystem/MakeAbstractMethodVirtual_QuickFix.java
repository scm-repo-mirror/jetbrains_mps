...
public class MakeAbstractMethodVirtual_QuickFix extends QuickFix_Runtime {
  ...
  public String getDescription(SNode node) {
    return "Mark an abstract method '" + SPropertyOperations.getString(((SNode) MakeAbstractMethodVirtual_QuickFix.this.getField("conceptMethod")[0]), PROPS.name$MnvL) + "' virtual as well";
  }
  public void execute(SNode node) {
    assert SPropertyOperations.getBoolean(((SNode) MakeAbstractMethodVirtual_QuickFix.this.getField("conceptMethod")[0]), PROPS.isAbstract$qvtK);
    SPropertyOperations.assign(((SNode) MakeAbstractMethodVirtual_QuickFix.this.getField("conceptMethod")[0]), PROPS.isVirtual$quZI, true);
  }
