...
public class RemoveFinalFromTheMethod_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    assert SPropertyOperations.getBoolean(((SNode) RemoveFinalFromTheMethod_QuickFix.this.getField("conceptMethod")[0]), PROPS.isFinal$I$Qu);
    SPropertyOperations.assign(((SNode) RemoveFinalFromTheMethod_QuickFix.this.getField("conceptMethod")[0]), PROPS.isFinal$I$Qu, false);
  }
