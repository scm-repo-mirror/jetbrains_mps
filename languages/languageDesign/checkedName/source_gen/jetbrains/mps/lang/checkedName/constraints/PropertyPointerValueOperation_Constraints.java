...
public class PropertyPointerValueOperation_Constraints extends BaseConstraintsDescriptor {
  public PropertyPointerValueOperation_Constraints() {
    super(CONCEPTS.PropertyPointerValueOperation$sT);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return SNodeOperations.isInstanceOf(parentNode, CONCEPTS.DotExpression$6a) && (TypecheckingFacade.getFromContext().strongCoerceType(TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(SNodeOperations.cast(parentNode, CONCEPTS.DotExpression$6a), LINKS.operand$P1i5)), CONCEPTS.PropertyPointerType$EW) != null);
  }
