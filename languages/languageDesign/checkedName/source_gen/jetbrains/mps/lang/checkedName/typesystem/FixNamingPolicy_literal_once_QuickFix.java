...
public class FixNamingPolicy_literal_once_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SPropertyOperations.set(((SNode) FixNamingPolicy_literal_once_QuickFix.this.getField("literal")[0]), PROPS.value$kiE0, NameUtil.captionPartWithNamingPolicy(SPropertyOperations.getString(((SNode) FixNamingPolicy_literal_once_QuickFix.this.getField("literal")[0]), PROPS.value$kiE0)));
  }
