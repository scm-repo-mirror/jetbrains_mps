...
public final class ConstraintFunction_CanBeAChild__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_gsolcy.ConstraintFunction_CanBeAChild_1644c7a7;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_gsolcy.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_gsolcy.ConstraintsFunctionParameter_node_ce2c6ef0);
    ListSequence.fromList(result).addElement(AUX_gsolcy.ConstraintFunctionParameter_parentNode_abecb297);
    ListSequence.fromList(result).addElement(AUX_gsolcy.ConstraintFunctionParameter_childConcept_8a370228);
    ListSequence.fromList(result).addElement(AUX_gsolcy.ConstraintFunctionParameter_link_8f0dbdc0);
    ListSequence.fromList(result).addElement(AUX_gsolcy.ConceptFunctionParameter_operationContext_90a078a3);
    return result;
  }
  ...
  /*package*/ ConstraintFunction_CanBeAChild__BehaviorDescriptor() {
  }
  ...
  private static final class AUX_gsolcy {
    ...
    /*package*/ static final SConcept ConstraintFunctionParameter_parentNode_abecb297 = MetaAdapterFactory.getConcept(0x3f4bc5f5c6c14a28L, 0x8b10c83066ffa4a1L, 0x11817c5715bL, "jetbrains.mps.lang.constraints.structure.ConstraintFunctionParameter_parentNode");
