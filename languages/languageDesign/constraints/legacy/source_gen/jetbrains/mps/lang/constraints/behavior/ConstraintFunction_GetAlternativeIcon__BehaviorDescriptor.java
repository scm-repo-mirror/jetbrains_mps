...
public final class ConstraintFunction_GetAlternativeIcon__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_61kfyl.ConstraintFunction_GetAlternativeIcon_2e62c646;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_61kfyl.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_61kfyl.ConstraintsFunctionParameter_node_ce2c6ef0);
    return result;
  }
  ...
  private static final class AUX_61kfyl {
