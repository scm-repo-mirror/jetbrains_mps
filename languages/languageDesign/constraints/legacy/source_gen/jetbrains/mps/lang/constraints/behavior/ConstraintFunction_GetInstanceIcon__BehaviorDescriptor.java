...
public final class ConstraintFunction_GetInstanceIcon__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_gb65fx.ConstraintFunction_GetInstanceIcon_62aca58;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_gb65fx.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_gb65fx.ConstraintsFunctionParameter_node_ce2c6ef0);
    return result;
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_8oyiej_a0a1();
  }

  /*package*/ ConstraintFunction_GetInstanceIcon__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_8oyiej_a0a1() {
  ...
  private static final class AUX_gb65fx {
