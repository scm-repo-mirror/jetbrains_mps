...
public class NodePropertyConstraint_Constraints extends BaseConstraintsDescriptor {
  public NodePropertyConstraint_Constraints() {
    super(AUX_hf9c5x.NodePropertyConstraint_95960da6);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(MetaAdapterFactory.getReferenceLink(0x3f4bc5f5c6c14a28L, 0x8b10c83066ffa4a1L, 0x10b2a5eaa48L, 0x10b2a61697bL, "applicableProperty"), this) {
      @Override
        ...
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            if (applicableConcept == null) {
              ...
              if (SNodeOperations.isInstanceOf(root, AUX_hf9c5x.ConceptConstraints_2e5b5de5)) {
                applicableConcept = SLinkOperations.getTarget(SNodeOperations.cast(root, AUX_hf9c5x.ConceptConstraints_2e5b5de5), MetaAdapterFactory.getReferenceLink(0x3f4bc5f5c6c14a28L, 0x8b10c83066ffa4a1L, 0x11a7208faaeL, 0x11a720969b6L, "concept"));
              } else {
                applicableConcept = SLinkOperations.getTarget(SNodeOperations.cast(root, AUX_hf9c5x.ConceptBehavior_68ebe6cd), MetaAdapterFactory.getReferenceLink(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, 0x11d43447b1aL, 0x11d43447b1fL, "concept"));
              }
            }
  ...
  private static final class AUX_hf9c5x {
