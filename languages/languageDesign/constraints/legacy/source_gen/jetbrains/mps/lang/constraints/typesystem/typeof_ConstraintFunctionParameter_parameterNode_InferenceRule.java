...
public class typeof_ConstraintFunctionParameter_parameterNode_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if ((SNodeOperations.getNodeAncestor(node, AUX_10ia44.NodeReferentConstraint_827fc615, false, false) != null)) {
      SNode constraint = SNodeOperations.getNodeAncestor(node, AUX_10ia44.NodeReferentConstraint_827fc615, false, false);
      {
      ...
      SNode defaultScope = SNodeOperations.getNodeAncestor(node, AUX_10ia44.NodeDefaultSearchScope_5e923e6f, false, false);
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "6768994795311836987", true), (SNode) _quotation_createNode_10ia44_a1a0c0b0a0a1(NodeDefaultSearchScope__BehaviorDescriptor.getReferentConcept_idhEwIhhr.invoke(defaultScope)), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = node;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "6768994795311837013", true), (SNode) _quotation_createNode_10ia44_a1a0c0a0a0a1(), _info_12389875345);
      }
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return AUX_10ia44.ConstraintFunctionParameter_parameterNode_7d430784;
  }
  ...
  private static SNode _quotation_createNode_10ia44_a1a0c0b0a0b(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_10ia44_a1a0c0b0a0a1(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, "jetbrains.mps.lang.smodel"), 0x108f968b3caL, "SNodeType"), null, null, false);
    SNodeAccessUtil.setReferenceTarget(quotedNode_2, MetaAdapterFactory.getReferenceLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x108f968b3caL, 0x1090e46ca51L, "concept"), (SNode) parameter_1);
  ...
  private static SNode _quotation_createNode_10ia44_a1a0c0a0a0a1() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static final class AUX_10ia44 {
