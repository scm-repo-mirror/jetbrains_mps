...
/*package*/ class GenerationDescriptor_ByInterface_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.mainIntfcClass$$p$E;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.mainIntfcClass$$p$E);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.mainIntfcClass$$p$E);
    }
  ...
  private static class methodsListHandler_laxs8h_b1a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(methodsListHandler_laxs8h_b1a.this.getNode(), LINKS.methods$CZw1));
      try {
