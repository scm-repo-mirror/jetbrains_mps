...
/*package*/ class TransformationMenuPart_Intention_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.intention$H6R0;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.intention$H6R0);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.intention$H6R0);
    }
  ...
  private static class featuresListHandler_yp01gy_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(featuresListHandler_yp01gy_c0.this.getNode(), LINKS.features$VYBA));
      try {
