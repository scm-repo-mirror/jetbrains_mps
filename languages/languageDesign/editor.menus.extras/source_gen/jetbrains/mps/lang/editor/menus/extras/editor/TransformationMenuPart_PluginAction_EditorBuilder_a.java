...
/*package*/ class TransformationMenuPart_PluginAction_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.action$a757;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.action$a757);
    }
  ...
  private static class featuresListHandler_uxi26n_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(featuresListHandler_uxi26n_c0.this.getNode(), LINKS.features$VYBA));
      try {
