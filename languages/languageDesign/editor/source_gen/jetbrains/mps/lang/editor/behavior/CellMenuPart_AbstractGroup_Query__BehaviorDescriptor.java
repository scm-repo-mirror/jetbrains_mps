...
public final class CellMenuPart_AbstractGroup_Query__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    SNode hostMenuGroup = SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.CellMenuPart_AbstractGroup$xt, false, false);
    SNode parameterObjectType = SLinkOperations.getTarget(hostMenuGroup, LINKS.parameterObjectType$zvPk);
