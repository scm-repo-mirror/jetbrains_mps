...
public final class CellMenuPart_AbstractGroup_Query__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_1sb4e6.CellMenuPart_AbstractGroup_Query_3a2b289f;
  ...
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    SNode hostMenuGroup = SNodeOperations.getNodeAncestor(__thisNode__, AUX_1sb4e6.CellMenuPart_AbstractGroup_7b60d76c, false, false);
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_1sb4e6.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_1sb4e6.ConceptFunctionParameter_operationContext_90a078a3);
    ListSequence.fromList(result).addElement(AUX_1sb4e6.CellMenuPart_Abstract_editedNode_47c274fa);
    ListSequence.fromList(result).addElement(AUX_1sb4e6.ConceptFunctionParameter_editorContext_94336d9a);
    return result;
  }
  ...
  private static final class AUX_1sb4e6 {
    /*package*/ static final SConcept CellMenuPart_AbstractGroup_Query_3a2b289f = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10eecbddc4fL, "jetbrains.mps.lang.editor.structure.CellMenuPart_AbstractGroup_Query");
