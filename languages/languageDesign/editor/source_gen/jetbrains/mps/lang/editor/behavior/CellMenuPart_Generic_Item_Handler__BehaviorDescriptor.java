...
public final class CellMenuPart_Generic_Item_Handler__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_fkcco9.CellMenuPart_Generic_Item_Handler_a156bc13;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_fkcco9.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_fkcco9.CellMenuPart_Abstract_editedNode_47c274fa);
    ListSequence.fromList(result).addElement(AUX_fkcco9.ConceptFunctionParameter_model_8efa7e9e);
    ListSequence.fromList(result).addElement(AUX_fkcco9.ConceptFunctionParameter_editorContext_94336d9a);
    ListSequence.fromList(result).addElement(AUX_fkcco9.ConceptFunctionParameter_operationContext_90a078a3);
    return result;
  }
  ...
  private static final class AUX_fkcco9 {
    /*package*/ static final SConcept CellMenuPart_Generic_Item_Handler_a156bc13 = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10f58b90423L, "jetbrains.mps.lang.editor.structure.CellMenuPart_Generic_Item_Handler");
