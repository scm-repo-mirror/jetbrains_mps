...
public final class CellMenuPart_PropertyValues_GetValues__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_f2irou.CellMenuPart_PropertyValues_GetValues_758422f7;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_f2irou.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_f2irou.ConceptFunctionParameter_operationContext_90a078a3);
    ListSequence.fromList(result).addElement(AUX_f2irou.CellMenuPart_Abstract_editedNode_47c274fa);
    return result;
  }
  ...
  private static final class AUX_f2irou {
    /*package*/ static final SConcept CellMenuPart_PropertyValues_GetValues_758422f7 = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10e32c7f49dL, "jetbrains.mps.lang.editor.structure.CellMenuPart_PropertyValues_GetValues");
