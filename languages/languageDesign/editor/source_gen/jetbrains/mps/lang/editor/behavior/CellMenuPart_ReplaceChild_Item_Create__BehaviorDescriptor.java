...
public final class CellMenuPart_ReplaceChild_Item_Create__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_f3tw72.CellMenuPart_ReplaceChild_Item_Create_780da2b5;
  ...
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    ...
    SNode hostMenuPart = SNodeOperations.getNodeAncestor(__thisNode__, AUX_f3tw72.CellMenuPart_Abstract_1876678, false, false);
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_f3tw72.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_f3tw72.CellMenuPart_ReplaceChild_currentChild_3192df4e);
    ListSequence.fromList(result).addElement(AUX_f3tw72.CellMenuPart_ReplaceChild_defaultChildConcept_e9a00fff);
    ListSequence.fromList(result).addElement(AUX_f3tw72.ConceptFunctionParameter_operationContext_90a078a3);
    ListSequence.fromList(result).addElement(AUX_f3tw72.ConceptFunctionParameter_model_8efa7e9e);
    ListSequence.fromList(result).addElement(AUX_f3tw72.CellMenuPart_Abstract_editedNode_47c274fa);
    ListSequence.fromList(result).addElement(AUX_f3tw72.CellMenuPart_ReplaceChild_defaultConceptOfChild_688376e3);
    return result;
  }
  ...
  private static final class AUX_f3tw72 {
    /*package*/ static final SConcept CellMenuPart_ReplaceChild_Item_Create_780da2b5 = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10f53a2ada9L, "jetbrains.mps.lang.editor.structure.CellMenuPart_ReplaceChild_Item_Create");
