...
public final class IMenu_Contribution__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_mnwxqs.IMenu_Contribution_b582d47e;

  public static final SMethod<SNode> getMenuReference_id1quYWAD2_PI = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getMenuReference").modifiers(SModifiersImpl.create(12, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1quYWAD2_PI").build();
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(kind), AUX_mnwxqs.AbstractConceptDeclaration_ec74828f)) {
      if (Language.getLanguageFor(SNodeOperations.getModel(__thisNode__)) == null) {
        return ScopeUtils.lazyParentScope(__thisNode__, kind);
      }
      return Scopes.forLanguageConcepts(__thisNode__, AUX_mnwxqs.AbstractConceptDeclaration_ec74828f);
    }
    return ((Scope) ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QDV$.invoke0(__thisNode__, AUX_mnwxqs.ScopeProvider_545e361a, kind, child));
  }
  ...
  private static final class AUX_mnwxqs {
