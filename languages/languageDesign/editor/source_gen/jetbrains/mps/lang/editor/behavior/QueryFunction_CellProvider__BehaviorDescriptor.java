...
public final class QueryFunction_CellProvider__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_q44a6x.QueryFunction_CellProvider_c10f319a;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_q44a6x.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_q44a6x.ConceptFunctionParameter_editorContext_94336d9a);
    ListSequence.fromList(result).addElement(AUX_q44a6x.ConceptFunctionParameter_node_c804e037);
    return result;
  }
  ...
  private static final class AUX_q44a6x {
    /*package*/ static final SConcept QueryFunction_CellProvider_c10f319a = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x111fbbfae55L, "jetbrains.mps.lang.editor.structure.QueryFunction_CellProvider");
