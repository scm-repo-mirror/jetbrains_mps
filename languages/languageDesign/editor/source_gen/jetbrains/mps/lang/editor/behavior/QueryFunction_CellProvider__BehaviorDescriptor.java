...
public final class QueryFunction_CellProvider__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static SNode _quotation_createNode_c0jdsv_a0a1() {
    ...
    quotedNode_1.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_1, facade.createModelReference("1ed103c3-3aa6-49b7-9c21-6765ee11f224/java:jetbrains.mps.nodeEditor(MPS.Editor/)"), facade.createNodeId("~AbstractCellProvider")));
    return quotedNode_1;
  }
