...
public final class QueryFunction_ColorComposit__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static SNode _quotation_createNode_6w5k1j_a0a0() {
    ...
    quotedNode_1.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_1, facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.util(MPS.Core/)"), facade.createNodeId("~Pair")));
    ...
    quotedNode_2.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_2, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.awt(JDK/)"), facade.createNodeId("~Color")));
    ...
    quotedNode_3.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_3, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.awt(JDK/)"), facade.createNodeId("~Color")));
