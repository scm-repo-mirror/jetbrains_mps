...
public final class QueryFunction_IsMethodCurrent__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_ri6pfc.QueryFunction_IsMethodCurrent_bfbb56f1;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_ri6pfc.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_ri6pfc.ConceptFunctionParameter_selectedNode_6c3d171b);
    ListSequence.fromList(result).addElement(AUX_ri6pfc.ConceptFunctionParameter_parameterObject_5c17ed34);
    ListSequence.fromList(result).addElement(AUX_ri6pfc.ConceptFunctionParameter_editorContext_94336d9a);
    return result;
  }
  ...
  private static final class AUX_ri6pfc {
    /*package*/ static final SConcept QueryFunction_IsMethodCurrent_bfbb56f1 = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x5917043ba8fab771L, "jetbrains.mps.lang.editor.structure.QueryFunction_IsMethodCurrent");
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_parameterObject_5c17ed34 = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x950e7629b27d763L, "jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_parameterObject");
