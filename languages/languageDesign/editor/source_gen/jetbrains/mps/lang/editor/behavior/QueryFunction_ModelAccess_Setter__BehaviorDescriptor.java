...
public final class QueryFunction_ModelAccess_Setter__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_kelc2g.QueryFunction_ModelAccess_Setter_21a6d07e;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_kelc2g.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_kelc2g.ConceptFunctionParameter_text_1ff5b4fb);
    ListSequence.fromList(result).addElement(AUX_kelc2g.ConceptFunctionParameter_editorContext_94336d9a);
    ListSequence.fromList(result).addElement(AUX_kelc2g.ConceptFunctionParameter_node_c804e037);
    return result;
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_rh2vcw_a0a1();
  }

  /*package*/ QueryFunction_ModelAccess_Setter__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_rh2vcw_a0a1() {
  ...
  private static final class AUX_kelc2g {
    /*package*/ static final SConcept QueryFunction_ModelAccess_Setter_21a6d07e = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x111f9d9c896L, "jetbrains.mps.lang.editor.structure.QueryFunction_ModelAccess_Setter");
