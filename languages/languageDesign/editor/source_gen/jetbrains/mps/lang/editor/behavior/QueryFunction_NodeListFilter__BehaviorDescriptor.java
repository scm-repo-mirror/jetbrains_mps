...
public final class QueryFunction_NodeListFilter__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_jyfecs.QueryFunction_NodeListFilter_6d0c168b;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_jyfecs.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_jyfecs.ConceptFunctionParameter_editorContext_94336d9a);
    ListSequence.fromList(result).addElement(AUX_jyfecs.ConceptFunctionParameter_childNode_f1d54c56);
    return result;
  }
  ...
  private static final class AUX_jyfecs {
    /*package*/ static final SConcept QueryFunction_NodeListFilter_6d0c168b = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x113401f5070L, "jetbrains.mps.lang.editor.structure.QueryFunction_NodeListFilter");
