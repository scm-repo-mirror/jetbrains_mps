...
public final class QueryFunction_SeparatorText__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_9sgoi2.QueryFunction_SeparatorText_fc81261d;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_9sgoi2.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_9sgoi2.ConceptFunctionParameter_node_c804e037);
    return result;
  }
  ...
  private static final class AUX_9sgoi2 {
