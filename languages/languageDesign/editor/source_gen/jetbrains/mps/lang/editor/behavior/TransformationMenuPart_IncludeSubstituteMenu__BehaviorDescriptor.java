...
public final class TransformationMenuPart_IncludeSubstituteMenu__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_wuikzz.TransformationMenuPart_IncludeSubstituteMenu_9237f23d;
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    Scope superScope = ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QDV$.invoke0(__thisNode__, AUX_wuikzz.IIncludeSubstituteMenuPart_2417557e, kind, child);
    ...
    return new FilteringScope(superScope) {
      ...
      public boolean isExcluded(SNode node) {
        if (SNodeOperations.isInstanceOf(node, AUX_wuikzz.AbstractConceptDeclaration_ec74828f)) {
          return !(((boolean) AbstractConceptDeclaration__BehaviorDescriptor.isSubconceptOf_id73yVtVlWOga.invoke(SNodeOperations.cast(node, AUX_wuikzz.AbstractConceptDeclaration_ec74828f), targetConcept)));
        } else if (SNodeOperations.isInstanceOf(node, AUX_wuikzz.SubstituteMenu_Named_2042e193)) {
          return !((boolean) AbstractConceptDeclaration__BehaviorDescriptor.isSubconceptOf_id73yVtVlWOga.invoke(IMenu__BehaviorDescriptor.getApplicableConcept_id1quYWAD18xk.invoke(SNodeOperations.cast(node, AUX_wuikzz.SubstituteMenu_Named_2042e193)), targetConcept));
        }
        return false;
      }
    };
  ...
  private static final class AUX_wuikzz {
