...
public class CellModel_RefCell_Constraints extends BaseConstraintsDescriptor {
  public CellModel_RefCell_Constraints() {
    super(AUX_ykculm.CellModel_RefCell_a9be5399);
  }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_ykculm_a0a0a0a0a1a0a0a0c;
          }
          @Override
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            // singular links declared in concept hierarchy and not overridden 
            SNode editorComponent = SNodeOperations.getNodeAncestor(_context.getContextNode(), AUX_ykculm.BaseEditorComponent_8ae20940, true, false);
  ...
  private static final SNodePointer breakingNode_ykculm_a0a0a0a0a1a0a0a0c = new SNodePointer("r:00000000-0000-4000-0000-011c89590298(jetbrains.mps.lang.editor.constraints)", "6836281137582782617");

  private static final class AUX_ykculm {
