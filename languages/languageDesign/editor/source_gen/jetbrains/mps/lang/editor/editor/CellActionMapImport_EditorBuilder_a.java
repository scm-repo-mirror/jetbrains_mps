...
/*package*/ class CellActionMapImport_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.cellActionMap$jBrw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.cellActionMap$jBrw);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.cellActionMap$jBrw);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new selectorSingleRoleHandler_qtyz1t_d0(myNode, LINKS.selector$zy1K, getEditorContext());
  ...
  private static class selectorSingleRoleHandler_qtyz1t_d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.selector$zy1K, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.selector$zy1K, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.selector$zy1K);
      }
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.selector$zy1K));
      try {
    ...
    private SNode _StyleParameter_QueryFunction_qtyz1t_a0d0() {
      return (SNode) CellActionMapImportSelector__BehaviorDescriptor.getNavigatableNodeWithin_id5Sx2dSLnDj7.invoke(SLinkOperations.getTarget(getNode(), LINKS.selector$zy1K), SLinkOperations.getTarget(getNode(), LINKS.cellActionMap$jBrw));
    }
  }
