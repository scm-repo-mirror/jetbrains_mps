...
/*package*/ class CellActionMapImport_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.cellActionMap$w6kw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.cellActionMap$w6kw);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.cellActionMap$w6kw);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new selectorSingleRoleHandler_qtyz1t_d0(myNode, LINKS.selector$duQg, getEditorContext());
  ...
  private static class selectorSingleRoleHandler_qtyz1t_d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.selector$duQg, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.selector$duQg, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.selector$duQg);
      }
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.selector$duQg));
      try {
    ...
    private SNode _StyleParameter_QueryFunction_qtyz1t_a0d0() {
      return (SNode) CellActionMapImportSelector__BehaviorDescriptor.getNavigatableNodeWithin_id5Sx2dSLnDj7.invoke(SLinkOperations.getTarget(getNode(), LINKS.selector$duQg), SLinkOperations.getTarget(getNode(), LINKS.cellActionMap$w6kw));
    }
  }
