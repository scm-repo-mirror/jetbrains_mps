...
public class CellActionMapItem_SubstituteMenu extends SubstituteMenuBase {
  ...
  private class SMP_Param_8k8pf4_a extends ParameterizedMenuPart<SEnumerationLiteral, SubstituteMenuItem, SubstituteMenuContext> {
    /*package*/ SMP_Param_8k8pf4_a() {
      super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c89590299(jetbrains.mps.lang.editor.editor)", "1741258697587152992")));
    }
    @NotNull
    @Override
