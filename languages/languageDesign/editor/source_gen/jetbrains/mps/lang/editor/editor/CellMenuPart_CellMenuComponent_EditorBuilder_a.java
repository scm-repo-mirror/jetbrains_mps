...
/*package*/ class CellMenuPart_CellMenuComponent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.cellMenuComponent$bfPt;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.cellMenuComponent$bfPt);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.cellMenuComponent$bfPt);
    }
