...
/*package*/ class CellMenuPart_CellMenuComponent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.cellMenuComponent$6XDQ;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.cellMenuComponent$6XDQ);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.cellMenuComponent$6XDQ);
    }
