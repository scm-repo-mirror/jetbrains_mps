...
/*package*/ class CellMenuPart_ReplaceNode_CustomNodeConcept_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.replacementConcept$9$zW;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.replacementConcept$9$zW);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.replacementConcept$9$zW);
    }
