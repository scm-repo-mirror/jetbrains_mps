...
/*package*/ class CellMenuPart_ReplaceNode_CustomNodeConcept_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.replacementConcept$GZ_F;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.replacementConcept$GZ_F);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.replacementConcept$GZ_F);
    }
