...
/*package*/ class CellModel_RefCell_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_lfsepz_a4a() {
    return SLinkOperations.getTarget(myNode, LINKS.relationDeclaration$E2hc) != null;
  }
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.linkDeclaration$JzAt);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new editorComponentSingleRoleHandler_lfsepz_e0(myNode, LINKS.editorComponent$$jf3, getEditorContext());
  ...
  private static class editorComponentSingleRoleHandler_lfsepz_e0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.editorComponent$$jf3, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.editorComponent$$jf3, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.editorComponent$$jf3);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.DRAW_BORDER, true);
      editorCell.getStyle().putAll(style);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.editorComponent$$jf3));
      try {
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink linkDeclaration$JzAt = MetaAdapterFactory.getReferenceLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfd52a2c922L, 0xfd52a483a2L, "linkDeclaration");
