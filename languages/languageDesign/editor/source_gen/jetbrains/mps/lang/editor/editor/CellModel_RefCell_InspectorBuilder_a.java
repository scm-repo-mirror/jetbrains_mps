...
/*package*/ class CellModel_RefCell_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_lfsepz_a1d0() {
    return (SLinkOperations.getTarget(SLinkOperations.getTarget(myNode, LINKS.editorComponent$36e$), LINKS.conceptDeclaration$sbgS) != null);
  }
  ...
  private EditorCell createRefCell_1() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, LINKS.editorComponent$36e$, CONCEPTS.InlineEditorComponent$CM, "editorComponent", getEditorContext()) {
