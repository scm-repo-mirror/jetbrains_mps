...
/*package*/ class EditorComponentDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_ajnur1.PropertyAttribute_d001db89);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new overridenEditorComponentSingleRoleHandler_qbcy69_b1b1a(myNode, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfb35c2bb47L, 0x619d955714550434L, "overridenEditorComponent"), getEditorContext());
  ...
  private static class contextHintsListHandler_qbcy69_b1b2a extends RefNodeListHandler {
    ...
    public SAbstractConcept getChildSConcept() {
      return AUX_ajnur1.ConceptEditorHintDeclarationReference_e10c95d9;
    }
  ...
  private EditorCell createRefCell_0() {
    ...
    Iterable<SNode> referenceAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_ajnur1.LinkAttribute_d001db6f);
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new cellModelSingleRoleHandler_qbcy69_b2b4a(myNode, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfba0eb7c50L, 0xfba0ec5415L, "cellModel"), getEditorContext());
    return provider.createCell();
  }
  ...
  private static final class AUX_ajnur1 {
