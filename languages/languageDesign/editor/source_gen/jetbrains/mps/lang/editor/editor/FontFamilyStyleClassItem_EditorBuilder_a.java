...
/*package*/ class FontFamilyStyleClassItem_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_w2alof_a2a() {
    return SLinkOperations.getTarget(myNode, LINKS.query$lkqw) == null;
  }
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.family$ktrw;
  ...
  public static class FontFamilyStyleClassItem_generic_cellMenu_w2alof_a0c0 extends AbstractCellMenuPart_Generic_Group {
    ...
    public void handleAction_impl(String parameterObject, SNode node, SModel model, IOperationContext operationContext, EditorContext editorContext) {
      if (Objects.equals(parameterObject, "query")) {
        SPropertyOperations.set(node, PROPS.family$ktrw, null);
        SNodeFactoryOperations.setNewChild(node, LINKS.query$lkqw, null);
      } else {
        SPropertyOperations.set(node, PROPS.family$ktrw, parameterObject);
      }
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new querySingleRoleHandler_w2alof_d0(myNode, LINKS.query$lkqw, getEditorContext());
  ...
  private static class querySingleRoleHandler_w2alof_d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.query$lkqw, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.query$lkqw, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.query$lkqw);
      }
      if (true) {
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.query$lkqw));
      try {
