...
/*package*/ class FontFamilyStyleClassItem_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createComponent_0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_StyleClassItem_cellMenu_w2alof_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  public static class ReplaceWith_StyleClassItem_cellMenu_w2alof_a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    ...
    public SAbstractConcept getReplacementConcept() {
      return AUX_b3el4v.StyleClassItem_828c57b7;
    }
    @Override
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.getStyle().putAll(style);
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new PropertyCellContext(myNode, property), new SubstituteInfoPartExt[]{new FontFamilyStyleClassItem_generic_cellMenu_w2alof_a0c0(), new SChildSubstituteInfoPartEx(editorCell)}));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_b3el4v.PropertyAttribute_d001db89);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new querySingleRoleHandler_w2alof_d0(myNode, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x66f3048aedb8fcd4L, 0x66f3048aedb8fcd5L, "query"), getEditorContext());
  ...
  private static final class AUX_b3el4v {
