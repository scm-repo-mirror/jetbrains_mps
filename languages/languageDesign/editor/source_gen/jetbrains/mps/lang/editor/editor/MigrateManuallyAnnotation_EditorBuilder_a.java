...
/*package*/ class MigrateManuallyAnnotation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_kasd0f_a1a0() {
    return (SLinkOperations.getTarget(myNode, LINKS.migrateTo$aun0) != null);
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.migrateTo$aun0;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.migrateTo$aun0);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.migrateTo$aun0);
    }
    Style style = new StyleImpl();
    style.set(StyleAttributes.NAVIGATABLE_SREFERENCE, LINKS.migrateTo$aun0);
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createReferencePresentation_0() {
      EditorCell_Property editorCell = EditorCell_RefPresentation.create(getEditorContext(), myNode, myReferencingNode, IReferentPresentationProvider.getDefaultPresentation(LINKS.migrateTo$aun0));
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink migrateTo$aun0 = MetaAdapterFactory.getReferenceLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x7ce0198267c4eb2L, 0x7ce0198267c4eb3L, "migrateTo");
  }
