...
/*package*/ class ParametersInformationStyleClassItem_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.parametersInformation$Q49T;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.parametersInformation$Q49T);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.parametersInformation$Q49T);
    }
