      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (root instanceof Frame) {
          ...
          modelAccess.runReadAction(new Runnable() {
            public void run() {
              filename.value = SPropertyOperations.getString(myNode, PROPS.imageFile$n87w);
            }
          });
          ...
          modelAccess.executeCommand(new EditorCommand(myEditorContext) {
            protected void doExecute() {
              SPropertyOperations.set(SelectImageFileButton.this.myNode, PROPS.imageFile$n87w, pathToShow);
            }
          });
        }
      }
