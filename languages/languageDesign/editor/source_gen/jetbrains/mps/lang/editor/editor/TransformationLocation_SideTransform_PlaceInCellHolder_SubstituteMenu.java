...
public class TransformationLocation_SideTransform_PlaceInCellHolder_SubstituteMenu extends SubstituteMenuBase {
  public TransformationLocation_SideTransform_PlaceInCellHolder_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "TransformationLocation_SideTransform_PlaceInCellHolder", new SNodePointer("r:00000000-0000-4000-0000-011c89590299(jetbrains.mps.lang.editor.editor)", "6339028036363453781")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Param_nrkshw_a extends ParameterizedMenuPart<SEnumerationLiteral, SubstituteMenuItem, SubstituteMenuContext> {
    /*package*/ SMP_Param_nrkshw_a() {
      super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c89590299(jetbrains.mps.lang.editor.editor)", "6339028036363453811")));
    }
    @NotNull
    @Override
