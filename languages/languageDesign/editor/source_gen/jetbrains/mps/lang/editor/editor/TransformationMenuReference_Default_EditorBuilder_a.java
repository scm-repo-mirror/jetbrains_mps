...
/*package*/ class TransformationMenuReference_Default_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private SNode _StyleParameter_QueryFunction_9zto5v_a0a0() {
    if ((SLinkOperations.getTarget(getNode(), LINKS.concept$kjNG) == null)) {
      return null;
    }
    return DefaultTransformationMenuUtil.findDefaultTransformationMenuForConcept(SLinkOperations.getTarget(getNode(), LINKS.concept$kjNG));
  }
