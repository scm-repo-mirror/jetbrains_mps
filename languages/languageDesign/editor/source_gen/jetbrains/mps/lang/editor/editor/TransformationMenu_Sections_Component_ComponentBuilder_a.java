...
/*package*/ class TransformationMenu_Sections_Component_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private static class sectionsListHandler_b13n4h_a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sectionsListHandler_b13n4h_a0.this.getNode(), LINKS.sections$CEZb));
      try {
