...
public final class AddIndent_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return (SNodeOperations.getParent(node) != null) && SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), AUX_rx0i8d.CellModel_Collection_26007059) && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(node), AUX_rx0i8d.CellModel_Collection_26007059), MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0x10192e0d3baL, "cellLayout")), AUX_rx0i8d.CellLayout_Indent_3a0f3674) && !((boolean) EditorCellModel__BehaviorDescriptor.isIndented_idi0pN94$.invoke(node));
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode newLine = SNodeFactoryOperations.createNewNode(AUX_rx0i8d.IndentLayoutIndentStyleClassItem_126deb2a, null);
  ...
  private static final class AUX_rx0i8d {
