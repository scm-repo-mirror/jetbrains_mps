...
public class check_ReferenceToNonexistentDefaultSubstituteMenu_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode ref, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode concept = SLinkOperations.getTarget(ref, LINKS.concept$x5r);
    if ((concept == null)) {
      return;
    }
    ...
    if ((DefaultTransformationMenuUtil.findDefaultSubstituteMenuForConcept(concept) == null)) {
      {
        final MessageTarget errorTarget = new ReferenceMessageTarget(LINKS.concept$x5r);
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportInfo(ref, "Default substitute menu for " + SPropertyOperations.getString(concept, PROPS.name$tAp1) + " is not defined. Implicit default menu will be used.", "r:00000000-0000-4000-0000-011c8959029a(jetbrains.mps.lang.editor.typesystem)", "4001367738979305344", null, errorTarget);
      }
    }
  }
