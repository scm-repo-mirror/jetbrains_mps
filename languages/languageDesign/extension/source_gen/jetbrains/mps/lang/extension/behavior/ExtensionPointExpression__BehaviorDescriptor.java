...
public final class ExtensionPointExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    return SConceptOperations.conceptAlias(SNodeOperations.getConcept(__thisNode__)) + "/" + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.extensionPoint$xzwB), PROPS.name$tAp1) + "/";
  }
