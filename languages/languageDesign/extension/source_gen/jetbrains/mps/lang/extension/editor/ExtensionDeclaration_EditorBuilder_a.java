...
/*package*/ class ExtensionDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.extensionPoint$POZi;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.extensionPoint$POZi);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.extensionPoint$POZi);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_1() {
      getCellFactory().pushCellContext();
      try {
        final SProperty property = PROPS.extensionName$fXXK;
        getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private static class fieldDeclarationListHandler_i2dquw_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.fieldDeclaration$sTgv;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ExtensionFieldDeclaration$L0;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(fieldDeclarationListHandler_i2dquw_c0.this.getNode(), LINKS.fieldDeclaration$sTgv));
      try {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new activatorSingleRoleHandler_i2dquw_b4a(myNode, LINKS.activator$4wGR, getEditorContext());
  ...
  private static class activatorSingleRoleHandler_i2dquw_b4a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.activator$4wGR, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.activator$4wGR, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.activator$4wGR);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.activator$4wGR));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new deactivatorSingleRoleHandler_i2dquw_b6a(myNode, LINKS.deactivator$4Bwk, getEditorContext());
    return provider.createCell();
  }
  private static class deactivatorSingleRoleHandler_i2dquw_b6a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.deactivator$4Bwk, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.deactivator$4Bwk, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.deactivator$4Bwk);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.deactivator$4Bwk));
      try {
        EditorCell editorCell = super.createEmptyCell();
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new objectGetterSingleRoleHandler_i2dquw_b8a(myNode, LINKS.objectGetter$USDy, getEditorContext());
    return provider.createCell();
  }
  private static class objectGetterSingleRoleHandler_i2dquw_b8a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.objectGetter$USDy, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.objectGetter$USDy, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.objectGetter$USDy);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.objectGetter$USDy));
      try {
        EditorCell editorCell = super.createEmptyCell();
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ExtensionFieldDeclaration$L0 = MetaAdapterFactory.getConcept(0xc0080a477e374558L, 0xbee99ae18e690549L, 0x61a62b43e1534e99L, "jetbrains.mps.lang.extension.structure.ExtensionFieldDeclaration");
  }
