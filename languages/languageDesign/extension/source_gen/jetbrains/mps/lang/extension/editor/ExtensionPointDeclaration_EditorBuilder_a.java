...
/*package*/ class ExtensionPointDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_obn5mp_a2a() {
    return SPropertyOperations.getString(myNode, PROPS.extensionName$fXXK) != null;
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new objectTypeSingleRoleHandler_obn5mp_e0(myNode, LINKS.objectType$ULR3, getEditorContext());
  ...
  private static class objectTypeSingleRoleHandler_obn5mp_e0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.objectType$ULR3, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.objectType$ULR3, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.objectType$ULR3);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.objectType$ULR3));
      try {
