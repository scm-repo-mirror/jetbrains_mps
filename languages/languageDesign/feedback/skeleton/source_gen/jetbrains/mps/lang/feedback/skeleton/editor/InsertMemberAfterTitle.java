  ...
  /*package*/ static AbstractCellAction createAction_INSERT(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.feedbacks$E$KJ)).insertElement(0, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getInterfaceConcept(0x517077fde44f4338L, 0xa4751d29781dfdb8L, 0x573ae5b8b8cc650eL, "jetbrains.mps.lang.feedback.skeleton.structure.FeedbackRootMember"))));
      }
