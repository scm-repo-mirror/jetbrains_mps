...
public final class FindBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_lhs1xm.FindBlock_c4096cf3;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_lhs1xm.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_lhs1xm.ConceptFunctionParameter_node_831b9c90);
    ListSequence.fromList(result).addElement(AUX_lhs1xm.ConceptFunctionParameter_scope_9273b7b7);
    ListSequence.fromList(result).addElement(AUX_lhs1xm.ConceptFunctionParameter_progressMonitor_c5bb541b);
    return result;
  }
  ...
  private static final class AUX_lhs1xm {
