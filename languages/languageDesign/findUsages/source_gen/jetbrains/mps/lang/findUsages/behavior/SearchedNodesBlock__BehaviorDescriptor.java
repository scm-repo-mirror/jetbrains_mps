...
public final class SearchedNodesBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_melts2.SearchedNodesBlock_1eda078a;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_melts2.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_melts2.ConceptFunctionParameter_scope_9273b7b7);
    ListSequence.fromList(result).addElement(AUX_melts2.ConceptFunctionParameter_node_831b9c90);
    return result;
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_fmmzyf_a0a2();
  }

  /*package*/ SearchedNodesBlock__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_fmmzyf_a0a2() {
  ...
  private static final class AUX_melts2 {
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_scope_9273b7b7 = MetaAdapterFactory.getConcept(0x13744753c81f424aL, 0x9c1bcf8943bf4e86L, 0x10e761e7965L, "jetbrains.mps.lang.sharedConcepts.structure.ConceptFunctionParameter_scope");
    /*package*/ static final SConcept ConceptFunctionParameter_node_831b9c90 = MetaAdapterFactory.getConcept(0x64d34fcdad024e73L, 0xaff8a581124c2e30L, 0x116c9c51f82L, "jetbrains.mps.lang.findUsages.structure.ConceptFunctionParameter_node");
  }
}
