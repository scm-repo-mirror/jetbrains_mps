...
public class GenerationContextOp_PropertyPatternRef_Constraints extends BaseConstraintsDescriptor {
  public GenerationContextOp_PropertyPatternRef_Constraints() {
    super(AUX_wqjpsb.GenerationContextOp_PropertyPatternRef_e935bb5a);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(MetaAdapterFactory.getReferenceLink(0xd7706f639be2479cL, 0xa3daae92af1e64d5L, 0x186874d40ed9c758L, 0x186874d40ed9c75cL, "propertyPatternVar"), this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_wqjpsb_a0a0a0a0a1a0a0a0c;
          }
          @Override
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            List<SNode> result = new ArrayList<SNode>();
            SNode rule = SNodeOperations.getNodeAncestor(_context.getContextNode(), AUX_wqjpsb.PatternReduction_MappingRule_acc8fafd, false, false);
            if ((rule != null) && (SLinkOperations.getTarget(rule, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x190d31fe6a12ebb4L, 0x190d31fe6a13891aL, "pattern")) != null)) {
              ListSequence.fromList(result).addSequence(ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(rule, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x190d31fe6a12ebb4L, 0x190d31fe6a13891aL, "pattern")), AUX_wqjpsb.PropertyPatternVariableDeclaration_b5cd3def, false, new SAbstractConcept[]{})));
            }
  ...
  private static final SNodePointer breakingNode_wqjpsb_a0a0a0a0a1a0a0a0c = new SNodePointer("r:00000000-0000-4000-0000-011c895902ee(jetbrains.mps.lang.generator.generationContext.constraints)", "6836281137582787180");

  private static final class AUX_wqjpsb {
