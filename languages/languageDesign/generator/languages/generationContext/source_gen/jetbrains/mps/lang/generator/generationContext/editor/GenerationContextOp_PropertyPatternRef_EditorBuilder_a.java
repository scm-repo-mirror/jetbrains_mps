...
/*package*/ class GenerationContextOp_PropertyPatternRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.propertyPatternVar$9Zh3;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.propertyPatternVar$9Zh3);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.propertyPatternVar$9Zh3);
    }
