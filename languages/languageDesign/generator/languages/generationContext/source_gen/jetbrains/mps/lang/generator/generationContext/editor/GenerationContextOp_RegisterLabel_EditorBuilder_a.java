...
/*package*/ class GenerationContextOp_RegisterLabel_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new inputNodeSingleRoleHandler_hi1ek1_b0(myNode, LINKS.inputNode$ir5s, getEditorContext());
  ...
  private static class inputNodeSingleRoleHandler_hi1ek1_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.inputNode$ir5s, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.inputNode$ir5s, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.inputNode$ir5s);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.inputNode$ir5s));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new outputNodeSingleRoleHandler_hi1ek1_d0(myNode, LINKS.outputNode$iymV, getEditorContext());
    return provider.createCell();
  }
  private static class outputNodeSingleRoleHandler_hi1ek1_d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.outputNode$iymV, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.outputNode$iymV, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.outputNode$iymV);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.outputNode$iymV));
      try {
        EditorCell editorCell = super.createEmptyCell();
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.label$$zMb;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.label$$zMb);
    }
    Style style = new StyleImpl();
