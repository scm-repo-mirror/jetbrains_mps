...
/*package*/ class Fork_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.plan$P$Kw;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.plan$P$Kw);
    }
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        return SModelOperations.getModelName(SNodeOperations.getModel(SLinkOperations.getTarget(myNode, LINKS.plan$P$Kw)));
      }
    }, myNode);
