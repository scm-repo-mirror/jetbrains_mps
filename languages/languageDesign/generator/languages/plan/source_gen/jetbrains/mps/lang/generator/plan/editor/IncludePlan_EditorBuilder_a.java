...
/*package*/ class IncludePlan_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.plan$fjNR;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.plan$fjNR);
    }
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        return SModelOperations.getModelName(SNodeOperations.getModel(SLinkOperations.getTarget(myNode, LINKS.plan$fjNR)));
      }
    }, myNode);
