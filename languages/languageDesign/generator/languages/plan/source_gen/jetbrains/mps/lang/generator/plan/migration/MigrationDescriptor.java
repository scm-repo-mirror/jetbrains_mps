...
public class MigrationDescriptor implements MigrationAspectDescriptor {
  private Map<Integer, MigrationScript> myScripts = MapSequence.fromMapAndEntryArray(new HashMap<Integer, MigrationScript>(), Map.entry(0, new InPlaceCheckpointDeclarations()), Map.entry(1, new EnhancedTransformStep()), Map.entry(2, new ReplaceGeneratorModulePointer()));
