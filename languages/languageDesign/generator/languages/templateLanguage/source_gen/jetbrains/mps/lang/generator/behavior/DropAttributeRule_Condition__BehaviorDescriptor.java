...
public final class DropAttributeRule_Condition__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_nroef7.DropAttributeRule_Condition_8bf6d65;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_nroef7.TemplateQueryBase_e1242b50);
    ListSequence.fromList(result).addElement(AUX_nroef7.TemplateFunctionParameter_generationContext_c78d9c30);
    ListSequence.fromList(result).addElement(AUX_nroef7.TemplateFunctionParameter_sourceNode_6cc2a91a);
    return result;
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_d9tcme_a0a1();
  }

  /*package*/ DropAttributeRule_Condition__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_d9tcme_a0a1() {
  ...
  private static final class AUX_nroef7 {
    /*package*/ static final SConcept DropAttributeRule_Condition_8bf6d65 = MetaAdapterFactory.getConcept(0xb401a68083254110L, 0x8fd384331ff25befL, 0x67b585b44f4d9446L, "jetbrains.mps.lang.generator.structure.DropAttributeRule_Condition");
