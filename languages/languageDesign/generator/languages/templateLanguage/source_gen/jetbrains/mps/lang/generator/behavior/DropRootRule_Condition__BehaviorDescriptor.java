...
public final class DropRootRule_Condition__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_j8s3ol.DropRootRule_Condition_3c58fd14;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_j8s3ol.TemplateQueryBase_e1242b50);
    ListSequence.fromList(result).addElement(AUX_j8s3ol.TemplateFunctionParameter_generationContext_c78d9c30);
    ListSequence.fromList(result).addElement(AUX_j8s3ol.TemplateFunctionParameter_sourceNode_6cc2a91a);
    return result;
  }
  ...
  private static final class AUX_j8s3ol {
    /*package*/ static final SConcept DropRootRule_Condition_3c58fd14 = MetaAdapterFactory.getConcept(0xb401a68083254110L, 0x8fd384331ff25befL, 0x11c0ad08d2aL, "jetbrains.mps.lang.generator.structure.DropRootRule_Condition");
