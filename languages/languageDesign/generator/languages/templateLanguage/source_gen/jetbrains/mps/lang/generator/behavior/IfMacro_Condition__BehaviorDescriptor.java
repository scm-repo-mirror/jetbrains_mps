...
public final class IfMacro_Condition__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_4wssra.IfMacro_Condition_758d58ff;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_4wssra.TemplateQueryBase_e1242b50);
    ListSequence.fromList(result).addElement(AUX_4wssra.TemplateFunctionParameter_generationContext_c78d9c30);
    ListSequence.fromList(result).addElement(AUX_4wssra.TemplateFunctionParameter_sourceNode_6cc2a91a);
    return result;
  }
  ...
  private static final class AUX_4wssra {
