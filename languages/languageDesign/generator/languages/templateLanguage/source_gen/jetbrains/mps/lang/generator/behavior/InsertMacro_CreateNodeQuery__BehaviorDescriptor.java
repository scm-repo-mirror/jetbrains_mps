...
public final class InsertMacro_CreateNodeQuery__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_qq1xen.InsertMacro_CreateNodeQuery_e5db37e;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_qq1xen.TemplateQueryBase_e1242b50);
    ListSequence.fromList(result).addElement(AUX_qq1xen.TemplateFunctionParameter_generationContext_c78d9c30);
    ListSequence.fromList(result).addElement(AUX_qq1xen.TemplateFunctionParameter_sourceNode_6cc2a91a);
    return result;
  }
  ...
  private static final class AUX_qq1xen {
    /*package*/ static final SConcept InsertMacro_CreateNodeQuery_e5db37e = MetaAdapterFactory.getConcept(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1231e32ff7a958cfL, "jetbrains.mps.lang.generator.structure.InsertMacro_CreateNodeQuery");
