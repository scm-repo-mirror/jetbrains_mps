...
public final class SourceSubstituteMacro_SourceNodeQuery__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_ajq3yq.SourceSubstituteMacro_SourceNodeQuery_27e68b2b;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_ajq3yq.TemplateQueryBase_e1242b50);
    ListSequence.fromList(result).addElement(AUX_ajq3yq.TemplateFunctionParameter_generationContext_c78d9c30);
    ListSequence.fromList(result).addElement(AUX_ajq3yq.TemplateFunctionParameter_sourceNode_6cc2a91a);
    return result;
  }
  ...
  private static final class AUX_ajq3yq {
