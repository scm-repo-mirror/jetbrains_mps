...
/*package*/ class DropAttributeRule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_20f4y9_a3a() {
    return SLinkOperations.getTarget(myNode, LINKS.condition$_XWb) == null;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.applicableConcept$Vjiu;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.applicableConcept$Vjiu);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.applicableConcept$Vjiu);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new conditionSingleRoleHandler_20f4y9_c0(myNode, LINKS.condition$_XWb, getEditorContext());
  ...
  private static class conditionSingleRoleHandler_20f4y9_c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.condition$_XWb, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.condition$_XWb, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.condition$_XWb);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.condition$_XWb));
      try {
