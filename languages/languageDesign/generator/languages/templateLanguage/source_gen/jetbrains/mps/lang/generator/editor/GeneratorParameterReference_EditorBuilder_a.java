...
/*package*/ class GeneratorParameterReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_p6qpij_a1a() {
    return (SLinkOperations.getTarget(myNode, LINKS.declaration$zrCQ) != null);
  }
  private boolean nodeCondition_p6qpij_a2a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isOptional$BMUi);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.declaration$zrCQ;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.declaration$zrCQ);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.declaration$zrCQ);
    }
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        return (String) BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(myNode, LINKS.declaration$zrCQ), LINKS.type$yt60));
      }
    }, myNode);
