...
/*package*/ class MapSrcListMacro_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), AUX_dgcmmj.NodeMacro_2cb20614, "jetbrains.mps.lang.generator.editor.ReplaceNodeMacro"));
  ...
  private static final class AUX_dgcmmj {
