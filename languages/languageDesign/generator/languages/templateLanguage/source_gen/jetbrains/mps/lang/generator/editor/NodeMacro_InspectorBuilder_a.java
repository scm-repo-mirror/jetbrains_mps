...
/*package*/ class NodeMacro_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_e7cx8x_a0c0() {
    return SLinkOperations.getTarget(myNode, LINKS.mappingLabel$Uf98) != null;
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.mappingLabel$Uf98;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.mappingLabel$Uf98);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.mappingLabel$Uf98);
    }
