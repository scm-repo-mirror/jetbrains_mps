...
public class TemplateArgumentPatternVarRefExpression_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_xyrbhp_a(), AUX_xyrbhp.TemplateArgumentPatternVarRefExpression_2ee19034));
  ...
  public class SMP_ReferenceScope_xyrbhp_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_xyrbhp_a() {
      ...
      super((SAbstractConcept) AUX_xyrbhp.TemplateArgumentPatternVarRefExpression_2ee19034, MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x40be82ad503b3c88L, 0x40be82ad503b3ec4L, "patternVarDecl"));
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_xyrbhp_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(AUX_xyrbhp.TemplateArgumentPatternVarRefExpression_2ee19034);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
  ...
  private static final class AUX_xyrbhp {
