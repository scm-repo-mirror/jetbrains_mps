...
/*package*/ class TemplateFragment_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_73o0fl_a1a() {
    return SLinkOperations.getTarget(myNode, LINKS.labelDeclaration$ORJN) != null;
  }
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.labelDeclaration$ORJN);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.labelDeclaration$ORJN);
    }
  ...
  private EditorCell createAttributedNodeCell_0() {
    ...
    style.set(StyleAttributes.BRACKETS_COLOR, getStyleRegistry().getSimpleColor(MPSColors.pink));
    editorCell.getStyle().putAll(style);
    return editorCell;
  }
