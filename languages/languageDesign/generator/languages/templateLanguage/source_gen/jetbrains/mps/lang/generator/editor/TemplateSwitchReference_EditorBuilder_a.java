...
/*package*/ class TemplateSwitchReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.templateSwitch$qS3q;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.templateSwitch$qS3q);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.templateSwitch$qS3q);
    }
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink templateSwitch$qS3q = MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1031eb3122dL, 0x1031eb352ffL, "templateSwitch");
  }
