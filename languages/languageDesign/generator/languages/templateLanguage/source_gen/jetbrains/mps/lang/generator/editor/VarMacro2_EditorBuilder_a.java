...
/*package*/ class VarMacro2_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class variablesListHandler_42cmxr_b1a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(variablesListHandler_42cmxr_b1a0.this.getNode(), LINKS.variables$htEz));
      try {
