...
/*package*/ class Weaving_MappingRule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ruleConsequenceSingleRoleHandler_gkr2rl_a3a(myNode, LINKS.ruleConsequence$mBcD, getEditorContext());
  ...
  private static class ruleConsequenceSingleRoleHandler_gkr2rl_a3a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.ruleConsequence$mBcD, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.ruleConsequence$mBcD, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.ruleConsequence$mBcD);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.ruleConsequence$mBcD));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new contextNodeQuerySingleRoleHandler_gkr2rl_c1d0(myNode, LINKS.contextNodeQuery$T$Sz, getEditorContext());
    return provider.createCell();
  }
  private static class contextNodeQuerySingleRoleHandler_gkr2rl_c1d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.contextNodeQuery$T$Sz, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.contextNodeQuery$T$Sz, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.contextNodeQuery$T$Sz);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.contextNodeQuery$T$Sz));
      try {
        EditorCell editorCell = super.createEmptyCell();
