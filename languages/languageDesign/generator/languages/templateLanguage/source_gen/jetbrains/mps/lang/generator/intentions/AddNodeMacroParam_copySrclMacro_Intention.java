...
public final class AddNodeMacroParam_copySrclMacro_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable implements ParameterizedIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode copySrcListMacro = SNodeFactoryOperations.createNewNode(CONCEPTS.CopySrcListMacro$63, null);
      ...
      SLinkOperations.setTarget(copySrcListMacro, LINKS.sourceNodesQuery$uLwL, referentValue);
      // set caret 
