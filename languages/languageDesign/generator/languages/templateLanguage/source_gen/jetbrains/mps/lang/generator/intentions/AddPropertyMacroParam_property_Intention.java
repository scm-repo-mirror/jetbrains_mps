...
public final class AddPropertyMacroParam_property_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable implements ParameterizedIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode propertyValue = SNodeFactoryOperations.createNewNode(AUX_wcza7p.PropertyMacro_GetPropertyValue_de10f40c, null);
      SNode dotExpression = SNodeFactoryOperations.createNewNode(AUX_wcza7p.DotExpression_97ed08d8, null);
      SNode propertyAccess = SNodeFactoryOperations.createNewNode(AUX_wcza7p.SPropertyAccess_5799f99, null);
      ...
      SLinkOperations.setTarget(dotExpression, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, 0x116b46a4416L, "operand"), SNodeFactoryOperations.createNewNode(AUX_wcza7p.TemplateFunctionParameter_sourceNode_6cc2a91a, null));
      SNode expressionStatement = SNodeFactoryOperations.createNewNode(AUX_wcza7p.ExpressionStatement_9dbf9b0c, null);
  ...
  private static final class AUX_wcza7p {
