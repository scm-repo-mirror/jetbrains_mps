...
public final class AddReferenceMacroParam_link_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable implements ParameterizedIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode referentValue = SNodeFactoryOperations.createNewNode(CONCEPTS.ReferenceMacro_GetReferent$OO, null);
      ...
      SLinkOperations.setTarget(linkAccess, LINKS.link$22g7, myParameter);
      ...
      SLinkOperations.setTarget(referenceMacro, LINKS.referentFunction$ABIo, referentValue);
      // set caret 
