...
public final class NewTemplateInWeavingRule_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    ...
    return SLinkOperations.getTarget(node, LINKS.ruleConsequence$pweR) == null || SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(SLinkOperations.getTarget(node, LINKS.ruleConsequence$pweR))), CONCEPTS.RuleConsequence$N0);
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode contextNodeType = TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(SNodeOperations.cast(node, CONCEPTS.Weaving_MappingRule$Iv), LINKS.contextNodeQuery$Pu5X));
      ...
      // make reference 
      SNode tr = SNodeFactoryOperations.setNewChild(node, LINKS.ruleConsequence$pweR, CONCEPTS.TemplateDeclarationReference$bd);
