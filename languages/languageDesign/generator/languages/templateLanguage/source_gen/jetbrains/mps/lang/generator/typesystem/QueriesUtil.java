...
public class QueriesUtil {
  ...
  public static void equate_templateFunction_inputNodeType(final TypeCheckingContext typeCheckingContext, SNode contextNode, SNode InputNodeType) {
    ...
    SNode applicableConcept = jetbrains.mps.lang.generator.helper.QueriesUtil.getApplicableConcept_fromEnvironment(contextNode);
    {
      ...
      typeCheckingContext.createEquation((SNode) _quotation_createNode_w9106s_a0a2a4a1(applicableConcept), (SNode) InputNodeType, _info_12389875345);
    }
  }
...
__switch__:
  ...
  /*package*/ static void equate_outputNodeType_fromSourceQuery(final TypeCheckingContext typeCheckingContext, final SNode query, final SNode TypeToEquate) {
    if (query == null) {
      {
        ...
        typeCheckingContext.createEquation((SNode) TypeToEquate, (SNode) _quotation_createNode_w9106s_a1a2a0a0a4(), _info_12389875345);
      }
      return;
    }
    final SNode Concept_typevar_1226671834537 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_w9106s_a0a2a2a4(typeCheckingContext.getRepresentative(Concept_typevar_1226671834537), typeCheckingContext.getRepresentative(Concept_typevar_1226671834537)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902e4(jetbrains.mps.lang.generator.typesystem)", "1226671782084", false), false, true, _info_12389875345);
    }
    {
      SNode _nodeToCheck_1029348928467 = null;
      ...
      typeCheckingContext.createEquation((SNode) TypeToEquate, (SNode) _quotation_createNode_w9106s_a1a2a3a4(typeCheckingContext.getRepresentative(Concept_typevar_1226671834537)), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_w9106s_a0a2a4a1(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_w9106s_a1a2a0a0a4() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode _quotation_createNode_w9106s_a0a2a2a4(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode _quotation_createNode_w9106s_a1a2a3a4(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, "jetbrains.mps.lang.smodel"), 0x108f968b3caL, "SNodeType"), null, null, false);
    SNodeAccessUtil.setReferenceTarget(quotedNode_2, MetaAdapterFactory.getReferenceLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x108f968b3caL, 0x1090e46ca51L, "concept"), (SNode) parameter_1);
