...
public class TemplateModelImpl extends TemplateModelBase {
  ...
  public String getLongName() {
    return "jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_ArgumentsInTemplateDeclarationReference";
  }
  ...
  public TemplateDeclaration loadTemplate(TemplateDeclarationKey key) {
    ...
    if (template.equals(new SNodePointer("r:b5afdf3a-04e4-43b0-b72c-a4e3b5141a37(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_ArgumentsInTemplateDeclarationReference@generator)", "7496726876599872860"))) {
      return new Template_reduceWithArgs();
    }
