...
/*package*/ class InputRootWithStatementList_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.useInTest$6mVt;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new statementListSingleRoleHandler_9a4nm0_b4a(myNode, LINKS.statementList$LPrK, getEditorContext());
  ...
  private static class statementListSingleRoleHandler_9a4nm0_b4a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.statementList$LPrK, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.statementList$LPrK, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.statementList$LPrK);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.statementList$LPrK));
      try {
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty useInTest$6mVt = MetaAdapterFactory.getProperty(0xab0ae915e3b54f35L, 0xb55ac655d649a03cL, 0x11986ebf992L, 0x11986ed1901L, "useInTest");
  }
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink statementList$LPrK = MetaAdapterFactory.getContainmentLink(0xab0ae915e3b54f35L, 0xb55ac655d649a03cL, 0x11986ebf992L, 0x11986ec6379L, "statementList");
  }
}
