...
/*package*/ class CustomStatementRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.myStatement$AJtq;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.myStatement$AJtq);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.myStatement$AJtq);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.ii$AJtT;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty ii$AJtT = MetaAdapterFactory.getProperty(0x157a9668bf58417bL, 0x893e53d86388dc56L, 0x1e076e8c8ce9211aL, 0x1e076e8c8ce92802L, "ii");
  }
}
