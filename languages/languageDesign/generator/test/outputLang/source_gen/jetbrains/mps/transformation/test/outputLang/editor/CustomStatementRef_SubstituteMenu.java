...
public class CustomStatementRef_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_vjpwj5_a(), AUX_vjpwj5.CustomStatementRef_e0ac4de7));
  ...
  public class SMP_ReferenceScope_vjpwj5_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_vjpwj5_a() {
      ...
      super((SAbstractConcept) AUX_vjpwj5.CustomStatementRef_e0ac4de7, MetaAdapterFactory.getReferenceLink(0x157a9668bf58417bL, 0x893e53d86388dc56L, 0x1e076e8c8ce9211aL, 0x1e076e8c8ce92801L, "myStatement"));
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_vjpwj5_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(AUX_vjpwj5.CustomStatementRef_e0ac4de7);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
  ...
  private static final class AUX_vjpwj5 {
