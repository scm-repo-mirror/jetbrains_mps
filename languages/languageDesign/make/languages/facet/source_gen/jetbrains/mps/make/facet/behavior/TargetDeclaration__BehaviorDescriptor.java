...
public final class TargetDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_y5vkdx.TargetDeclaration_ec040aeb;
  ...
  /*package*/ static SNode facetDeclaration_id6O0kUTrtki6(@NotNull SNode __thisNode__) {
    return SNodeOperations.as(SNodeOperations.getParent(__thisNode__), AUX_y5vkdx.FacetDeclaration_ec040a6d);
  }
  /*package*/ static String getTargetFqName_idLXloLaM9s9(@NotNull SNode __thisNode__) {
    String ffqn = FacetDeclaration__BehaviorDescriptor.getFacetFqName_id1ExXGqkc_QX.invoke(SNodeOperations.as(SNodeOperations.getParent(__thisNode__), AUX_y5vkdx.FacetDeclaration_ec040a6d));
  ...
  private static final class AUX_y5vkdx {
