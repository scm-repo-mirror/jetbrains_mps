...
public class ExtendsFacetReference_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for ExtendsFacetReference. Generated from implicit smart reference attribute.", new SNodePointer("r:b16ff46d-fa06-479d-9f5c-5b6e17e7f1b2(jetbrains.mps.make.facet.structure)", "6447445394688555033")));
    try {
  ...
  public class SMP_ReferenceScope_o2m7k5_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_o2m7k5_a() {
      ...
      super((SAbstractConcept) CONCEPTS.ExtendsFacetReference$4a, LINKS.facet$M0dw);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_o2m7k5_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "ExtendsFacetReference", null));
      try {
        return super.createItems(context);
      } finally {
        context.getEditorMenuTrace().popTraceInfo();
