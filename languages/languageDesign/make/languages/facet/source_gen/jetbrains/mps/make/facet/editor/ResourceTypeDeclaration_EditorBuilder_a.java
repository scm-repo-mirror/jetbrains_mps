...
/*package*/ class ResourceTypeDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new resourceTypeListHandler_57opql_a0(myNode, getEditorContext());
  ...
  private static class resourceTypeListHandler_57opql_a0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.resourceType$VkPy;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(resourceTypeListHandler_57opql_a0.this.getNode(), LINKS.resourceType$VkPy));
      try {
