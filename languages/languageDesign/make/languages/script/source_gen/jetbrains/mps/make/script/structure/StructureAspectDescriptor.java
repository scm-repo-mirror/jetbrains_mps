...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForReportFeedbackStatement() {
    ...
    b.version(2);
    b.property("feedback", 0x32eac1b57fc1b82eL).type(MetaIdFactory.dataTypeId(0x95f8a3e6f9944ca0L, 0xa65e763c9bae2d3bL, 0x32eac1b57fc1b82aL)).origin("4241665505353454025").done();
  ...
  private static ConceptDescriptor createDescriptorForResultStatement() {
    ...
    b.version(2);
    b.property("result", 0x6237d5bb8b2a942eL).type(MetaIdFactory.dataTypeId(0x95f8a3e6f9944ca0L, 0xa65e763c9bae2d3bL, 0x20c069f80a9472daL)).origin("4241665505353454023").done();
    b.kind(ConceptKind.NORMAL, StaticScope.NONE);
    return b.create();
  }
