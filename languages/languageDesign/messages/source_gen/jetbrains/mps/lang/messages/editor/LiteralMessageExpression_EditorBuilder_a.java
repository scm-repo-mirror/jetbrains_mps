...
/*package*/ class LiteralMessageExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.message$cm50;
      ...
      editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.LiteralMessageExpression$Ga, "jetbrains.mps.lang.messages.editor.LiteralMessageAllowsMacros"));
