...
/*package*/ class LiteralMessageExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.message$umWY;
      ...
      editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.LiteralMessageExpression$$8, "jetbrains.mps.lang.messages.editor.LiteralMessageAllowsMacros"));
