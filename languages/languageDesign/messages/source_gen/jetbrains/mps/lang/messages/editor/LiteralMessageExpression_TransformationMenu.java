...
public class LiteralMessageExpression_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "LiteralMessageExpression", new SNodePointer("r:46037634-9be0-4da8-8dd8-3cb367171177(jetbrains.mps.lang.messages.editor)", "4356326056161557747")));
    try {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new LiteralMessageExpression_TransformationMenu.TMP_Param_4hvhzf_a0());
    }
    return result;
  }

  private class TMP_Param_4hvhzf_a0 extends ParameterizedMenuPart<SNode, TransformationMenuItem, TransformationMenuContext> {

    @NotNull
    @Override
    protected List<TransformationMenuItem> createItems(SNode parameter, TransformationMenuContext context) {
      return new LiteralMessageExpression_TransformationMenu.TMP_Param_4hvhzf_a0.TMP_Action_4hvhzf_a0a(parameter).createItems(context);
    }
    ...
    private class TMP_Action_4hvhzf_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      private final SNode myParameterObject;
      public TMP_Action_4hvhzf_a0a(SNode parameterObject) {
        myParameterObject = parameterObject;
      }
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        LiteralMessageExpression_TransformationMenu.TMP_Param_4hvhzf_a0.TMP_Action_4hvhzf_a0a.Item item = new LiteralMessageExpression_TransformationMenu.TMP_Param_4hvhzf_a0.TMP_Action_4hvhzf_a0a.Item(context);
        String description;
        try {
