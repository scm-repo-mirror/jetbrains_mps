...
@GeneratedClass(nodeId = "5168866961623738063", model = "528ff3b9-5fc4-40dd-931f-c6ce3650640e/r:f69c3fa1-0e30-4980-84e2-190ae44e4c3d(jetbrains.mps.lang.migration.runtime/jetbrains.mps.lang.migration.runtime.base)")
  ...
  public static RefactoringScript resolve(final SRepository repo, final RefactoringScriptReference sr) {
    ...
    repo.getModelAccess().runReadAction(() -> {
      ...
      if (module instanceof Language) {
        ...
        final SNode log = ListSequence.fromList(SModelOperations.roots(migrationModel, CONCEPTS.RefactoringLog$xp)).where((it) -> SPropertyOperations.getInteger(it, PROPS.fromVersion$clQh) == current).first();
        if (log == null) {
