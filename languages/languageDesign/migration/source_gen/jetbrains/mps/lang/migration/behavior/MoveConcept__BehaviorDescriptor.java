...
public final class MoveConcept__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_uhenws.MoveConcept_c2b72190;
  ...
  /*package*/ static void doDeprecateOldNode_id1NHZk5hiKRu(@NotNull SNode __thisNode__, SRepository repository) {
    SNode from = SNodeOperations.cast(MoveNodeSpecialization__BehaviorDescriptor.getFrom_id1NHZk5hj1Zl.invoke(__thisNode__, repository), AUX_uhenws.AbstractConceptDeclaration_ec74828f);
    ...
    SNode to = SNodeOperations.cast(MoveNodeSpecialization__BehaviorDescriptor.getTo_id1NHZk5hj1ls.invoke(__thisNode__, repository), AUX_uhenws.AbstractConceptDeclaration_ec74828f);
    ...
    AttributeOperations.setAttribute(SNodeOperations.cast(from, AUX_uhenws.AbstractConceptDeclaration_ec74828f), new IAttributeDescriptor.NodeAttribute(AUX_uhenws.DeprecatedNodeAnnotation_3819b71a), createDeprecatedNodeAnnotation_t3xq9p_a0e0b("The concept was moved to language \"" + SNodeOperations.getModel(SNodeOperations.cast(to, AUX_uhenws.AbstractConceptDeclaration_ec74828f)).getModule().getModuleName() + "\""));
  }
  ...
  private static SNode createDeprecatedNodeAnnotation_t3xq9p_a0e0b(Object p0) {
    ...
    SNode n1 = SModelUtil_new.instantiateConceptDeclaration(AUX_uhenws.DeprecatedNodeAnnotation_3819b71a, null, null, false);
  ...
  private static final class AUX_uhenws {
