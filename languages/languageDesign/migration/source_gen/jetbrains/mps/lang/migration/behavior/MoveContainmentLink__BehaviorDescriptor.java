...
public final class MoveContainmentLink__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_7uvhq6.MoveContainmentLink_c2b72194;
  ...
  /*package*/ static void doDeprecateOldNode_id1NHZk5hiKRu(@NotNull SNode __thisNode__, SRepository repository) {
    SNode from = SNodeOperations.cast(MoveNodeSpecialization__BehaviorDescriptor.getFrom_id1NHZk5hj1Zl.invoke(__thisNode__, repository), AUX_7uvhq6.LinkDeclaration_ce818bfc);
    ...
    SNode to = SNodeOperations.cast(MoveNodeSpecialization__BehaviorDescriptor.getTo_id1NHZk5hj1ls.invoke(__thisNode__, repository), AUX_7uvhq6.LinkDeclaration_ce818bfc);
    ...
    AttributeOperations.setAttribute(from, new IAttributeDescriptor.NodeAttribute(AUX_7uvhq6.DeprecatedNodeAnnotation_3819b71a), createDeprecatedNodeAnnotation_8j70jv_a0e0a("The link was moved to concept \"" + INamedConcept__BehaviorDescriptor.getFqName_idhEwIO9y.invoke(SNodeOperations.cast(SNodeOperations.getParent(to), AUX_7uvhq6.AbstractConceptDeclaration_ec74828f)) + "\""));
  }
  ...
  private static SNode createDeprecatedNodeAnnotation_8j70jv_a0e0a(Object p0) {
    ...
    SNode n1 = SModelUtil_new.instantiateConceptDeclaration(AUX_7uvhq6.DeprecatedNodeAnnotation_3819b71a, null, null, false);
  ...
  private static final class AUX_7uvhq6 {
