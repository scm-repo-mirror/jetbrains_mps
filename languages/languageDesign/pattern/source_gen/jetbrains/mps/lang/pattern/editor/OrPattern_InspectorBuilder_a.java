...
/*package*/ class OrPattern_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new variableListHandler_oeflkv_b0(myNode, getEditorContext());
  ...
  private static class variableListHandler_oeflkv_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(variableListHandler_oeflkv_b0.this.getNode(), LINKS.variable$_xUF));
      try {
