...
public class AddWorkbenchToActionParameters_Contribution extends SubstituteMenuBase {
  ...
  private class SMP_Param_bkyuyj_a extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected Iterable<? extends SNode> getParameters(SubstituteMenuContext _context) {
      return SNodeOperations.ofConcept(IClassifierType__BehaviorDescriptor.getMembers_id6r77ob2V1Fr.invoke(_quotation_createNode_bkyuyj_a0a0a0a()), CONCEPTS.StaticFieldDeclaration$R5);
    }
