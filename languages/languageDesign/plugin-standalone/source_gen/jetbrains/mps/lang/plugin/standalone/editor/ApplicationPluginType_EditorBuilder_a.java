...
/*package*/ class ApplicationPluginType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.plugin$HQ_8;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.plugin$HQ_8);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.plugin$HQ_8);
    }
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink plugin$HQ_8 = MetaAdapterFactory.getReferenceLink(0xef7bf5acd06c4342L, 0xb11de42104eb9343L, 0x6b059b0986f204fL, 0x6b059b0986f2051L, "plugin");
  }
