...
/*package*/ class GetPreferencesComponentInProjectOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.componentDeclaration$ho40;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.componentDeclaration$ho40);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.componentDeclaration$ho40);
    }
