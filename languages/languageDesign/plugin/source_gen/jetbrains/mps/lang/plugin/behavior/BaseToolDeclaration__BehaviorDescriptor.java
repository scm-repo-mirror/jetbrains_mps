...
public final class BaseToolDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> hasNumber_id5FstybB4d8v = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("hasNumber").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("5FstybB4d8v").build();
  ...
  public static final SMethod<String> getExpandedIconPath_id5FstybB4d94 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getExpandedIconPath").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("5FstybB4d94").build();
  ...
  /*package*/ static String getExpandedIconPath_id5FstybB4d94(@NotNull SNode __thisNode__) {
    ...
    return MacrosFactory.forModule(module).expandPath(SPropertyOperations.getString(__thisNode__, PROPS.icon$E_UG));
  }
  /*package*/ static PropertyReference getPropertyToCheck_id4cWf37B8oYh(@NotNull SNode __thisNode__) {
    return new PropertyReference(__thisNode__, PROPS.caption$A_WD);
  }
  ...
  private static SNode _quotation_createNode_7ol7e8_a0a3(Object parameter_1) {
    ...
    quotedNode_2 = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, "jetbrains.mps.lang.plugin"), 0x11961ebbf24L, "ToolType")).getResult();
  ...
  private static SNode _quotation_createNode_7ol7e8_a0a4() {
    ...
    quotedNode_1.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), facade.createNodeReference("742f6602-5a2f-4313-aa6e-ae1cd4ffdc61/java:jetbrains.mps.ide.tools(MPS.Platform/)/~BaseTool"));
    return quotedNode_1;
  }
