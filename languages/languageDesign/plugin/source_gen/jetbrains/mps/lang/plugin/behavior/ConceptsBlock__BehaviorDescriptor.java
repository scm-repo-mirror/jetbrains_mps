...
public final class ConceptsBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_v3evr5.ConceptsBlock_191cd234;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_v3evr5.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_v3evr5.ConceptFunctionParameter_node_8c8dbd9e);
    return result;
  }
  ...
  private static final class AUX_v3evr5 {
    /*package*/ static final SConcept ConceptsBlock_191cd234 = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x6785022a196e8effL, "jetbrains.mps.lang.plugin.structure.ConceptsBlock");
