...
public final class GetNodeBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_mjfvuj.GetNodeBlock_3262e26f;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_mjfvuj.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_mjfvuj.ConceptFunctionParameter_node_8c8dbd9e);
    return result;
  }
  ...
  /*package*/ GetNodeBlock__BehaviorDescriptor() {
  }
  ...
  private static final class AUX_mjfvuj {
