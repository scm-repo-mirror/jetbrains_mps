...
public final class NumberToolShortcut__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int getNumber_idqbzkx46jl9(@NotNull SNode __thisNode__) {
    if (REGEXP_k3b4z8_a0a0a8.matcher(SPropertyOperations.getString(__thisNode__, PROPS.number$5Dx6)).matches()) {
      return Integer.parseInt(SPropertyOperations.getString(__thisNode__, PROPS.number$5Dx6));
    } else {
      return -1;
    }
  }
