...
public final class OnBeforeWriteBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_4fzv3a.OnBeforeWriteBlock_94f6cffa;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_4fzv3a.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_4fzv3a.ConceptFunctionParameter_MPSProject_83f59e4);
    return result;
  }
  ...
  private static final class AUX_4fzv3a {
    /*package*/ static final SConcept OnBeforeWriteBlock_94f6cffa = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x119e1f3f82bL, "jetbrains.mps.lang.plugin.structure.OnBeforeWriteBlock");
