...
public final class PreferencePageCommitBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_ggnv3q.PreferencePageCommitBlock_1eb964d;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_ggnv3q.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_ggnv3q.ConceptFunctionParameter_Project_6ddce6ef);
    ListSequence.fromList(result).addElement(AUX_ggnv3q.ConceptFunctionParameter_PreferencePage_component_29277c31);
    return result;
  }
  ...
  private static final class AUX_ggnv3q {
    /*package*/ static final SConcept PreferencePageCommitBlock_1eb964d = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x119e291160cL, "jetbrains.mps.lang.plugin.structure.PreferencePageCommitBlock");
