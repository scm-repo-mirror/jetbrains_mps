...
public final class PreferencePageResetBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_cyil04.PreferencePageResetBlock_4fc593;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_cyil04.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_cyil04.ConceptFunctionParameter_Project_6ddce6ef);
    ListSequence.fromList(result).addElement(AUX_cyil04.ConceptFunctionParameter_PreferencePage_component_29277c31);
    return result;
  }
  ...
  private static final class AUX_cyil04 {
    /*package*/ static final SConcept PreferencePageResetBlock_4fc593 = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x119e28fc2f6L, "jetbrains.mps.lang.plugin.structure.PreferencePageResetBlock");
