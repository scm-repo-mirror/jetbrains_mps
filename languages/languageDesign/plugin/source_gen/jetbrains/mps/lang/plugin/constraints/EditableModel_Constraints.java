...
public class EditableModel_Constraints extends BaseConstraintsDescriptor {
  public EditableModel_Constraints() {
    super(AUX_z543ji.EditableModel_b7dd1c82);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return TypecheckingFacade.getFromContext().isSubtype(TypecheckingFacade.getFromContext().getTypeOf(SNodeOperations.getNodeAncestor(parentNode, AUX_z543ji.ActionDataParameterDeclaration_44247ef5, true, false)), _quotation_createNode_z543ji_b0a0a3());
  }
  ...
  private static final class AUX_z543ji {
    /*package*/ static final SConcept EditableModel_b7dd1c82 = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x4ecd9810833251a2L, "jetbrains.mps.lang.plugin.structure.EditableModel");
