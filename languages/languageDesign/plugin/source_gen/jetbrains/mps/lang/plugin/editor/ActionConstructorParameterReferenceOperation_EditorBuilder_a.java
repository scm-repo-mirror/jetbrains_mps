...
/*package*/ class ActionConstructorParameterReferenceOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.declaration$ex07);
    ...
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfoSmartReferenceDecorator(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.ActionConstructionParameterDeclaration$AK)));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink declaration$ex07 = MetaAdapterFactory.getReferenceLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x11daf6e60e3L, 0x11daf6f626eL, "declaration");
  }
