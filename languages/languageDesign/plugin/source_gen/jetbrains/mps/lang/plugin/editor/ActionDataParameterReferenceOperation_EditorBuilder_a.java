...
/*package*/ class ActionDataParameterReferenceOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.parameterDeclaration$8HQn);
    ...
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfoSmartReferenceDecorator(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.ActionDataParameterDeclaration$Wd)));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink parameterDeclaration$8HQn = MetaAdapterFactory.getReferenceLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x11b69e60be0L, 0x11b69e60be3L, "parameterDeclaration");
  }
