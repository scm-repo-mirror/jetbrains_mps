...
/*package*/ class ActionParameterReferenceOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.parameterDeclaration$aMqr);
    ...
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfoSmartReferenceDecorator(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.ActionParameterDeclaration$rR)));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink parameterDeclaration$aMqr = MetaAdapterFactory.getReferenceLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x118d0b7fab3L, 0x118d0bb8cbfL, "parameterDeclaration");
  }
