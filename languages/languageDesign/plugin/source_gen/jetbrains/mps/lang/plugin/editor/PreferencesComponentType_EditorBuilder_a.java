...
/*package*/ class PreferencesComponentType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.componentDeclaration$svsy;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.componentDeclaration$svsy);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.componentDeclaration$svsy);
    }
