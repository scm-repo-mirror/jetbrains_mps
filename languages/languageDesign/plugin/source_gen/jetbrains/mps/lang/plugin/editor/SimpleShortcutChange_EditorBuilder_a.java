...
/*package*/ class SimpleShortcutChange_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class keystrokeListHandler_x0wya_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(keystrokeListHandler_x0wya_b0.this.getNode(), LINKS.keystroke$9uQp));
      try {
