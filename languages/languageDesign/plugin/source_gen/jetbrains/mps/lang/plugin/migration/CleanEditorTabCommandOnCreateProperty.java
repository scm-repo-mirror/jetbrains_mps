...
public class CleanEditorTabCommandOnCreateProperty extends MigrationScriptBase {
  ...
  public void doExecute(final SModule m) {
    {
      ...
      CollectionSequence.fromCollection(CommandUtil.instances(CommandUtil.selectScope(null, context), CONCEPTS.EditorTab$zO, false)).visitAll(new IVisitor<SNode>() {
        public void visit(SNode it) {
          SPropertyOperations.remove(it, PROPS.commandOnCreate$B0K$);
        }
      });
    }
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty commandOnCreate$B0K$ = MetaAdapterFactory.getProperty(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x33f4c34299ff0d2fL, 0x71dc7d539b7857cfL, "commandOnCreate");
  }
}
