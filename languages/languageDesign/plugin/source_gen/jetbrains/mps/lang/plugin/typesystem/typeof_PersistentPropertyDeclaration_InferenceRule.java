...
public class typeof_PersistentPropertyDeclaration_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode _quotation_createNode_sacma3_a1a0c0b0b(Object parameter_1) {
    ...
    quotedNode_3.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_3, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Cloneable")));
    quotedNode_2.addChild(LINKS.argument$xIHX, quotedNode_3);
    ...
    quotedNode_4.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_4, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Enum")));
    quotedNode_2.addChild(LINKS.argument$xIHX, quotedNode_4);
    ...
    quotedNode_5.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_5, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~String")));
    quotedNode_2.addChild(LINKS.argument$xIHX, quotedNode_5);
    quotedNode_6 = (SNode) parameter_1;
    if (quotedNode_6 != null) {
      quotedNode_2.addChild(LINKS.argument$xIHX, SNodeOperations.copyIfNecessary(quotedNode_6));
    }
    return quotedNode_2;
  }
