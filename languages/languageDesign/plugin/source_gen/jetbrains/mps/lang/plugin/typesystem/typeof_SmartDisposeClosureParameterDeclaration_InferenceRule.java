...
public class typeof_SmartDisposeClosureParameterDeclaration_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode declaration, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode tab = SNodeOperations.getNodeAncestor(declaration, AUX_x0tmu7.AddTabOperation_a51f38cd, false, false);
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(declaration), AUX_x0tmu7.ClosureLiteral_6eeca0d3) && tab != null) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590364(jetbrains.mps.lang.plugin.typesystem)", "485694842828666177", true), (SNode) typeCheckingContext.typeOf(SLinkOperations.getTarget(SNodeOperations.cast(tab, AUX_x0tmu7.AddTabOperation_a51f38cd), MetaAdapterFactory.getContainmentLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x51d51510f17237b8L, 0x6902a1ec28a66248L, "tab")), "r:00000000-0000-4000-0000-011c89590364(jetbrains.mps.lang.plugin.typesystem)", "485694842828666194", true), _info_12389875345);
      }
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return AUX_x0tmu7.SmartDisposeClosureParameterDeclaration_4574bb4b;
  }
  ...
  private static final class AUX_x0tmu7 {
