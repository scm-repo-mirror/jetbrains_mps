...
public final class NodeBuilderInitLink__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode getInitValue_id1o$2SUuvJqx(@NotNull SNode __thisNode__) {
    if (SLinkOperations.getTarget(__thisNode__, LINKS.initValue$UJfh) != null) {
      return SLinkOperations.getTarget(__thisNode__, LINKS.initValue$UJfh);
    } else {
      return SNodeOperations.as(SLinkOperations.getTarget(__thisNode__, LINKS.expression$NDf$), CONCEPTS.NodeBuilderInitLinkValue$_6);
    }
  }
