...
public final class Quotation__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_lhevs6.Quotation_25f29ad1;
  ...
  /*package*/ static boolean suppress_id2WmWrdnSpX7(@NotNull SNode __thisNode__, SNode child) {
    if (ListSequence.fromList(SNodeOperations.getNodeAncestors(child, null, true)).contains(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x3a13115c633c4c5cL, 0xbbcc75c4219e9555L, 0x1168c104659L, 0x1168c10465aL, "quotedNode")))) {
      if (SNodeOperations.isInstanceOf(ListSequence.fromList(SNodeOperations.getNodeAncestorsWhereConceptInList(child, new SAbstractConcept[]{AUX_lhevs6.AbstractAntiquotation_25f29ace, AUX_lhevs6.Quotation_25f29ad1}, true)).first(), AUX_lhevs6.AbstractAntiquotation_25f29ace)) {
        return false;
      }
    }
    return ((boolean) ISuppressErrors__BehaviorDescriptor.suppress_id2WmWrdnSpX7.invoke0(__thisNode__, AUX_lhevs6.ISuppressErrors_96ee6c6d, child));
  }
  ...
  private static final class AUX_lhevs6 {
