...
public class NodeBuilderNode_Constraints extends BaseConstraintsDescriptor {
  /*package*/ NodeBuilderNode_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.NodeBuilderNode$Sn, initContext);
    record(new RD1(this));
  }
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.concept$xoA0, container, true, false);
    }
    @Nullable
    @Override
    public ReferenceScopeProvider getScopeProvider() {
      return ReferenceScopeProvider.fromHierarchy(CONCEPTS.ConceptDeclaration$gH, new SNodePointer("r:abd7937b-2ad1-4cfc-8256-a7fa45a55f0f(jetbrains.mps.lang.quotation.constraints)", "1866752856968203083"));
    }
  }
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    if (link == null || Objects.equals(link.getTargetConcept(), CONCEPTS.Expression$mB)) {
      return Objects.equals(link, LINKS.expression$YNz0);
    } else {
      return true;
    }
  }
