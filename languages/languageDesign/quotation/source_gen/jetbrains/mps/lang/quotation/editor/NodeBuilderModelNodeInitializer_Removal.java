...
public class NodeBuilderModelNodeInitializer_Removal {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (!(DeletionApproverUtil.approve(editorContext, SLinkOperations.getTarget(node, LINKS.modelToCreate$AyVT)))) {
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.modelToCreate$AyVT));
