...
public class addLinkValue_QuickFix extends QuickFix_Runtime {
  ...
  public String getDescription(SNode node) {
    return "Initialize `" + SPropertyOperations.getString(((SNode) addLinkValue_QuickFix.this.getField("link")[0]), PROPS.role$Nsjf) + "'";
  }
  public void execute(SNode node) {
    ...
    SLinkOperations.setTarget(val, LINKS.link$VNT5, ((SNode) addLinkValue_QuickFix.this.getField("link")[0]));
    ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(node, CONCEPTS.NodeBuilderNode$Sn), LINKS.values$JgAV)).addElement(val);
  }
