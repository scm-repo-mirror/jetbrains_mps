...
public class addPropertyValue_QuickFix extends QuickFix_Runtime {
  ...
  public String getDescription(SNode node) {
    return "Initialize `" + SPropertyOperations.getString(((SNode) addPropertyValue_QuickFix.this.getField("property")[0]), PROPS.name$MnvL) + "'";
  }
  public void execute(SNode node) {
    ...
    SLinkOperations.setTarget(val, LINKS.property$Y_u4, ((SNode) addPropertyValue_QuickFix.this.getField("property")[0]));
