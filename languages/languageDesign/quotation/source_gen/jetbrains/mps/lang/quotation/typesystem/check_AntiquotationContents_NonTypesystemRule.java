      ...
      if ((boolean) AbstractConceptDeclaration__BehaviorDescriptor.isSubconceptOf_id4UTtJHK9fEJ.invoke(SLinkOperations.getTarget(SNodeOperations.cast(contentsType, CONCEPTS.SNodeType$hR), LINKS.concept$OMgE), CONCEPTS.Classifier$Ix)) {
        {
          ...
          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(SLinkOperations.getTarget(antiquotation, LINKS.expression$hE$), "Substitution of a classifier here is probably an error", "r:00000000-0000-4000-0000-011c8959034a(jetbrains.mps.lang.quotation.typesystem)", "1228301999219", null, errorTarget);
          {
            BaseQuickFixProvider intentionProvider = new BaseQuickFixProvider("jetbrains.mps.lang.quotation.typesystem.ReplaceClassAntiquotationWithClassifierType_QuickFix", "1228302388410", false);
