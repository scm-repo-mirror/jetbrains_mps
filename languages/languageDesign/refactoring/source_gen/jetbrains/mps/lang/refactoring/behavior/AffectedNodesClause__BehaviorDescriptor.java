...
public final class AffectedNodesClause__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static SNode _quotation_createNode_ypf7uq_a0a2() {
    ...
    quotedNode_1.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_1, facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.ide.findusages.model(MPS.Core/)"), facade.createNodeId("~SearchResults")));
    return quotedNode_1;
  }
