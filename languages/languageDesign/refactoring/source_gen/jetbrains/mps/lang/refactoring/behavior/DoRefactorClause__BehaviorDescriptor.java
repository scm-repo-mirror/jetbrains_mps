...
public final class DoRefactorClause__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_6l7iu6.DoRefactorClause_91b824d6;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_6l7iu6.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_6l7iu6.RefactoringContext_ConceptFunctionParameter_dc994594);
    return result;
  }
  ...
  private static final class AUX_6l7iu6 {
