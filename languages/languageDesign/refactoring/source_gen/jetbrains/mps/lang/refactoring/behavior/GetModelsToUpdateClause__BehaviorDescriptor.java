...
public final class GetModelsToUpdateClause__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_lntx16.GetModelsToUpdateClause_131139f1;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_lntx16.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_lntx16.RefactoringContext_ConceptFunctionParameter_dc994594);
    return result;
  }
  ...
  private static final class AUX_lntx16 {
    /*package*/ static final SConcept GetModelsToUpdateClause_131139f1 = MetaAdapterFactory.getConcept(0x3ecd7c84cde345deL, 0x886c135ecc69b742L, 0x119f1c05cbcL, "jetbrains.mps.lang.refactoring.structure.GetModelsToUpdateClause");
