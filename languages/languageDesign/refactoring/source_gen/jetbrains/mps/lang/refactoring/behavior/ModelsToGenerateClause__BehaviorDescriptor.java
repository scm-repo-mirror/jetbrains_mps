...
public final class ModelsToGenerateClause__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_l138k5.ModelsToGenerateClause_e2d6af3a;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_l138k5.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_l138k5.RefactoringContext_ConceptFunctionParameter_dc994594);
    return result;
  }
  ...
  private static final class AUX_l138k5 {
