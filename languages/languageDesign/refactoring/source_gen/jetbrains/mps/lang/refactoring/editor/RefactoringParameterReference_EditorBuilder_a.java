...
/*package*/ class RefactoringParameterReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.refactoringParameter$Q8o0;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.refactoringParameter$Q8o0);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.refactoringParameter$Q8o0);
    }
