...
public class typeof_ExecuteRefactoringStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode statement, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode target = SLinkOperations.getTarget(SLinkOperations.getTarget(statement, LINKS.refactoring$WUC4), LINKS.target$qEUa);
    if (SPropertyOperations.getBoolean(target, PROPS.allowMultiple$_gcJ) == false) {
      {
        SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(statement, LINKS.target$WTV1);
    ...
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(statement, LINKS.project$WUp3);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(statement, LINKS.parameters$WUa2)).count() != ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(statement, LINKS.refactoring$WUC4), LINKS.parameter$foUx)).count()) {
      {
        final MessageTarget errorTarget = new ReferenceMessageTarget(LINKS.parameters$WUa2);
    ...
    {
      Iterator<SNode> inputParameter_it = ListSequence.fromList(SLinkOperations.getChildren(statement, LINKS.parameters$WUa2)).iterator();
      Iterator<SNode> declaredParameter_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(statement, LINKS.refactoring$WUC4), LINKS.parameter$foUx)).iterator();
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.ExecuteRefactoringStatement$cl;
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept ExecuteRefactoringStatement$cl = MetaAdapterFactory.getConcept(0x3ecd7c84cde345deL, 0x886c135ecc69b742L, 0x1fe4fcef62d0186cL, "jetbrains.mps.lang.refactoring.structure.ExecuteRefactoringStatement");
  }
}
