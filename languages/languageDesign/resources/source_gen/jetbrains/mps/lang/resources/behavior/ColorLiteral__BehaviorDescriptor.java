...
public final class ColorLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> getIntValue_id1BguvjG4ybo = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("getIntValue").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1BguvjG4ybo").build();
