...
public final class InstancesExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_wf91bv.InstancesExpression_bee6738b;
  ...
  /*package*/ static Iterable<SConcept> getSupportedParameters_id3J6h25QXCDW(@NotNull SAbstractConcept __thisConcept__) {
    return ListSequence.fromListAndArray(new ArrayList<SConcept>(), AUX_wf91bv.QueryParameterScope_old_8bfb6f38, AUX_wf91bv.QueryParameterScope_e23e4568, AUX_wf91bv.QueryParameterIncludeReadOnly_old_8bfb6829, AUX_wf91bv.QueryParameterExact_1d0ff961);
  }
  /*package*/ static String getHelpPage_id64VftqEen2L(@NotNull SAbstractConcept __thisConcept__) {
    return HelpProvider__BehaviorDescriptor.getHelpPage_id64VftqEen2L.invokeSuper(__thisConcept__, AUX_wf91bv.InstancesExpression_bee6738b) + "\nImplementation of this command uses the IDE indexes to speed up execution";
  }
  /*package*/ static String getDisplayString_id5YxQmqOFZEf(@NotNull SAbstractConcept __thisConcept__) {
    return HelpProvider__BehaviorDescriptor.getDisplayString_id5YxQmqOFZEf.invokeSuper(__thisConcept__, AUX_wf91bv.InstancesExpression_bee6738b) + "(concept)";
  }
  ...
  private static final class AUX_wf91bv {
