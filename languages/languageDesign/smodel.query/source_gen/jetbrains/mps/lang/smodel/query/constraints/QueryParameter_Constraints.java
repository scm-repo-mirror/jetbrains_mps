...
public class QueryParameter_Constraints extends BaseConstraintsDescriptor {
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    if (!(Objects.equals(SNodeOperations.getContainingLink(parentNode), LINKS.parameter$jM02))) {
      return false;
    }
    return Sequence.fromIterable(QueryExpression__BehaviorDescriptor.getSupportedParameters_id3J6h25QXCDW.invoke(SNodeOperations.asSConcept(SNodeOperations.getConcept(SNodeOperations.cast(SNodeOperations.getParent(parentNode), CONCEPTS.QueryExpression$lN))))).contains(SNodeOperations.castConcept(childConcept, CONCEPTS.QueryParameter$2S));
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept QueryParameter$2S = MetaAdapterFactory.getConcept(0x1a8554c4eb8443baL, 0x8c346f0d90c6e75aL, 0x3bc64421760badf5L, "jetbrains.mps.lang.smodel.query.structure.QueryParameter");
