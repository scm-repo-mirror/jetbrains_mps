...
/*package*/ class QueryParameterList_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class parameterListHandler_3efoba_a0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.parameter$clir;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.QueryParameter$2S;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_3efoba_a0.this.getNode(), LINKS.parameter$clir));
      try {
