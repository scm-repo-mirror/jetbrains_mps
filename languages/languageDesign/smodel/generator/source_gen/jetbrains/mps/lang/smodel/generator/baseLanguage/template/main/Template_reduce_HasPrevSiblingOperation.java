...
@Generated
public class Template_reduce_HasPrevSiblingOperation extends TemplateDeclarationBase {

  public Template_reduce_HasPrevSiblingOperation() {
    super(new MO());
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "8432949284911505812");
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      }
      {
        ...
        {
          environment.associate(tnode3, myAssociationLinks[0], "r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)", "6599163591527294154");
          ...
          TemplateContext context2 = context1.subContext();
          {
            ...
            final SNode copySrcInput4 = QueriesGenerated.sourceNodeQuery_146_0(new SourceSubstituteMacroNodeContext(context2, copySrcMacro_fnd6kv_b0a0c0d0b0c0c0g));
            tlist4 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput4), copySrcMacro_fnd6kv_b0a0c0d0b0c0c0g, "tpl/r:00000000-0000-4000-0000-011c89590303/4979433055039530169", context2);
  ...
  private static final SNodePointer copySrcMacro_fnd6kv_b0a0c0d0b0c0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "4979433055039530170");
}
