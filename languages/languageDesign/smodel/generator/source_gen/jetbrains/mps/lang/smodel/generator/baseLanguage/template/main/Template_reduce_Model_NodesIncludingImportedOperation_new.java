...
@Generated
public class Template_reduce_Model_NodesIncludingImportedOperation_new extends TemplateDeclarationBase {

  public Template_reduce_Model_NodesIncludingImportedOperation_new() {
    super(new MO());
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_44_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_eqijg3_b0a0c0d0c0g));
      ...
      }
      {
        ...
        if (QueriesGenerated.ifMacro_Condition_44_0(new IfMacroContext(context1, ifMacroRef_eqijg3_b0a0b0e0c0g))) {
          Collection<SNode> tlist5 = null;
          {
            final SNode switchInput5 = QueriesGenerated.sourceNodeQuery_44_1(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_eqijg3_b0a0a0a1a1a4a2a6));
  ...
  private static final SNodePointer copySrcMacro_eqijg3_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "5443371287119273268");
  private static final SNodePointer switchMacroRef_eqijg3_b0a0a0a1a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6750920497477170815");
  private static final SNodePointer templateSwitchNode_eqijg3_a0a0c0a1a1a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653355606");
  private static final SNodePointer ifMacroRef_eqijg3_b0a0b0e0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6750920497477166897");
}
