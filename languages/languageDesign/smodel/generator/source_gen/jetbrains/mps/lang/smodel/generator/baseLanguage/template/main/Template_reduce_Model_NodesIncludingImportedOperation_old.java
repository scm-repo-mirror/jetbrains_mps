...
@Generated
public class Template_reduce_Model_NodesIncludingImportedOperation_old extends TemplateDeclarationBase {

  public Template_reduce_Model_NodesIncludingImportedOperation_old() {
    super(new MO());
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_43_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_eqijw6_b0a0c0d0c0g));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_eqijw6_b0a0c0d0c0g, "tpl/r:00000000-0000-4000-0000-011c89590303/1182511526039", context1);
      ...
      }
      {
        ...
        SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_43_1(new SourceSubstituteMacroNodeContext(context1, callMacro_eqijw6_b0a0a1a4a2a6));
  ...
  private static final SNodePointer copySrcMacro_eqijw6_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1182511526040");
  private static final SNodePointer callMacro_eqijw6_b0a0a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145303");
}
