...
@Generated
public class Template_reduce_Model_NodesOperation_old extends TemplateDeclarationBase {

  public Template_reduce_Model_NodesOperation_old() {
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1171324405763");
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6599163591527280778")));
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_26_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_68unms_b0a0c0d0c0g));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_68unms_b0a0c0d0c0g, "tpl/r:00000000-0000-4000-0000-011c89590303/1171324405765", context1);
      ...
      }
      {
        ...
        SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_26_1(new SourceSubstituteMacroNodeContext(context1, callMacro_68unms_b0a0a1a4a2a6));
        TemplateContext context2;
        context2 = context1.subContext(null, callInputNode4);
        if (callInputNode4 != null) {
          tlist4 = environment.callSite(new Template_reduce_ConceptDeclaration2SAbstractConcept(), new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145296")).apply(context2);
        }
  ...
  private static final SNodePointer copySrcMacro_68unms_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1171324405766");
  private static final SNodePointer callMacro_68unms_b0a0a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145296");
}
