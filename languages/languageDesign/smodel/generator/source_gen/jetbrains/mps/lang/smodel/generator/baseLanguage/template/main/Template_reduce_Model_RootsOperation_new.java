    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      }
      {
        ...
        if (QueriesGenerated.ifMacro_Condition_25_0(new IfMacroContext(context1, ifMacroRef_79tro0_b0a0b0e0c0g))) {
          ...
          {
            final SNode switchInput5 = QueriesGenerated.sourceNodeQuery_25_1(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_79tro0_b0a0a0a1a1a4a2a6));
            if (switchInput5 == null) {
              ...
              tlist5 = environment.trySwitch(templateSwitchNode_79tro0_a0a0c0a1a1a1a4a2a6, switchContext5);
              if (tlist5 == null) {
