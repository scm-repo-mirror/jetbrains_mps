...
public class Node_GetChildrenAndChildAttributesOperation_Factory {
  public static class NodeFactory_7457491784609238794 implements NodeFactory {
    public void setup(SNode newNode, SNode sampleNode, SNode enclosingNode, int index, SModel model) {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(newNode, LINKS.parameter$mzxB)).addElement(parameter);
      ...
      SLinkOperations.setTarget(parameter, LINKS.linkQualifier$8gyw, refQualifier);
    }
  }
