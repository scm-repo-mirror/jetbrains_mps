...
public final class SwitchExpressionPW_PasteWrapper_2 implements PasteWrapper {
  ...
  public SAbstractConcept getSourceConcept() {
    return AUX_3nypdr.EnumSwitchCaseBody_Expression_81c8e210;
  }
  @Override
  public SAbstractConcept getTargetConcept() {
    return AUX_3nypdr.ExpressionStatement_9dbf9b0c;
  }
  @Override
  public SNode wrap(SNode sourceNode) {
    return createExpressionStatement_degi1_a0a0c(SLinkOperations.getTarget(sourceNode, MetaAdapterFactory.getContainmentLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x220ad6aedf1fdcc5L, 0x220ad6aedf1fdcc6L, "expression")));
  }
  private static SNode createExpressionStatement_degi1_a0a0c(SNode node0) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode n1 = SModelUtil_new.instantiateConceptDeclaration(AUX_3nypdr.ExpressionStatement_9dbf9b0c, null, null, false);
    if (node0 != null) {
      n1.addChild(MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b213L, 0xf8cc56b214L, "expression"), SNodeOperations.copyIfNecessary(SNodeOperations.cast(node0, AUX_3nypdr.Expression_4199e28d)));
    }
    return n1;
  }
