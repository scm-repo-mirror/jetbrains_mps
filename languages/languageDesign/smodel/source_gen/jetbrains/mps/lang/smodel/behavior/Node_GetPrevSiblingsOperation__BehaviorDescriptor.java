...
public final class Node_GetPrevSiblingsOperation__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_i0k7s5.Node_GetPrevSiblingsOperation_ac8b2e07;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id6ALWH9fQysn(@NotNull SAbstractConcept __thisConcept__) {
    return ListSequence.fromListAndArray(new ArrayList<SConcept>(), AUX_i0k7s5.OperationParm_Inclusion_281b6df5);
  }
  ...
  private static final class AUX_i0k7s5 {
