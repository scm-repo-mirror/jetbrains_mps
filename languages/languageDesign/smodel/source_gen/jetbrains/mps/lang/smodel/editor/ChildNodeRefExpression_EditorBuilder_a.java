...
/*package*/ class ChildNodeRefExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new parentSingleRoleHandler_qcpp4v_b0(myNode, LINKS.parent$sz8R, getEditorContext());
  ...
  private static class parentSingleRoleHandler_qcpp4v_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.parent$sz8R, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.parent$sz8R, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.parent$sz8R);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
      editorCell.getStyle().putAll(style);
    ...
    protected EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.parent$sz8R));
      try {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.targetNode$szAT;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.targetNode$szAT);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.targetNode$szAT);
    }
