...
/*package*/ class ConceptIdRefExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_kkjzaq_a0a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.bootstrap$GiM3);
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.conceptDeclaration$l13w;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.conceptDeclaration$l13w);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.conceptDeclaration$l13w);
    }
    Style style = new StyleImpl();
