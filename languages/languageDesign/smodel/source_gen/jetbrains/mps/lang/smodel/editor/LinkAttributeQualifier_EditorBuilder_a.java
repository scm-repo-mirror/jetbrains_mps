...
/*package*/ class LinkAttributeQualifier_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.attributeConcept$yZow;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.attributeConcept$yZow);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.attributeConcept$yZow);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new linkQualifierSingleRoleHandler_mg3hvm_c0(myNode, LINKS.linkQualifier$D95G, getEditorContext());
  ...
  private static class linkQualifierSingleRoleHandler_mg3hvm_c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.linkQualifier$D95G, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.linkQualifier$D95G, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.linkQualifier$D95G);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.linkQualifier$D95G));
      try {
