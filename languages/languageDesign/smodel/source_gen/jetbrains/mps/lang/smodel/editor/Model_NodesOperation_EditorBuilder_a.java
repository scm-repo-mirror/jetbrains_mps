...
/*package*/ class Model_NodesOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_kohub4_a2a() {
    return SLinkOperations.getTarget(myNode, LINKS.concept$r7zb) != null;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.concept$r7zb;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.concept$r7zb);
    }
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new conceptArgumentSingleRoleHandler_kohub4_a2a(myNode, LINKS.conceptArgument$63TI, getEditorContext());
  ...
  private static class conceptArgumentSingleRoleHandler_kohub4_a2a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.conceptArgument$63TI, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.conceptArgument$63TI, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.conceptArgument$63TI);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.conceptArgument$63TI));
      try {
