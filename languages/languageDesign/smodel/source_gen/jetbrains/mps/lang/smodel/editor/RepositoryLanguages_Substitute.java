...
public class RepositoryLanguages_Substitute extends SubstituteMenuBase {
  ...
  private class SMP_Param_pm0kc4_a extends ParameterizedMenuPart<SModuleReference, SubstituteMenuItem, SubstituteMenuContext> {
    /*package*/ SMP_Param_pm0kc4_a() {
      super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "5769081855528901638")));
    }
    @NotNull
    @Override
