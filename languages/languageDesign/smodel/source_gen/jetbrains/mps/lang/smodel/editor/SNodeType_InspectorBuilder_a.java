...
/*package*/ class SNodeType_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  public SNodeType_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_x5m1a6_0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_x5m1a6_0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_x5m1a6_1");
    Style style = new StyleImpl();
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        return ((SLinkOperations.getTarget(myNode, LINKS.concept$gpfa) != null) ? INamedConcept__BehaviorDescriptor.getFqName_idhEwIO9y.invoke(SLinkOperations.getTarget(myNode, LINKS.concept$gpfa)) : "");
      }
    }, myNode);
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_x5m1a6_0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_x5m1a6_2");
    Style style = new StyleImpl();
