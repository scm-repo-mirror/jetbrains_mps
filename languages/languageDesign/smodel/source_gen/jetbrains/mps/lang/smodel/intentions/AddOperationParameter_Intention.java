  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      if (ListSequence.fromList(applicableParms).count() == 1) {
        ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.parameter$mzxB)).addElement(SNodeFactoryOperations.createNewNode(ListSequence.fromList(applicableParms).first(), null));
      } else {
