...
public final class IntentionsDescriptor extends AbstractIntentionAspectDescriptor {
  ...
  public Collection<IntentionFactory> getAllIntentions() {
    ...
    rv[10] = new ConceptRef2Concept_Intention();
    rv[11] = new ConceptNodeType2SConceptType_Intention();
    rv[12] = new ConvertCastToSConceptType_Intention();
    rv[13] = new ConvertConceptNodeToSCOncept_Intention();
    rv[14] = new ConceptNodeType2NodeType_Intention();
    rv[15] = new ReplaceWithModuleRef_Intention();
    rv[16] = new ReplaceWithResolveExpr_Intention();
    rv[17] = new ReplaceWithPointer_Intention();
