...
public class AggregationLinkTypeAsClassifier_ComparisonRule extends ComparisonRule_Runtime {
  /*package*/ GeneratedMatchingPattern myMatchingPattern2;
  public AggregationLinkTypeAsClassifier_ComparisonRule() {
  }
  ...
  public IsApplicableStatus isApplicableSecond(SNode node) {
    {
      GeneratedMatchingPattern pattern = new Pattern_nsgjh_a0a0a0f(_quotation_createNode_nsgjh_a0a0a0a0f());
  ...
  public SAbstractConcept getApplicableConcept1() {
    return CONCEPTS.AggregationLinkType$1r;
  }
  ...
  private static SNode _quotation_createNode_nsgjh_a0a0a0a0f() {
