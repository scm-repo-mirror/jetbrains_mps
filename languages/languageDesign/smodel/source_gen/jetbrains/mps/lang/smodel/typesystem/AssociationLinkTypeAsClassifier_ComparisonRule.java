...
public class AssociationLinkTypeAsClassifier_ComparisonRule extends ComparisonRule_Runtime {
  /*package*/ GeneratedMatchingPattern myMatchingPattern2;
  public AssociationLinkTypeAsClassifier_ComparisonRule() {
  }
  ...
  public IsApplicableStatus isApplicableSecond(SNode node) {
    {
      GeneratedMatchingPattern pattern = new Pattern_qxa1tq_a0a0a0f(_quotation_createNode_qxa1tq_a0a0a0a0f());
  ...
  public SAbstractConcept getApplicableConcept1() {
    return CONCEPTS.AssociationLinkType$9A;
  }
  ...
  private static SNode _quotation_createNode_qxa1tq_a0a0a0a0f() {
