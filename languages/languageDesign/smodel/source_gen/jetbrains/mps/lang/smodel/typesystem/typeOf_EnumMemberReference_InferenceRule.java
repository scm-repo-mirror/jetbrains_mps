  ...
  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1203711941826", true), (SNode) RulesUtil.datatypeBLType(SNodeOperations.as(SNodeOperations.getParent(SLinkOperations.getTarget(node, LINKS.enumMember$hl0V)), CONCEPTS.EnumerationDataTypeDeclaration_Old$B8)), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.EnumMemberReference_Old$15;
  }
