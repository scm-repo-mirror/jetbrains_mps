...
public class typeof_AsSConcept_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode asSConcept, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.whenConcrete(operandType, new Runnable() {
        public void run() {
          if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(operandType), AUX_24c979.ConceptNodeType_842b4d80)) {
            {
              ...
              typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "8828148184967395095", true), (SNode) _quotation_createNode_24c979_a1a0c0a0a0a0a1a0b0a0b(SLinkOperations.getTarget(SNodeOperations.cast(typeCheckingContext.getExpandedNode(operandType), AUX_24c979.ConceptNodeType_842b4d80), MetaAdapterFactory.getReferenceLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x110f9b63680L, 0x112da284156L, "conceptDeclaraton"))), _info_12389875345);
            }
          } else if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(operandType), AUX_24c979.SConceptType_7fe2a457) || SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(operandType), AUX_24c979.SConceptTypeLiteral_83a436c5)) {
            {
              SNode _nodeToCheck_1029348928467 = asSConcept;
            ...
            if (!(typeCheckingContext.isSingleTypeComputation())) {
              {
                ...
                typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.getExpandedNode(operandType), (SNode) _quotation_createNode_24c979_a1a0c0a0a0a0a0a0b0a1a0a1(), true, false, _info_12389875345);
              }
            }
            {
              SNode _nodeToCheck_1029348928467 = asSConcept;
              ...
              typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "955802970103931826", true), (SNode) _quotation_createNode_24c979_a1a0c0b0a0a0a0b0a1a0a1(), _info_12389875345);
            }
          }
        }
  ...
  public SAbstractConcept getApplicableConcept() {
    return AUX_24c979.AsSConcept_f2e34a07;
  }
  ...
  private static SNode _quotation_createNode_24c979_a1a0c0a0a0a0a1a0b0a0b(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_24c979_a1a0c0a0a0a0a0a0b0a1a0a1() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode _quotation_createNode_24c979_a1a0c0b0a0a0a0b0a1a0a1() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
  ...
  private static final class AUX_24c979 {
