...
public class typeof_Node_GetSConceptOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode operand = SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(op), CONCEPTS.DotExpression$6a), LINKS.operand$P1i5);
    final SNode C_typevar_7453996997717785676 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "7453996997717785684", false), (SNode) _quotation_createNode_rcqvls_a1a0c0c0b(typeCheckingContext.getRepresentative(C_typevar_7453996997717785676)), false, true, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "7453996997717785693", true), (SNode) _quotation_createNode_rcqvls_a1a0c0d0b(typeCheckingContext.getRepresentative(C_typevar_7453996997717785676)), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.Node_GetSConceptOperation$EU;
  }
  ...
  private static SNode _quotation_createNode_rcqvls_a1a0c0c0b(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_rcqvls_a1a0c0d0b(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
