...
public class typeof_Node_InsertNewPrevSiblingOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1203712014834", true), (SNode) _quotation_createNode_nhxdir_a1a0c0a0b(SLinkOperations.getTarget(op, MetaAdapterFactory.getReferenceLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x10a2d494062L, 0x10a2d494065L, "concept"))), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return AUX_nhxdir.Node_InsertNewPrevSiblingOperation_bd9d7cb4;
  }
  ...
  private static final class AUX_nhxdir {
