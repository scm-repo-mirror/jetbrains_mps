...
public class typeof_Node_PointerOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
            ...
            if (coercedNode_gixyfg_a0d0 != null) {
              {
                ...
                typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "5312793114533519567", true), (SNode) _quotation_createNode_91gkjb_a1a2a0a1a0a0a0b0a1a3a1(SLinkOperations.getTarget(coercedNode_gixyfg_a0d0, MetaAdapterFactory.getReferenceLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x108f968b3caL, 0x1090e46ca51L, "concept"))), _info_12389875345);
              }
            } else {
              {
                SNode _nodeToCheck_1029348928467 = op;
                ...
                typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "5312793114533519575", true), (SNode) _quotation_createNode_91gkjb_a1a2a0a0b0a0a0a1a0b0d0b(), _info_12389875345);
              }
            }
          }
        }
  ...
  private static SNode _quotation_createNode_91gkjb_a1a2a0a1a0a0a0b0a1a3a1(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode _quotation_createNode_91gkjb_a1a2a0a0b0a0a0a1a0b0d0b() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, "jetbrains.mps.lang.smodel"), 0x66b228a4fad6b29eL, "SNodePointerType"), null, null, false);
    return quotedNode_1;
