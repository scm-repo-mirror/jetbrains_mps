...
public class typeof_SNodeCreator_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode creator, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode createdType = SLinkOperations.getTarget(creator, LINKS.createdType$EjOY);
    if (createdType != null) {
      if (SLinkOperations.getTarget(createdType, LINKS.concept$HWFQ) == null) {
        {
      ...
      if (SLinkOperations.getTarget(creator, LINKS.prototypeNode$_hnx) != null) {
        {
          SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(creator, LINKS.prototypeNode$_hnx);
  ...
  private static SNode _quotation_createNode_tty23h_a1a0c0a0b0b0b() {
