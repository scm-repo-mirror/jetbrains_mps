...
public class CreateFirstDeclaration_ext_2 extends TransformationMenuBase {
  ...
  public class TMP_Group_zaql19_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected boolean isApplicable(TransformationMenuContext _context) {
      return ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.linkDeclaration$YU1f)).where((it) -> SEnumOperations.isMember(SPropertyOperations.getEnum(it, PROPS.metaClass$PeKc), 0xfc6f4e95b9L)).isEmpty();
    }
    ...
    private class TMP_Param_zaql19_b0a extends ParameterizedMenuPart<SNode, TransformationMenuItem, TransformationMenuContext> {
      /*package*/ TMP_Param_zaql19_b0a() {
        super(new EditorMenuDescriptorBase("parameterized transformation menu part", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065533")));
      }
      @NotNull
      @Override
