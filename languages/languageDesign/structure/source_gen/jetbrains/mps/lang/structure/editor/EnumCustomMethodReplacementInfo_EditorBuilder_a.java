...
/*package*/ class EnumCustomMethodReplacementInfo_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.kind$Pl$D;
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.enum$Pl_B;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.enum$Pl_B);
    }
    Style style = new StyleImpl();
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createReferencePresentation_0() {
      EditorCell_Property editorCell = EditorCell_RefPresentation.create(getEditorContext(), myNode, myReferencingNode, IReferentPresentationProvider.getDefaultPresentation(LINKS.enum$Pl_B));
