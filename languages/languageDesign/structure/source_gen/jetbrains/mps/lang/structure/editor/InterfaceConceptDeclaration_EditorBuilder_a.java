...
/*package*/ class InterfaceConceptDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class extendsListHandler_7v1nzk_b2a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(extendsListHandler_7v1nzk_b2a0.this.getNode(), LINKS.extends$V2F7));
      try {
  ...
  private static class propertyDeclarationListHandler_7v1nzk_c1c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(propertyDeclarationListHandler_7v1nzk_c1c0.this.getNode(), LINKS.propertyDeclaration$yMqt));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_6() {
      ...
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.InterfaceConceptDeclaration$MT, "jetbrains.mps.lang.structure.editor.InterfaceConceptDeclaration_ApplySideTransforms_2"));
      editorCell.setDefaultText("<< ... >>");
  ...
  private static class linkDeclarationListHandler_7v1nzk_f1c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(linkDeclarationListHandler_7v1nzk_f1c0.this.getNode(), LINKS.linkDeclaration$yMbs));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_9() {
      ...
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.InterfaceConceptDeclaration$MT, "jetbrains.mps.lang.structure.editor.InterfaceConceptDeclaration_ApplySideTransforms_1"));
      editorCell.setDefaultText("<< ... >>");
      editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell));
      return editorCell;
    }
  ...
  private static class linkDeclarationListHandler_7v1nzk_i1c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(linkDeclarationListHandler_7v1nzk_i1c0.this.getNode(), LINKS.linkDeclaration$yMbs));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_12() {
      ...
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.InterfaceConceptDeclaration$MT, "jetbrains.mps.lang.structure.editor.InterfaceConceptDeclaration_ApplySideTransforms"));
      editorCell.setDefaultText("<< ... >>");
      editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell));
      return editorCell;
    }
