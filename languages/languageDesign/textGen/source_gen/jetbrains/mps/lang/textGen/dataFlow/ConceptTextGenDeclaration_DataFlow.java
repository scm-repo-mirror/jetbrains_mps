...
public class ConceptTextGenDeclaration_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    ...
    _context.getBuilder().emitRead(SLinkOperations.getTarget(_context.getNode(), LINKS.conceptDeclaration$V5r6), "r:812dd537-4bc6-4b23-8ff0-eed686398e8b(jetbrains.mps.lang.textGen.dataFlow)/1237483501065");
    _context.getBuilder().build((SNode) SLinkOperations.getTarget(_context.getNode(), LINKS.textGenBlock$5Aoi));
  }
