...
public class OperationCall_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    _context.getBuilder().emitRead(SLinkOperations.getTarget(_context.getNode(), LINKS.function$yXj1), "r:812dd537-4bc6-4b23-8ff0-eed686398e8b(jetbrains.mps.lang.textGen.dataFlow)/1234274923805");
    for (SNode parameter : SLinkOperations.getChildren(_context.getNode(), LINKS.parameter$Qu0D)) {
