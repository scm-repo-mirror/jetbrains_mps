...
/*package*/ class UtilityMethodDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new returnTypeSingleRoleHandler_4607in_d0(myNode, LINKS.returnType$qrVw, getEditorContext());
  ...
  public static class UtilityMethodDeclaration_name_postfixCellMenu_4607in_a0e0 extends AbstractCellMenuPart_PropertyPostfixHints {
    ...
    public List<String> getPostfixes(SNode node, IOperationContext operationContext, EditorContext editorContext) {
      List<String> result;
      SNode nodeType = SLinkOperations.getTarget(node, LINKS.returnType$qrVw);
      if (nodeType != null) {
  ...
  private static class parameterListHandler_4607in_g0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_4607in_g0.this.getNode(), LINKS.parameter$qsax));
      try {
