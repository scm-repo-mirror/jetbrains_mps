...
public final class MeetType__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_kwev0x.MeetType_789ba16c;
  ...
  /*package*/ static SNode eraseGenerics_id4qyz6djw13y(@NotNull SNode __thisNode__) {
    ...
    for (SNode arg : ListSequence.fromList(SLinkOperations.getChildren(copy, MetaAdapterFactory.getContainmentLink(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x114b68ad132L, 0x114b68b040bL, "argument"))).toListSequence()) {
      if (SNodeOperations.isInstanceOf(arg, AUX_kwev0x.IGenericType_d5d80471)) {
        SNodeOperations.replaceWithAnother(arg, IGenericType__BehaviorDescriptor.eraseGenerics_id4qyz6djw13y.invoke(SNodeOperations.cast(arg, AUX_kwev0x.IGenericType_d5d80471)));
      }
    }
    return copy;
  }
  ...
  private static final class AUX_kwev0x {
