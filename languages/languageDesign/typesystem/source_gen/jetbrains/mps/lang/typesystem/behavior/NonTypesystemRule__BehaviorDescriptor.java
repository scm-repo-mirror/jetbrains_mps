...
public final class NonTypesystemRule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static void setBaseConcept_id5r_35Ihc58c(@NotNull SNode __thisNode__, SNode baseConcept) {
    ...
    SPropertyOperations.set(__thisNode__, PROPS.name$tAp1, "check_" + SPropertyOperations.getString(baseConcept, PROPS.name$tAp1));
  }
  ...
  /*package*/ static Iterable<SNode> findSuperRules_id21kJG8Hh$W9(@NotNull SNode __thisNode__) {
    SNode applicableConcept = ApplicableNodeCondition__BehaviorDescriptor.getApplicableConcept_idhEwIszL.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.applicableNode$lCke));
