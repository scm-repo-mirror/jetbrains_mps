...
public final class QuickFixSetSelectionBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_5kpea6.QuickFixSetSelectionBlock_87dc2c0e;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_5kpea6.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_5kpea6.ConceptFunctionParameter_Selection_7ed12452);
    ListSequence.fromList(result).addElement(AUX_5kpea6.ConceptFunctionParameter_EditorContext_87dc9209);
    ListSequence.fromList(result).addElement(AUX_5kpea6.ConceptFunctionParameter_node_55bbf709);
    return result;
  }
  ...
  /*package*/ QuickFixSetSelectionBlock__BehaviorDescriptor() {
  }
  ...
  private static final class AUX_5kpea6 {
    /*package*/ static final SConcept QuickFixSetSelectionBlock_87dc2c0e = MetaAdapterFactory.getConcept(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x335fe1d0b7494a6dL, "jetbrains.mps.lang.typesystem.structure.QuickFixSetSelectionBlock");
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_Selection_7ed12452 = MetaAdapterFactory.getConcept(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x611e7dc14a69a014L, "jetbrains.mps.lang.typesystem.structure.ConceptFunctionParameter_Selection");
    /*package*/ static final SConcept ConceptFunctionParameter_EditorContext_87dc9209 = MetaAdapterFactory.getConcept(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x335fe1d0b7494cfcL, "jetbrains.mps.lang.typesystem.structure.ConceptFunctionParameter_EditorContext");
    /*package*/ static final SConcept ConceptFunctionParameter_node_55bbf709 = MetaAdapterFactory.getConcept(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x11b3618c300L, "jetbrains.mps.lang.typesystem.structure.ConceptFunctionParameter_node");
  }
}
