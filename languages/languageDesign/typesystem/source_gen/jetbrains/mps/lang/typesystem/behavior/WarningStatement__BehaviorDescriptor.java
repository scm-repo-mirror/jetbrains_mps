...
public final class WarningStatement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static void attachNewMessageAnnotation_id7nf9pEwlup1(@NotNull SNode __thisNode__) {
    SNode newAnnotation = SNodeFactoryOperations.createNewNode(CONCEPTS.WarningStatementAnnotation$xf, null);
  ...
  /*package*/ static String getName_id1oFBbRehoLP(@NotNull SNode __thisNode__) {
    if ((AttributeOperations.getAttribute(__thisNode__, new IAttributeDescriptor.NodeAttribute(CONCEPTS.MessageStatementAnnotation$sq)) != null)) {
      ...
      String nameGenerated = MessageStatementUtil.generateNameFromExpression(SLinkOperations.getTarget(__thisNode__, LINKS.warningText$PGng));
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept WarningStatementAnnotation$xf = MetaAdapterFactory.getConcept(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x6ee9803e48223f34L, "jetbrains.mps.lang.typesystem.structure.WarningStatementAnnotation");
