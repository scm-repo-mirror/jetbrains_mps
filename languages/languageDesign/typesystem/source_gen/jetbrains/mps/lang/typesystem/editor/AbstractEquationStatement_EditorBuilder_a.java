...
/*package*/ class AbstractEquationStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftExpressionSingleRoleHandler_ie6eqd_a0(myNode, LINKS.leftExpression$U_o$, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightExpressionSingleRoleHandler_ie6eqd_c0(myNode, LINKS.rightExpression$U_B_, getEditorContext());
    return provider.createCell();
  }
