...
/*package*/ class JoinType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class argumentListHandler_biwp50_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argumentListHandler_biwp50_c0.this.getNode(), LINKS.argument$xIHX));
      try {
