...
/*package*/ class TypeVarReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.typeVarDeclaration$770K;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.typeVarDeclaration$770K);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.typeVarDeclaration$770K);
    }
