...
/*package*/ class TypeVarReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.typeVarDeclaration$IgIU;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.typeVarDeclaration$IgIU);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.typeVarDeclaration$IgIU);
    }
