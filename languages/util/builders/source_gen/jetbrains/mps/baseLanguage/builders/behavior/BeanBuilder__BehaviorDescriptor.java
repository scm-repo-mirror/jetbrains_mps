...
public final class BeanBuilder__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode getCreatorExpression_id67LR$5LQRIR(@NotNull SNode __thisNode__, SNode parentRef) {
    return _quotation_createNode_ef9w03_a0a0(SLinkOperations.getChildren(__thisNode__, LINKS.actualArgument$$A7L), SLinkOperations.getTarget(__thisNode__, LINKS.baseMethodDeclaration$$A7i));
  }
  /*package*/ static SNode getResultType_id67LR$5LQPoF(@NotNull SNode __thisNode__) {
    return _quotation_createNode_ef9w03_a0a1(SNodeOperations.cast(SNodeOperations.getParent(SLinkOperations.getTarget(__thisNode__, LINKS.baseMethodDeclaration$$A7i)), CONCEPTS.ClassConcept$IY));
  }
  ...
  private static SNode _quotation_createNode_ef9w03_a0a0(Object parameter_1, Object parameter_2) {
    ...
    SNodeAccessUtil.setReferenceTarget(quotedNode_4, LINKS.baseMethodDeclaration$$A7i, (SNode) parameter_2);
    {
      List<SNode> nodes = (List<SNode>) parameter_1;
      for (SNode child : nodes) {
        quotedNode_4.addChild(LINKS.actualArgument$$A7L, SNodeOperations.copyIfNecessary(child));
      }
    }
