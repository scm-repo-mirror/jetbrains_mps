...
/*package*/ class SimpleBuilderChild_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.child$UKGw;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.child$UKGw);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new attachStatementSingleRoleHandler_tobbik_b3a(myNode, LINKS.attachStatement$LJYT, getEditorContext());
  ...
  private static class attachStatementSingleRoleHandler_tobbik_b3a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.attachStatement$LJYT, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.attachStatement$LJYT, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.attachStatement$LJYT);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
      style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.attachStatement$LJYT));
      try {
