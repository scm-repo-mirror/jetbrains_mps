...
/*package*/ class SimpleBuilderChild_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.child$XL3w;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.child$XL3w);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new attachStatementSingleRoleHandler_tobbik_b3a(myNode, LINKS.attachStatement$VqkB, getEditorContext());
  ...
  private static class attachStatementSingleRoleHandler_tobbik_b3a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.attachStatement$VqkB, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.attachStatement$VqkB, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.attachStatement$VqkB);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
      style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.attachStatement$VqkB));
      try {
