...
/*package*/ class SimpleBuilderExtensionDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.extended$Z_z2;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.extended$Z_z2);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.extended$Z_z2);
    }
  ...
  private static class childListHandler_lhunxw_e0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(childListHandler_lhunxw_e0.this.getNode(), LINKS.child$Z_50));
      try {
  ...
  private static class propertyListHandler_lhunxw_f0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(propertyListHandler_lhunxw_f0.this.getNode(), LINKS.property$Z_k1));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink child$Z_50 = MetaAdapterFactory.getContainmentLink(0x132aa4d8a3f7441cL, 0xa7eb3fce23492c6aL, 0x56cd40dfa78dcaf3L, 0x56cd40dfa78dcaf4L, "child");
