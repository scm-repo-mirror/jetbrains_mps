...
/*package*/ class SimpleBuilder_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_jpvk41_a1a() {
    return ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(myNode, LINKS.declaration$oxEw), LINKS.parameter$zrwh)).isNotEmpty();
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.declaration$oxEw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.declaration$oxEw);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.declaration$oxEw);
    }
  ...
  private static class argumentListHandler_jpvk41_b1a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argumentListHandler_jpvk41_b1a.this.getNode(), LINKS.argument$6P3U));
      try {
