...
public class typeof_SimpleBuilderParentExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode expression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode builder = BaseSimpleBuilderDeclaration__BehaviorDescriptor.getContextDeclaration_id5rdgdYBzN9n.invoke(SNodeOperations.getNodeAncestor(expression, AUX_lh2s21.BaseSimpleBuilderDeclaration_c6b4a6bc, false, false));
    {
  ...
  public SAbstractConcept getApplicableConcept() {
    return AUX_lh2s21.SimpleBuilderParentExpression_56efbc40;
  }
  ...
  private static final class AUX_lh2s21 {
    ...
    /*package*/ static final SConcept SimpleBuilderParentExpression_56efbc40 = MetaAdapterFactory.getConcept(0x132aa4d8a3f7441cL, 0xa7eb3fce23492c6aL, 0x6524536b2e1d353cL, "jetbrains.mps.baseLanguage.builders.structure.SimpleBuilderParentExpression");
  }
}
