...
public class typeof_SimpleBuilderPropertyValue_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode value, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode prop = SNodeOperations.getNodeAncestor(value, CONCEPTS.SimpleBuilderProperty$zv, true, false);
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:35ef73a5-9726-4c66-9d79-f51c95cc08d6(jetbrains.mps.baseLanguage.builders.typesystem)", "5389689214217316344", true), (SNode) SLinkOperations.getTarget(prop, LINKS.type$E5IN), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.SimpleBuilderPropertyValue$MI;
  }
