...
/*package*/ class Header_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new elementsListHandler_tbyzlb_b0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_elements");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_SIZE, _StyleParameter_QueryFunction_tbyzlb_a0b0());
    editorCell.getStyle().putAll(style);
    Line_Actions.setCellActions(editorCell, myNode, getEditorContext());
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class elementsListHandler_tbyzlb_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public elementsListHandler_tbyzlb_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(elementsListHandler_tbyzlb_b0.this.getNode(), LINKS.elements$_j45));
      try {
    ...
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_tbyzlb_a1a");
