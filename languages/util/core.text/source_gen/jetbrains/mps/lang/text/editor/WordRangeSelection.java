...
public class WordRangeSelection extends AbstractMultipleSelection {
  private static final Logger LOG = LogManager.getLogger(WordRangeSelection.class);
  ...
  private void selectNext(final EditorContext editorContext, final SelectionManager selectionManager) {
    editorContext.getRepository().getModelAccess().executeCommand(new EditorCommand(editorContext) {
      @Override
      public void doExecute() {
        LoggingRuntime.logMsgView(Level.WARN, "AAAAAAAAAA", WordRangeSelection.class, null, null);
        if (!(myGrowingForward)) {
          LoggingRuntime.logMsgView(Level.WARN, "BBBBBBBB", WordRangeSelection.class, null, null);
          ...
          LoggingRuntime.logMsgView(Level.WARN, "CCCCCCCCCC", WordRangeSelection.class, null, null);
