...
public class LocalExtendedMethodCall_Constraints extends BaseConstraintsDescriptor {
  public LocalExtendedMethodCall_Constraints() {
    super(AUX_rxyf25.LocalExtendedMethodCall_f9dbee25);
  }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            if (SNodeOperations.getNodeAncestor(_context.getContextNode(), AUX_rxyf25.StaticMethodDeclaration_9cd8c445, false, false) != null) {
              return ListScope.forResolvableElements(result);
            }
            SNode classifier = ExtensionMethodDeclaration__BehaviorDescriptor.getClassifier_id6EBM_lhz9HU.invoke(SNodeOperations.getNodeAncestor(_context.getContextNode(), AUX_rxyf25.ExtensionMethodDeclaration_9924fbf7, false, false));
            if (classifier == null) {
              return ListScope.forResolvableElements(result);
            }
            ...
            while (classifier != null) {
              ...
              classifier = SNodeOperations.getNodeAncestor(classifier, AUX_rxyf25.Classifier_4b7e553, false, false);
            }
            return ListScope.forResolvableElements(result);
          }
        };
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return SNodeOperations.getNodeAncestor(parentNode, AUX_rxyf25.ExtensionMethodDeclaration_9924fbf7, true, false) != null;
  }
  ...
  private static final class AUX_rxyf25 {
