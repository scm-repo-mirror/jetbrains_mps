...
/*package*/ class ExtensionMethodCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.extension$LeHP);
    ...
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfoSmartReferenceDecorator(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.ExtensionMethodDeclaration$9b)));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink extension$LeHP = MetaAdapterFactory.getReferenceLink(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x1583d1b63359483bL, 0x1583d1b63359483cL, "extension");
  }
