...
/*package*/ class PredefinedSymbolClassSymbolClassPart_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.declaration$SIgd;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.declaration$SIgd);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.declaration$SIgd);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        final SProperty property = PROPS.description$g2Cc;
