...
/*package*/ class Regexps_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class regexpListHandler_fnjk3l_d0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.regexp$b2sx;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.RegexpDeclaration$6D;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(regexpListHandler_fnjk3l_d0.this.getNode(), LINKS.regexp$b2sx));
      try {
