...
/*package*/ class Regexps_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class regexpListHandler_fnjk3l_d0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.regexp$n$NH;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.RegexpDeclaration$tP;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(regexpListHandler_fnjk3l_d0.this.getNode(), LINKS.regexp$n$NH));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink regexp$n$NH = MetaAdapterFactory.getContainmentLink(0xdaafa647f1f74b0bL, 0xb09669cd7c8408c0L, 0x1117f550b6dL, 0x1117f554ef2L, "regexp");
  }
}
