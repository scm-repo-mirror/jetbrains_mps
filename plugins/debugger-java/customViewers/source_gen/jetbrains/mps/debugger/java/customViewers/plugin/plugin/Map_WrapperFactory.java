...
@GeneratedClass(node = "r:9d33947d-45a8-4aa4-b61a-9c874e4614d7(jetbrains.mps.debugger.java.customViewers.plugin.plugin)/2929731761237869354", model = "r:9d33947d-45a8-4aa4-b61a-9c874e4614d7(jetbrains.mps.debugger.java.customViewers.plugin.plugin)")
public class Map_WrapperFactory extends ValueWrapperFactory {
  ...
  public static class MapWrapper extends ValueWrapper {
    ...
    protected List<CustomJavaWatchable> getSubvaluesImpl(IObjectValueProxy value) throws EvaluationException {
      ...
      IObjectValueProxy entries = ((IObjectValueProxy) ((IObjectValueProxy) value).invokeMethod("entrySet", "()Ljava/util/Set;", getThreadReference()));
