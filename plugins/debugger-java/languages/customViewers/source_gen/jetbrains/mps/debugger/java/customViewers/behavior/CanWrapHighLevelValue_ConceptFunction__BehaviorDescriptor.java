...
public final class CanWrapHighLevelValue_ConceptFunction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_gutg7p.CanWrapHighLevelValue_ConceptFunction_602f12fc;
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    List<SConcept> result = ConceptFunction__BehaviorDescriptor.getParameterConcepts_id2xELmDxyi2v.invoke0(__thisNode__, AUX_gutg7p.ConceptFunction_e08795a5);
    ListSequence.fromList(result).addElement(AUX_gutg7p.HighLevelValue_ConceptFunctionParameter_61c6cc19);
    return result;
  }
  ...
  /*package*/ CanWrapHighLevelValue_ConceptFunction__BehaviorDescriptor() {
  }
  ...
  private static final class AUX_gutg7p {
    /*package*/ static final SConcept CanWrapHighLevelValue_ConceptFunction_602f12fc = MetaAdapterFactory.getConcept(0xfa8aeae94df94e13L, 0xbfb19b04c67ddb77L, 0x9a1514043ecbdbL, "jetbrains.mps.debugger.java.customViewers.structure.CanWrapHighLevelValue_ConceptFunction");
