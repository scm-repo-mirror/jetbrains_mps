...
/*package*/ class EvaluatorsSuperMethodCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.instanceMethodDeclaration$KyhO);
  ...
  private static class actualArgumentListHandler_2iixvv_f0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualArgumentListHandler_2iixvv_f0.this.getNode(), LINKS.actualArgument$$A7L));
      try {
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink instanceMethodDeclaration$KyhO = MetaAdapterFactory.getReferenceLink(0x7da4580f9d754603L, 0x816251a896d78375L, 0x53c5060c6b1ae1feL, 0x53c5060c6b1ae83bL, "instanceMethodDeclaration");
