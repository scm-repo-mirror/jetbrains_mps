...
public class PrivateInstanceMethodCallOperation_Constraints extends BaseConstraintsDescriptor {
  public PrivateInstanceMethodCallOperation_Constraints() {
    super(AUX_8iqmcz.PrivateInstanceMethodCallOperation_8b64e8e);
  }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            if (!(SNodeOperations.isInstanceOf(enclosingNode, AUX_8iqmcz.DotExpression_97ed08d8))) {
              return new EmptyScope();
            }
            SNode instance = SLinkOperations.getTarget(SNodeOperations.as(enclosingNode, AUX_8iqmcz.DotExpression_97ed08d8), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, 0x116b46a4416L, "operand"));

            final SNode classifierType = TypecheckingFacade.getFromContext().strongCoerceType(TypecheckingFacade.getFromContext().getTypeOf(instance), AUX_8iqmcz.ClassifierType_42700403);
            ...
            Iterable<SNode> privateMethods = (Iterable<SNode>) Sequence.fromIterable(IClassifierType__BehaviorDescriptor.getMembers_id6r77ob2V1Fr.invoke(classifierType)).where(new IWhereFilter<SNode>() {
              public boolean accept(SNode it) {
                return SNodeOperations.isInstanceOf(it, AUX_8iqmcz.InstanceMethodDeclaration_9dbf9b2b);
              }
  ...
  private static final class AUX_8iqmcz {
