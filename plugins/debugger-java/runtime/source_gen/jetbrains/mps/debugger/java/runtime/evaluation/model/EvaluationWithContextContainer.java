...
public class EvaluationWithContextContainer extends EvaluationContainer {
  ...
  public static List<String> getDebuggerStubPath() {
    ...
    ListSequence.fromList(paths).addSequence(
        ListSequence.fromList(
            getClassPath(((IdeaPluginDescriptorImpl) PluginManager.getPlugin(apiPlugin)).getPath())
        )
    );
    ListSequence.fromList(paths).addSequence(
        ListSequence.fromList(
            getClassPath(((IdeaPluginDescriptorImpl) PluginManager.getPlugin(javaPlugin)).getPath())
        )
    );
  ...
  private static @NotNull List<File> getClassPath(Path path) {
