...
/*package*/ class EditorExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.persistentPropertyDeclaration$9Zvw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.persistentPropertyDeclaration$9Zvw);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.persistentPropertyDeclaration$9Zvw);
    }
