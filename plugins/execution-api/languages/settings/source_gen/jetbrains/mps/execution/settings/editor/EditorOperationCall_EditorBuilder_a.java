...
/*package*/ class EditorOperationCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.editorOperationDeclaration$1mIR;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.editorOperationDeclaration$1mIR);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.editorOperationDeclaration$1mIR);
    }
  ...
  private static class argumentsListHandler_jn1wx6_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argumentsListHandler_jn1wx6_c0.this.getNode(), LINKS.arguments$1mgP));
      try {
