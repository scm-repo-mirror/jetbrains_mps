...
/*package*/ class PersistentConfigurationTemplateInitializer_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_e5b6m9_a0a() {
    return (SLinkOperations.getTarget(myNode, LINKS.template$YCBl) == null) || (new IAttributeDescriptor.NodeAttribute(CONCEPTS.DeprecatedAnnotation$xW).get(SLinkOperations.getTarget(myNode, LINKS.template$YCBl)) == null);
  }
  private boolean nodeCondition_e5b6m9_a1a() {
    return (SLinkOperations.getTarget(myNode, LINKS.template$YCBl) != null) && (new IAttributeDescriptor.NodeAttribute(CONCEPTS.DeprecatedAnnotation$xW).get(SLinkOperations.getTarget(myNode, LINKS.template$YCBl)) != null);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.template$YCBl;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.template$YCBl);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.template$YCBl);
    }
  ...
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.template$YCBl);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_notnull_smartReference(cell);
        return cell;
  ...
  private static class parameterListHandler_e5b6m9_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_e5b6m9_d0.this.getNode(), LINKS.parameter$YCQm));
      try {
