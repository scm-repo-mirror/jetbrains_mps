...
/*package*/ class PersistentConfigurationTemplate_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class templateParameterListHandler_85j21_d0a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.templateParameter$9XoQ;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(templateParameterListHandler_85j21_d0a.this.getNode(), LINKS.templateParameter$9XoQ));
      try {
