...
public class PersistentConfigurationType_Contribution extends SubstituteMenuBase {
  public PersistentConfigurationType_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Type", new SNodePointer("r:328ff5ee-9330-4068-906e-6e3bb50e6e1d(jetbrains.mps.execution.settings.editor)", "1741258697586930409")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_67nl4b_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    private class SMP_Param_67nl4b_a0 extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
      /*package*/ SMP_Param_67nl4b_a0() {
        super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:328ff5ee-9330-4068-906e-6e3bb50e6e1d(jetbrains.mps.execution.settings.editor)", "1741258697586930447")));
      }
      @NotNull
      @Override
      ...
      protected Iterable<? extends SNode> getParameters(SubstituteMenuContext _context) {
        return ListSequence.fromList(SModelOperations.rootsIncludingImported(_context.getModel(), CONCEPTS.PersistentConfigurationTemplate$li)).where((it) -> (new IAttributeDescriptor.NodeAttribute(CONCEPTS.DeprecatedAnnotation$xW).get(it) == null)).toList();
      }
      private class SMP_Action_67nl4b_a0a extends SingleItemSubstituteMenuPart {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          /*package*/ void resetTraceInfo() {
            ...
            updateTraceInfo(description, new SNodePointer("r:328ff5ee-9330-4068-906e-6e3bb50e6e1d(jetbrains.mps.execution.settings.editor)", "1741258697586930497"));
          }
