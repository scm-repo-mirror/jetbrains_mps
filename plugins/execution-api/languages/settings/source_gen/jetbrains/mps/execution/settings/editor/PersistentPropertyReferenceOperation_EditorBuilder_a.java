...
/*package*/ class PersistentPropertyReferenceOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.variableDeclaration$9R10;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.variableDeclaration$9R10);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.variableDeclaration$9R10);
    }
