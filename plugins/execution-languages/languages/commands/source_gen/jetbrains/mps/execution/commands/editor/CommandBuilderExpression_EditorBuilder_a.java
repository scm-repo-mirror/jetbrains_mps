...
/*package*/ class CommandBuilderExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.commandPart$vwzX;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.commandPart$vwzX);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.commandPart$vwzX);
    }
  ...
  private static class argumentListHandler_lo57cy_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argumentListHandler_lo57cy_c0.this.getNode(), LINKS.argument$npCw));
      try {
