...
public class check_BuildMpsLayout_TestModules_haltonfailure_option_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode options, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if ((SLinkOperations.getTarget(options, LINKS.haltonfailure$573F) != null) && !((boolean) BuildMps_TestModules_Options__BehaviorDescriptor.isBooleanOptionValueOk_id51DD0tdKxuK.invoke(options, BuildString__BehaviorDescriptor.getText_id3NagsOfTioI.invoke(SLinkOperations.getTarget(options, LINKS.haltonfailure$573F), null)))) {
      {
        final MessageTarget errorTarget = new NodeMessageTarget();
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(SLinkOperations.getTarget(options, LINKS.haltonfailure$573F), "Inappropriate value for 'haltonfailure' property", "r:f8814f89-9801-40d6-822f-e0e0a3a2c53d(jetbrains.mps.build.mps.tests.typesystem)", "5794342746865161859", null, errorTarget);
      }
    }
  }
