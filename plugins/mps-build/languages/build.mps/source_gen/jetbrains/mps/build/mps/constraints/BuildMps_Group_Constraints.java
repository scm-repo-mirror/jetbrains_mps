...
public class BuildMps_Group_Constraints extends BaseConstraintsDescriptor {
  public BuildMps_Group_Constraints() {
    super(AUX_s54c64.BuildMps_Group_9a78986e);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    ...
    SNode buildProject = SNodeOperations.getNodeAncestor(parentNode, AUX_s54c64.BuildProject_808bb057, true, false);
    if ((buildProject != null)) {
      // limit use of this concept in a project with MPS plugin 
      return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(buildProject, MetaAdapterFactory.getContainmentLink(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x4df58c6f18f84a13L, 0x5c3f3e2c1ce9ac70L, "plugins")), AUX_s54c64.BuildMPSPlugin_88f067e)).isNotEmpty();
    }
  ...
  private static final class AUX_s54c64 {
