...
public class BuildMps_IdeaPluginGroup_Constraints extends BaseConstraintsDescriptor {
  public BuildMps_IdeaPluginGroup_Constraints() {
    super(AUX_h6r07b.BuildMps_IdeaPluginGroup_d3614963);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(MetaAdapterFactory.getReferenceLink(0xcf935df46994e9cL, 0xa132fa109541cba3L, 0x5b7be37b4deb1201L, 0x5b7be37b4deb1202L, "group"), this) {
      @Override
        ...
        return new BaseScopeProvider() {
          ...
          public String getPresentation(final IOperationContext operationContext, final ReferencePresentationContext _context) {
            if (SNodeOperations.getContainingRoot(_context.getParameterNode()) != SNodeOperations.getContainingRoot(_context.getContextNode())) {
              SNode proj = SNodeOperations.as(SNodeOperations.getContainingRoot(_context.getParameterNode()), AUX_h6r07b.BuildProject_808bb057);
              if (proj != null) {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            Scope scope = Scope.getScope(_context.getContextNode(), _context.getContainmentLink(), _context.getPosition(), AUX_h6r07b.BuildMps_Group_9a78986e);
  ...
  private static final class AUX_h6r07b {
