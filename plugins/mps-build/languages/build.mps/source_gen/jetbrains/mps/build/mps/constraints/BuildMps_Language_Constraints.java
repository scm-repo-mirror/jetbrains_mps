...
public class BuildMps_Language_Constraints extends BaseConstraintsDescriptor {
  public BuildMps_Language_Constraints() {
    super(AUX_l7hddi.BuildMps_Language_41959b14);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    ...
    SNode buildProject = SNodeOperations.getNodeAncestor(parentNode, AUX_l7hddi.BuildProject_808bb057, true, false);
    if ((buildProject != null)) {
      // limit use of this concept in a project with MPS plugin 
      return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(buildProject, MetaAdapterFactory.getContainmentLink(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x4df58c6f18f84a13L, 0x5c3f3e2c1ce9ac70L, "plugins")), AUX_l7hddi.BuildMPSPlugin_88f067e)).isNotEmpty();
    }
  ...
  private static final class AUX_l7hddi {
