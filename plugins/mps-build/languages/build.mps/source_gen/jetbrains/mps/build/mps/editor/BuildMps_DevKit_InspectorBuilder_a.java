...
/*package*/ class BuildMps_DevKit_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_pa0pfb_0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_pa0pfb_1");
  ...
  private EditorCell createCollection_2() {
    ...
    editorCell.setCellId("Collection_pa0pfb_2");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_pa0pfb_0");
    Style style = new StyleImpl();
  ...
  private EditorCell createCollection_3() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_pa0pfb_3");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_pa0pfb_1");
    Style style = new StyleImpl();
    new keywordStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new extendsListHandler_pa0pfb_b1a0(myNode, getEditorContext());
  ...
  private static class extendsListHandler_pa0pfb_b1a0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.extends$b9fB;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BuildMps_DevKitRef$iR;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(extendsListHandler_pa0pfb_b1a0.this.getNode(), LINKS.extends$b9fB));
      try {
    ...
    private EditorCell createConstant_2() {
      ...
      editorCell.setCellId("Constant_pa0pfb_2");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_pa0pfb_3");
    Style style = new StyleImpl();
    new keywordStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new exportsListHandler_pa0pfb_d1a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class exportsListHandler_pa0pfb_d1a0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.exports$90Bp;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BuildMps_DevKitExport$xp;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(exportsListHandler_pa0pfb_d1a0.this.getNode(), LINKS.exports$90Bp));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_4() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_pa0pfb_4");
      Style style = new StyleImpl();
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept BuildMps_DevKitExport$xp = MetaAdapterFactory.getConcept(0xcf935df46994e9cL, 0xa132fa109541cba3L, 0x4780308f5d23143L, "jetbrains.mps.build.mps.structure.BuildMps_DevKitExport");
  }
