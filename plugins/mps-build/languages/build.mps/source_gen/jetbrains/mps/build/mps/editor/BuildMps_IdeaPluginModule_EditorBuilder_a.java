...
/*package*/ class BuildMps_IdeaPluginModule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_37ht8c_a1a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.customPackaging$31Ex);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$ccfo;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.target$ccfo);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.target$ccfo);
    }
