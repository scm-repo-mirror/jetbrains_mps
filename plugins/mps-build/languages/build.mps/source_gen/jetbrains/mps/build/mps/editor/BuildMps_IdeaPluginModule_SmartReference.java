...
public class BuildMps_IdeaPluginModule_SmartReference extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_wbo7rb_a(), CONCEPTS.BuildMps_IdeaPluginModule$rY));
    return result;
  }
  ...
  public class SMP_ReferenceScope_wbo7rb_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_wbo7rb_a() {
      ...
      super((SAbstractConcept) CONCEPTS.BuildMps_IdeaPluginModule$rY, LINKS.target$ccfo);
    }
    @NotNull
    @Override
