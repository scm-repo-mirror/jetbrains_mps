...
/*package*/ class BuildMps_Language_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createComponent_0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_BuildProjectPart_cellMenu_ucemm3_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new pathSingleRoleHandler_ucemm3_b3a(myNode, LINKS.path$g7Oh, getEditorContext());
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new sourcesListHandler_ucemm3_b4a(myNode, getEditorContext());
  ...
  private static class sourcesListHandler_ucemm3_b4a extends RefNodeListHandler {
    ...
    public sourcesListHandler_ucemm3_b4a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sourcesListHandler_ucemm3_b4a.this.getNode(), LINKS.sources$Pqd_));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new dependenciesListHandler_ucemm3_d4a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class dependenciesListHandler_ucemm3_d4a extends RefNodeListHandler {
    ...
    public dependenciesListHandler_ucemm3_d4a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(dependenciesListHandler_ucemm3_d4a.this.getNode(), LINKS.dependencies$Pit_));
      try {
        EditorCell emptyCell = null;
  ...
  private EditorCell createRefNodeList_2() {
    AbstractCellListHandler handler = new runtimeListHandler_ucemm3_f4a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class runtimeListHandler_ucemm3_f4a extends RefNodeListHandler {
    ...
    public runtimeListHandler_ucemm3_f4a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.runtime$RrxF;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BuildMps_ModuleRuntime$qr;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(runtimeListHandler_ucemm3_f4a.this.getNode(), LINKS.runtime$RrxF));
      try {
        EditorCell emptyCell = null;
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept BuildMps_ModuleRuntime$qr = MetaAdapterFactory.getConcept(0xcf935df46994e9cL, 0xa132fa109541cba3L, 0x2c446791464389f7L, "jetbrains.mps.build.mps.structure.BuildMps_ModuleRuntime");
  }
