...
/*package*/ class BuildMps_ModuleDependencyOnModule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_2jl94m_a1a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.reexport$PAD5);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.module$PvPC;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.module$PvPC);
    }
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.BuildMps_ModuleDependencyOnModule$_g, "jetbrains.mps.build.mps.editor.add_reexport"));
