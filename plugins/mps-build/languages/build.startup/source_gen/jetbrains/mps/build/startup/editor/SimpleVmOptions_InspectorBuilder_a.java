...
/*package*/ class SimpleVmOptions_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setDefaultText("<no commented>");
      editorCell.setCellId("property_commented");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_9jgmwo.PropertyAttribute_d001db89);
  ...
  private static final class AUX_9jgmwo {
