...
/*package*/ class BwfPathDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class contentListHandler_onntkk_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentListHandler_onntkk_c0.this.getNode(), LINKS.content$vnjn));
      try {
