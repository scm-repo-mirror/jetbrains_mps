...
public class add_dependencies_BwfSubTask_ext_3 extends TransformationMenuBase {
  ...
  public class TMP_Group_cfx569_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new TMP_Group_cfx569_a0.TMP_Action_cfx569_a0a());
    }
    private class TMP_Action_cfx569_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        TMP_Group_cfx569_a0.TMP_Action_cfx569_a0a.Item item = new TMP_Group_cfx569_a0.TMP_Action_cfx569_a0a.Item(context);
        String description;
        try {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), MetaAdapterFactory.getContainmentLink(0x698a8d22a10447a0L, 0xba8d10e3ec237f13L, 0x2670d5989d5a6275L, 0x36fb0dc9fd36bb1bL, "before"))).addElement(SModelOperations.createNewNode(_context.getModel(), null, AUX_cfx569.BwfSubTaskDependency_ea416a83));
  ...
  private static final class AUX_cfx569 {
