...
public final class BuildNamedLayout__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_dtgkor.BuildNamedLayout_8f437f39;
  ...
  /*package*/ static void appendName_id1bWeed$ownT(@NotNull SNode __thisNode__, SNode parent, StringBuilder sb) {
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), AUX_dtgkor.BuildProject_808bb057)) {
      sb.append(SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), AUX_dtgkor.BuildProject_808bb057), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")));
      sb.append(".");
    }
  ...
  private static final class AUX_dtgkor {
