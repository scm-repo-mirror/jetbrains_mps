...
/*package*/ class BuildLayout_ExportAsJavaLibrary_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public static class ReplaceWith_BuildLayout_AbstractContainer_cellMenu_ge4r0w_a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    ...
    public SAbstractConcept getReplacementConcept() {
      return CONCEPTS.BuildLayout_AbstractContainer$zG;
    }
    @Override
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.library$Ok95;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.library$Ok95);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.library$Ok95);
    }
    Style style = new StyleImpl();
