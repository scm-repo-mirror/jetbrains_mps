...
/*package*/ class BuildLayout_containerElements_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_hdw7mg_a1a() {
    return !(SNodeOperations.isInstanceOf(ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.children$aiMf)).last(), CONCEPTS.BuildLayout_AbstractContainer$19));
  }
  ...
  private static class childrenListHandler_hdw7mg_a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(childrenListHandler_hdw7mg_a0.this.getNode(), LINKS.children$aiMf));
      try {
