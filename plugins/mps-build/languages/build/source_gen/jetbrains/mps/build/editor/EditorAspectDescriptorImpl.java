...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  private static final String[] stringSwitchCases_xbvbvu_a0a0a0a1a5 = new String[]{"jetbrains.mps.build.editor.add_DependencyLocation"};
  private static final String[] stringSwitchCases_xbvbvu_a0a0a0b1a5 = new String[]{"jetbrains.mps.build.editor.add_reexport_BuildSourcePath", "jetbrains.mps.build.editor.transform_CompositePath_BuildSourcePath"};
  private static final String[] stringSwitchCases_xbvbvu_a0a0a0a1a7 = new String[]{"jetbrains.mps.build.editor.BuildSource_JavaExternalJarFolderRef_SmartReference"};
  private static final String[] stringSwitchCases_xbvbvu_a0a0a0b1a7 = new String[]{"jetbrains.mps.build.editor.BuildSource_JavaExternalJarRef_SmartReference"};
}
