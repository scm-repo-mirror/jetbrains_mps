...
/*package*/ class GeneratorInternal_BuildSource_JavaModule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_zc1akc_a1a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.targetReexport$HbdZ);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.targetModule$Hbdw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.targetModule$Hbdw);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.targetModule$Hbdw);
    }
