...
SET BITS=64
SET USER_JDK64_FILE=%USERPROFILE%\.MPS2020.2\config\mps%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%USERPROFILE%\.MPS2020.2\config\mps%BITS%.exe.jdk
...
IF NOT EXIST "%VM_OPTIONS_FILE%" (
  :: user-overridden
  SET VM_OPTIONS_FILE=%USERPROFILE%\.MPS2020.2\config\mps%BITS%.exe.vmoptions
)
IF NOT EXIST "%VM_OPTIONS_FILE%" (
