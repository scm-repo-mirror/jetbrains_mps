...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/rhino.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/kotlinx-coroutines-slf4j-1.10.1-intellij.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.aalto.xml.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.asm.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.caffeine.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.cglib.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.fastutil.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.gson.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.guava.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.hash4j.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.icu4j.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.ion.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jackson.databind.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jackson.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jackson.jr.objects.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jackson.module.kotlin.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlin.reflect.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.coroutines.slf4j.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.io.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.serialization.core.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.serialization.json.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.ktor.client.cio.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.ktor.client.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.ktor.io.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.ktor.network.tls.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.ktor.utils.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.lz4.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.miglayout.swing.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.mvstore.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.proxy.vole.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.rhino.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.winp.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.xerces.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.xz.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.debugger.impl.rpc.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.debugger.impl.shared.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.eel.impl.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.find.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.managed.cache.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.polySymbols.backend.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.polySymbols.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.rpc.topics.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.scopes.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.vcs.core.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.vcs.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.platform.vcs.shared.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.regexp.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.analysis.impl.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.analysis.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.dom.impl.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.dom.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.impl.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.parser.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.psi.impl.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.psi.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.structureView.impl.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.structureView.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.syntax.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.xml.ui.common.jar"
