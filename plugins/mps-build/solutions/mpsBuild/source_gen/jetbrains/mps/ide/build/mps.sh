...
CLASSPATH="$IDE_HOME/lib/3rd-party-native.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/intellij-coverage-agent-1.0.682.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/tools-testsBootstrap.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/util.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/util_rt.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/xml-dom-impl.jar"
