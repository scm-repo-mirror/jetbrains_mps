...
CLASSPATH="$IDE_HOME/lib/3rd-party-rt.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/annotations.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/app.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/asm-9.2.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/asm-analysis-9.2.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/asm-commons-9.2.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/asm-tree-9.2.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/asm-util-9.2.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/branding.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/byte-buddy-agent.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/dom-impl.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/grpc-netty-shaded.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/idea_rt.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/intellij-coverage-agent-1.0.673.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/jffi-1.3.9-native.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/jffi-1.3.9.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/jna.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/jnr-a64asm-1.0.0.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/jnr-ffi-2.2.12.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/jnr-x86asm-1.0.2.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/jps-model.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/junit4.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/kotlin-compiler-client-embeddable-1.7.0.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/kotlinx-metadata-jvm-0.4.2.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/lz4-java.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/mps-logging.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/mps-messaging.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/platform-objectSerializer-annotations.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/platform-statistics-devkit.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/protobuf.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/pty4j.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/rd-core.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/rd-framework.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/rd-swing.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/rd-text.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/stats.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/testFramework.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/tests_bootstrap.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/util.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/util_rt.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/winp.jar"
