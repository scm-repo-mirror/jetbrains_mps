...
/*package*/ class OfAspectOperation_old_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.requestedAspect_old$dPGU;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.requestedAspect_old$dPGU);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.requestedAspect_old$dPGU);
    }
