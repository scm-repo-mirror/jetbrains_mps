...
/*package*/ class XMLSAXAttributeRule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_z5ltoj_a0a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isRequired$ho0w);
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new handlerSingleRoleHandler_z5ltoj_d0(myNode, LINKS.handler$hofx, getEditorContext());
  ...
  private static class handlerSingleRoleHandler_z5ltoj_d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.handler$hofx, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.handler$hofx, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.handler$hofx);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.handler$hofx));
      try {
