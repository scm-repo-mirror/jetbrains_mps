...
public final class XmlText__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = AUX_b9lriq.XmlText_49cf0e78;
  ...
  /*package*/ static boolean onNewLine_id1Qs9WekVZ9$(@NotNull SNode __thisNode__) {
    ...
    if (SNodeOperations.isInstanceOf(left, AUX_b9lriq.XmlContent_5d5001c3)) {
      SNode leftContent = SNodeOperations.cast(left, AUX_b9lriq.XmlContent_5d5001c3);
  ...
  private static final class AUX_b9lriq {
