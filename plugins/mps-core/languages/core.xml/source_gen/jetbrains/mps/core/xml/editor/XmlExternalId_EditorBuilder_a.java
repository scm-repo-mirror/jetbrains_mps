...
/*package*/ class XmlExternalId_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new XmlExternalId_component_cellMenu_dsthrr_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_7aiyyv.PropertyAttribute_d001db89);
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new XmlExternalId_component_cellMenu_dsthrr_a0a0a(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private static final class AUX_7aiyyv {
