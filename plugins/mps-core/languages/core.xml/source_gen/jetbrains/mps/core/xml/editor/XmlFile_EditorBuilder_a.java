...
/*package*/ class XmlFile_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.fileExtension$l9Ay;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new documentSingleRoleHandler_zencf0_f0(myNode, LINKS.document$xlg0, getEditorContext());
