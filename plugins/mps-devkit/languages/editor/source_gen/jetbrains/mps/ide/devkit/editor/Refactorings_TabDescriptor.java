...
public class Refactorings_TabDescriptor extends RelationDescriptor {
  ...
  public Iterable<SConcept> getAspectConcepts(final SNode node) {
    LanguageAspectDescriptor ad = LanguageAspectSupport.getAspectDescriptorById("refactorings");
  ...
  protected SNode doCreateAspect(final CreateAspectContext _context) {
    ...
    SModel am = SModuleOperations.getAspect(lang, "refactorings");
    if (am == null) {
      LanguageAspectDescriptor ad = LanguageAspectSupport.getAspectDescriptorById("refactorings");
      ...
      if (ad != null && ad.canCreate(cac)) {
        ad.create(cac);
        am = SModuleOperations.getAspect(lang, "refactorings");
      }
    }
    if (am == null) {
      return null;
