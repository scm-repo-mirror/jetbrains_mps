...
public class EditorMenuTrace_Tool extends BaseTabbedTool {
  ...
  public void showEditorMenuTraceInfo(@Nullable EditorMenuTraceInfo info) {
    if (info != null) {
      EditorMenuTraceTab tab = new EditorMenuTraceTab((BaseTabbedTool) ((Object) EditorMenuTrace_Tool.this), EditorMenuTrace_Tool.this.myProject.getComponent(MPSProject.class));
