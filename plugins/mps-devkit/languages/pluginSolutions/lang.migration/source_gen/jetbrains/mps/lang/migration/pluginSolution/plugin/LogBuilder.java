...
public class LogBuilder {
  private static final Logger LOG = Logger.getLogger(LogBuilder.class);
  ...
  public void addPart(RefactoringParticipant.PersistentRefactoringParticipant participant, SNode initialState, SNode finalState) {
    ListSequence.fromList(SLinkOperations.getChildren(myRefactoringStep, LINKS.part$cm5i)).addElement(createRefactoringPart_1o8b1n_a0a0a4(participant.getId(), initialState, finalState));
  }
  ...
  private static SNode createRefactoringLog_1o8b1n_a0h0d(int p0, String p1) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.RefactoringLog$xp);
    n0.setProperty(PROPS.virtualPackage$EkXl, "refactoring");
    n0.setProperty(PROPS.fromVersion$clQh, "" + (p0));
    n0.setProperty(PROPS.name$MnvL, p1);
    return n0.getResult();
  }
  private static SNode createRefactoringPart_1o8b1n_a0a0a4(String p0, SNode p1, SNode p2) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.RefactoringPart$lO);
    n0.setProperty(PROPS.participant$1LmE, p0);
    n0.forChild(LINKS.initialState$1LOG).initNode(p1, CONCEPTS.BaseConcept$gP, true);
    n0.forChild(LINKS.finalState$1MiI).initNode(p2, CONCEPTS.BaseConcept$gP, true);
    return n0.getResult();
  }
  private static SNode createRefactoringOption_1o8b1n_a0a0a0a1a6(String p0, String p1) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.RefactoringOption$3c);
    n0.setProperty(PROPS.optionId$l6wK, p0);
    n0.setProperty(PROPS.description$GF4B, p1);
    return n0.getResult();
  }
