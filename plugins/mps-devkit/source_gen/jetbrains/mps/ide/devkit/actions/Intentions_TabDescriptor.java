...
public class Intentions_TabDescriptor extends RelationDescriptor {
  ...
  public boolean isApplicable(SNode node) {
    return SNodeOperations.isInstanceOf(node, AUX_jwwqxi.AbstractConceptDeclaration_ec74828f);
  }
  @Nullable
  public Icon getIcon() {
    return ICON;
  ...
  public List<SNode> getNodes(SNode node) {
    ...
    return Sequence.fromIterable(((Iterable<SNode>) BHReflection.invoke0(node, AUX_jwwqxi.AbstractConceptDeclaration_ec74828f, SMethodTrimmedId.create("findConceptAspects", AUX_jwwqxi.AbstractConceptDeclaration_ec74828f, "4G9PD8$NvPM"), aspectModel))).toListSequence();
  }
  ...
  private static final class AUX_jwwqxi {
