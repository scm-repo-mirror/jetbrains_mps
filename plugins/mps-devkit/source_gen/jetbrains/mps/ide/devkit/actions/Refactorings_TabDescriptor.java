...
public class Refactorings_TabDescriptor extends RelationDescriptor {
  ...
  public boolean isApplicable(SNode node) {
    return SNodeOperations.isInstanceOf(node, AUX_p1zg4c.AbstractConceptDeclaration_ec74828f);
  }
  @Nullable
  public Icon getIcon() {
    return ICON;
  ...
  public List<SNode> getNodes(SNode node) {
    ...
    return Sequence.fromIterable(((Iterable<SNode>) BHReflection.invoke0(node, AUX_p1zg4c.AbstractConceptDeclaration_ec74828f, SMethodTrimmedId.create("findConceptAspects", AUX_p1zg4c.AbstractConceptDeclaration_ec74828f, "4G9PD8$NvPM"), aspectModel))).toListSequence();
  }
  ...
  private static final class AUX_p1zg4c {
