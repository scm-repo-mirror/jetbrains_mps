...
/*package*/ class AttributedFigureReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.figureAttribute$3FRC;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.figureAttribute$3FRC);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.figureAttribute$3FRC);
    }
    ...
    private EditorCell createReadOnlyModelAccessor_0() {
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
        public String getText() {
          return SPropertyOperations.getString(FigureAttribute__BehaviorDescriptor.getFigureClass_id4H19mAwT6pg.invoke(myNode), PROPS.name$lA7v);
        }
      }, myNode);
