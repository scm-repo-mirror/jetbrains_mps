...
/*package*/ class AttributedFigureReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.figureAttribute$Fuko;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.figureAttribute$Fuko);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.figureAttribute$Fuko);
    }
    ...
    private EditorCell createReadOnlyModelAccessor_0() {
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor() {
        public String getText() {
          return SPropertyOperations.getString(FigureAttribute__BehaviorDescriptor.getFigureClass_id4H19mAwT6pg.invoke(myNode), PROPS.name$tAp1);
        }
