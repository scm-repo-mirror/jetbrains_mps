...
public class typeof_DiagramElementBLQuery_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:40b64a44-89c9-404d-9824-6c98cb8ca353(jetbrains.mps.lang.editor.diagram.typesystem)", "1301388602725203466", true), (SNode) _quotation_createNode_pjqjxq_a1a0c0a0b0b(), true, true, _info_12389875345);
      }
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.DiagramElementBLQuery$LG;
  }
  ...
  private static SNode _quotation_createNode_pjqjxq_a1a0c0a0b0b() {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept DiagramElementBLQuery$LG = MetaAdapterFactory.getConcept(0x6106f6117a7442d1L, 0x80deedc5c602bfd1L, 0x4a53d4fb31aaee31L, "jetbrains.mps.lang.editor.diagram.structure.DiagramElementBLQuery");
  }
}
