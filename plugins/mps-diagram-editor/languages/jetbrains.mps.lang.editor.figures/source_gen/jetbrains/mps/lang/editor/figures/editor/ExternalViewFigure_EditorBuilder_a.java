...
/*package*/ class ExternalViewFigure_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.classifier$YFfM;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.classifier$YFfM);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.classifier$YFfM);
    }
  ...
  private static class fieldsListHandler_jnzu2k_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(fieldsListHandler_jnzu2k_d0.this.getNode(), LINKS.fields$1RAp));
      try {
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink fields$1RAp = MetaAdapterFactory.getContainmentLink(0xd7722d504b934c3aL, 0xae061903d05f95a7L, 0x1e3b9cbb9f7493c2L, 0x1e3b9cbb9f749440L, "fields");
  }
