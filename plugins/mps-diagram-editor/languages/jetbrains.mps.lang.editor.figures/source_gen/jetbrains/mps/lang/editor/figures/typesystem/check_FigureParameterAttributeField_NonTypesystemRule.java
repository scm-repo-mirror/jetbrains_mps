...
public class check_FigureParameterAttributeField_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode fieldAttribute, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (!(Utils.isSupportedParameterType(FigureParameter__BehaviorDescriptor.getParameterType_idiZqVFYvBew.invoke(fieldAttribute), SNodeOperations.getNode("67b3c41d-58b3-4756-b971-30bf8a9d63e6/java:jetbrains.jetpad.model.property(jetbrains.jetpad/)", "~Property")))) {
      {
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.FigureParameterAttributeField$KP;
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept FigureParameterAttributeField$KP = MetaAdapterFactory.getConcept(0xd7722d504b934c3aL, 0xae061903d05f95a7L, 0x1ceea85e3fd59976L, "jetbrains.mps.lang.editor.figures.structure.FigureParameterAttributeField");
  }
}
