...
/*package*/ class Diagram2_DiagramTestTextual_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new mainNodesListHandler_b472j3_c2a(myNode, getEditorContext());
  ...
  private static class mainNodesListHandler_b472j3_c2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.mainNodes$OehA;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Node$SU;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(mainNodesListHandler_b472j3_c2a.this.getNode(), LINKS.mainNodes$OehA));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new nodeConnectorsListHandler_b472j3_g2a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class nodeConnectorsListHandler_b472j3_g2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.nodeConnectors$mCYE;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.OutputToInputPortConnector$i_;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(nodeConnectorsListHandler_b472j3_g2a.this.getNode(), LINKS.nodeConnectors$mCYE));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
