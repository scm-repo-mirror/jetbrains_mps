...
/*package*/ class NodeWithPortQueries_DiagramTestTextual_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_4() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.lineWidth$p7H2;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private static class inputsListHandler_com5ge_s2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(inputsListHandler_com5ge_s2a.this.getNode(), LINKS.inputs$79d3));
      try {
  ...
  private static class outputsListHandler_com5ge_w2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(outputsListHandler_com5ge_w2a.this.getNode(), LINKS.outputs$79F$));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
