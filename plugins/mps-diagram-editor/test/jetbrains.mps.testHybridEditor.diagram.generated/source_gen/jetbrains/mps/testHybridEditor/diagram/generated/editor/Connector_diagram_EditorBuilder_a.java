...
/*package*/ class Connector_diagram_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Connector_diagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramConnector_0() {
    final ConnectorCell editorCell = new ConnectorCellImpl_a4xffp_a(getEditorContext(), myNode);
  ...
  public class ConnectorCellImpl_a4xffp_a extends ConnectorCell {
    ...
    public void synchronize() {
      myInputPort.set(MultiTuple.<SNode>from(SLinkOperations.getTarget(getSNode(), LINKS.inputPort$zoXt)));
      myOutputPort.set(MultiTuple.<SNode>from(SLinkOperations.getTarget(getSNode(), LINKS.outputPort$zo1p)));
    }
