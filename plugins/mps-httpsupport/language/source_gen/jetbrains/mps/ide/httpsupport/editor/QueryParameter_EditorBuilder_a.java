...
/*package*/ class QueryParameter_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_o17mi1.PropertyAttribute_d001db89);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new parameterConverterSingleRoleHandler_pp9zo5_c0(myNode, MetaAdapterFactory.getContainmentLink(0x817e4e70961e4a95L, 0x98a115e9f32231f1L, 0x205f4376c585b439L, 0x46f064803fbfba0fL, "parameterConverter"), getEditorContext());
