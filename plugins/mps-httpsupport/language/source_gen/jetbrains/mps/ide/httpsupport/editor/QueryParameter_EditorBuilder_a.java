...
/*package*/ class QueryParameter_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_pp9zo5_a3a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.required$QJGS);
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new parameterConverterSingleRoleHandler_pp9zo5_c0(myNode, LINKS.parameterConverter$VsXK, getEditorContext());
  ...
  private static class parameterConverterSingleRoleHandler_pp9zo5_c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.parameterConverter$VsXK, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.parameterConverter$VsXK, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.parameterConverter$VsXK);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.parameterConverter$VsXK));
      try {
