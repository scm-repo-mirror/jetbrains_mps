...
import jetbrains.mps.ide.script.migrationtool.ResultsListener;
...
public abstract class MigrationScriptsView implements ResultsListener {
  ...
  private MigrationScriptsTool_Tool myTool;
  ...
  private void checkMigrationResults() {
    ...
    ProgressManager.getInstance().run(new Task.Modal(myProject.getProject(), "Searching", true) {
      ...
      public void run(@NotNull final ProgressIndicator indicator) {
        ...
        int newCount = results.value.getSearchResults2().size();
        if (newCount > 0) {
