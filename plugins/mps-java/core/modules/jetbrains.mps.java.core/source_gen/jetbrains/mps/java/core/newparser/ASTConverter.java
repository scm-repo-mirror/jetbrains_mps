...
public class ASTConverter {
  ...
  public SNode convertAnnotation(Annotation anno) throws JavaParseException {
    ...
    for (MemberValuePair pair : anno.memberValuePairs()) {
      ...
      val.setReference(LINKS.key$wMU9, ResolveInfo.of(new String(pair.name)));
  ...
  public SNode buildClassifierType(String typ, TypeReference typRef) {
    ...
    cls.setReference(LINKS.classifier$xslD, ResolveInfo.of(typ));
  ...
  public SNode buildAnnotationInstance(String name) {
    ...
    anno.setReference(LINKS.annotation$lXdy, ResolveInfo.of(name));
    return anno;
  }
  ...
  protected static class State {
    ...
    protected SNode resolveTypeVar(String name) {
      ...
      if (myTypeVars == null || !(MapSequence.fromMap(myTypeVars).containsKey(name))) {
        ...
        if (typeVar != null) {
          SLinkOperations.setTarget(typeVarRef, LINKS.typeVariableDeclaration$6t$W, typeVar);
        } else {
          typeVarRef.setReference(LINKS.typeVariableDeclaration$6t$W, ResolveInfo.of(name));
        }
