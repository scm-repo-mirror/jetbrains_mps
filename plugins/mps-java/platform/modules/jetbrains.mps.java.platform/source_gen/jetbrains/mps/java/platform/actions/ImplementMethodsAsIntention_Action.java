...
public class ImplementMethodsAsIntention_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    SNode classifier = SNodeOperations.getNodeAncestor(((SNode) MapSequence.fromMap(_params).get("selectedNode")), AUX_19i29h.Classifier_4b7e553, true, false);
    if (SNodeOperations.isInstanceOf(classifier, AUX_19i29h.EnumClass_acf68fc0)) {
      SNode enumConstant = SNodeOperations.getNodeAncestor(((SNode) MapSequence.fromMap(_params).get("selectedNode")), AUX_19i29h.EnumConstantDeclaration_b06144d8, true, false);
      if ((enumConstant != null)) {
        return !(((EditorContext) MapSequence.fromMap(_params).get("editorContext")).isInspector()) && ListSequence.fromList(((List<SNode>) BHReflection.invoke0(enumConstant, AUX_19i29h.IMemberContainer_166f7222, SMethodTrimmedId.create("getMethodsToImplement", null, "4GM03FJm5q2")))).isNotEmpty();
      }
    }
    return !(((EditorContext) MapSequence.fromMap(_params).get("editorContext")).isInspector()) && (classifier != null) && ListSequence.fromList(((List<SNode>) BHReflection.invoke0(classifier, AUX_19i29h.IMemberContainer_166f7222, SMethodTrimmedId.create("getMethodsToImplement", null, "4GM03FJm5q2")))).isNotEmpty();
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    final boolean isInEnumConstant = new ModelAccessHelper(((MPSProject) MapSequence.fromMap(_params).get("project")).getModelAccess()).runReadAction(new Computable<Boolean>() {
      public Boolean compute() {
        return (SNodeOperations.getNodeAncestor(((SNode) MapSequence.fromMap(_params).get("selectedNode")), AUX_19i29h.EnumConstantDeclaration_b06144d8, true, false) != null);
      }
    });
    if (isInEnumConstant) {
  ...
  private static final class AUX_19i29h {
