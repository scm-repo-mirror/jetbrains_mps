...
@GeneratedClass(node = "r:c6bc30d1-d0d1-44c6-ba7e-90e78619615e(jetbrains.mps.java.platform.actions)/8838506468326707812", model = "r:c6bc30d1-d0d1-44c6-ba7e-90e78619615e(jetbrains.mps.java.platform.actions)")
public class ImplementMethodsAsIntention_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ...
    return !(((EditorContext) MapSequence.fromMap(_params).get("editorContext")).isInspector()) && (classifier != null) && ListSequence.fromList(((List<SNode>) BHReflection.invoke0(classifier, CONCEPTS.IMemberContainer$60, SMethodTrimmedId.create("getMethodsToImplement", null, "4GM03FJm5q2")))).isNotEmpty();
