...
@GeneratedClass(nodeId = "2872212824181502686", model = "r:c6bc30d1-d0d1-44c6-ba7e-90e78619615e(jetbrains.mps.java.platform.actions)")
public class PasteAsJavaStatements_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ...
    return (SNodeOperations.getNodeAncestor(((SNode) ((SNode) MapSequence.fromMap(_params).get("anchorNode"))), CONCEPTS.StatementList$m_, true, false) != null) && JavaPaster.isStringOnlyDataAvailableInClipboard();
  }
  @Override
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    pm.runProcessWithProgressSynchronously(() -> {
      ...
      monitor.start(IdeBundle.message("actions.pasteAsJavaStatements.progressTitle"), 5);
      try {
    ...
    }, IdeBundle.message("actions.pasteAsJavaStatements.progressTitle"), false, ideaProject);
  }
