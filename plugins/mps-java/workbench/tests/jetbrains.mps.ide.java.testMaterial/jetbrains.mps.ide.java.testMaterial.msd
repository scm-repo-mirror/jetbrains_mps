...
<solution name="jetbrains.mps.ide.java.testMaterial" uuid="49166c31-952a-46f6-8970-ea45964379d0" moduleVersion="0" generatorOutputPath="${module}/resources/testData">
  <compileInIDEA />
  <models>
