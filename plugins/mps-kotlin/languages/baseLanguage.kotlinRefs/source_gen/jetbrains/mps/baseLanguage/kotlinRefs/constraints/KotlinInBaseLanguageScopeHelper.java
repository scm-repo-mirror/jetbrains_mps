...
public class KotlinInBaseLanguageScopeHelper {
  public static class AccessorFilter extends SignatureFilter {
    ...
    public boolean accept(MemberSignature signature, SNode source) {
      return ((PropertyAccessorSignature) signature).getKind() == myKind;
    }
  }
  ...
  public static Scope getScopeForMember(SNode referenceNode, SNode contextNode, SAbstractConcept filteringConcept, SignatureFilter signatureFilter) {
    ...
    ClassMemberVisitor visitor = new ClassMemberVisitor(signatureFilter, repository);
