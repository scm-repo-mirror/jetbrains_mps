...
public class KotlinInBaseLanguageScopeHelper {
  /*package*/ static class AccessorFilter extends SignatureFilter<PropertyAccessorSignature> {
    private final PropertyAccessorKind myKind;
    public AccessorFilter(PropertyAccessorKind kind) {
      super(PropertyAccessorSignature.class);
      myKind = kind;
    }
    @Override
    protected boolean accept(PropertyAccessorSignature signature, SNode source) {
      return signature.getKind() == myKind;
    }
  }

  public static Scope getScopeForAccessor(SNode referenceNode, SNode contextNode, PropertyAccessorKind kind) {
  ...
  public static Scope getScopeForMember(SNode referenceNode, SNode contextNode, SAbstractConcept filteringConcept, SignatureFilter<? extends MemberSignature> signatureFilter) {
    ...
    ClassMemberVisitor visitor = new ClassMemberVisitor(signatureFilter);
