...
import jetbrains.mps.kotlin.editor.INullableType_Delete;
import org.jetbrains.mps.openapi.language.SContainmentLink;
import jetbrains.mps.smodel.adapter.structure.MetaAdapterFactory;
import org.jetbrains.mps.openapi.language.SConcept;
import org.jetbrains.mps.openapi.language.SInterfaceConcept;

/*package*/ class JavaClassType_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public JavaClassType_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ghbim6_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createRefCell_0());
    if (nodeCondition_ghbim6_a1a()) {
      editorCell.addEditorCell(createComponent_0());
    }
    if (nodeCondition_ghbim6_a2a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_ghbim6_a1a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.typeProjections$vhti)).isNotEmpty();
  }
  private boolean nodeCondition_ghbim6_a2a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isNullable$KWwD);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.javaClass$CQOW;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.javaClass$CQOW);
    ...
    provider.setNoTargetText("<no javaClass>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.javaClass$CQOW);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new ReplaceWith_IType_cellMenu_ghbim6_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class ReplaceWith_IType_cellMenu_ghbim6_a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_IType_cellMenu_ghbim6_a0a0() {
    }
    ...
    protected EditorMenuDescriptor createEditorMenuDescriptor(CellContext cellContext, EditorContext editorContext) {
      return new EditorMenuDescriptorBase("replace node (custom node concept: " + "IType" + ")", new SNodePointer("r:12420812-a86a-4269-8305-60120c560ef6(jetbrains.mps.kotlin.javaRefs.editor)", "1752885245461417100"));
    }
  }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ghbim6_c0");
