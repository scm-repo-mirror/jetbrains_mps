...
/*package*/ class JavaTypeVariableReferenceType_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public JavaTypeVariableReferenceType_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_u7m3kv_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createRefCell_0());
    if (nodeCondition_u7m3kv_a1a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_u7m3kv_a1a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isNullable$KWwD);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.typeVariable$LHQO;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.typeVariable$LHQO);
    ...
    provider.setNoTargetText("<no typeVariable>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.typeVariable$LHQO);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_u7m3kv_b0");
    Style style = new StyleImpl();
