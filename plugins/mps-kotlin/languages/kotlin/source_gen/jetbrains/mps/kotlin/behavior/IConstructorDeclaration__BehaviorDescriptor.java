...
public final class IConstructorDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode getClass_id4vugIDehkCF(@NotNull SNode __thisNode__) {
    // Not to mix with getConstructedClass! This one give the class of the constructor as an instance function in case the constructed class is a nested one
  ...
  /*package*/ static SConcept getDefaultVisibility_id2WVyZr43qIN(@NotNull SNode __thisNode__) {
    SNode constructedClass = IConstructorDeclaration__BehaviorDescriptor.getConstructedClass_id7WpE6U5evQG.invoke(__thisNode__);

    // Other cases: inherit class visibility
    if (!(Objects.equals(constructedClass, __thisNode__)) && (constructedClass != null)) {
      // Overridden visibility from that given class
      SConcept defaultConstructorVisibility = IClassLike__BehaviorDescriptor.getConstructorDefaultVisibility_idu1nygduECM.invoke(constructedClass);
      if (defaultConstructorVisibility != null) {
        return defaultConstructorVisibility;
      }

      return IVisible__BehaviorDescriptor.getVisibility_id2WVyZr44ojH.invoke(constructedClass);
    }

    // Fallback to default behavior
    return IVisible__BehaviorDescriptor.getDefaultVisibility_id2WVyZr43qIN.invokeSuper(__thisNode__, CONCEPTS.IConstructorDeclaration$rR);
  }
