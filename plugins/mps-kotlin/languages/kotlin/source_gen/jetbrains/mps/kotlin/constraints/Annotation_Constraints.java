      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final ReferenceConstraintsContext _context) {
            return new FilteringScope(ConstructorScope.create(_context.getContextNode())) {
              @Override
              public boolean isExcluded(SNode node) {
                // Only annotation class
                return !((boolean) IClassLike__BehaviorDescriptor.hasModifier_id2NtWm0y2Y2A.invoke(IConstructorDeclaration__BehaviorDescriptor.getConstructedClass_id7WpE6U5evQG.invoke(SNodeOperations.as(node, CONCEPTS.IConstructorDeclaration$rR)), CONCEPTS.AnnotationClassModifier$vN));
              }
            };
          }
        };
