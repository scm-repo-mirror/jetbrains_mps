...
/*package*/ class BinLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BinLiteral_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_x98wky_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createProperty_0());
    if (nodeCondition_x98wky_a2a()) {
      editorCell.addEditorCell(createConstant_1());
    }
    if (nodeCondition_x98wky_a3a()) {
      editorCell.addEditorCell(createConstant_2());
    }
    return editorCell;
  }
  private boolean nodeCondition_x98wky_a2a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.long$1NZg);
  }
  private boolean nodeCondition_x98wky_a3a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.unsigned$iUpc);
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "0b");
    editorCell.setCellId("Constant_x98wky_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.value$xanU;
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_x98wky_c0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_x98wky_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
