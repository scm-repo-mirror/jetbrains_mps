...
public class BinaryOperator_RemoveFromOperator {
  ...
  /*package*/ static AbstractCellAction createAction_BACKSPACE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNode replacement = ((SLinkOperations.getTarget(node, LINKS.right$yQIM) != null) ? SLinkOperations.getTarget(node, LINKS.right$yQIM) : SLinkOperations.getTarget(node, LINKS.left$yQgK));
        SNode removed = ((SLinkOperations.getTarget(node, LINKS.left$yQgK) != null) ? SLinkOperations.getTarget(node, LINKS.left$yQgK) : SLinkOperations.getTarget(node, LINKS.right$yQIM));
        if (DeletionApproverUtil.approve(editorContext, removed)) {
          return;
        }
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNode replacement = ((SLinkOperations.getTarget(node, LINKS.left$yQgK) != null) ? SLinkOperations.getTarget(node, LINKS.left$yQgK) : SLinkOperations.getTarget(node, LINKS.right$yQIM));
        SNode removed = ((SLinkOperations.getTarget(node, LINKS.right$yQIM) != null) ? SLinkOperations.getTarget(node, LINKS.right$yQIM) : SLinkOperations.getTarget(node, LINKS.left$yQgK));
        if (DeletionApproverUtil.approve(editorContext, removed)) {
          return;
        }

        SNodeOperations.replaceWithAnother(node, replacement);
        SelectionUtil.selectLabelCellAnSetCaret(editorContext, replacement, SelectionManager.FIRST_CELL, -1);
      }
