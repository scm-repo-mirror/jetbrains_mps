...
/*package*/ class ContinueExpression_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ContinueExpression_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_z63gqu_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createConstant_0());
    if (nodeCondition_z63gqu_a1a()) {
      editorCell.addEditorCell(createComponent_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_z63gqu_a1a() {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_z63gqu_a0");
