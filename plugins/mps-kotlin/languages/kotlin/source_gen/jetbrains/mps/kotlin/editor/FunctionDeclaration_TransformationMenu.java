...
public class FunctionDeclaration_TransformationMenu extends TransformationMenuBase {
  ...
  private class TMP_Action_ygp9jm_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      ...
      context.getEditorMenuTrace().pushTraceInfo();
      try {
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1806979145041356421")));
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        SelectionUtil.selectLabelCellAnSetCaret(_context.getEditorContext(), SNodeFactoryOperations.addNewChild(_context.getNode(), LINKS.typeParameters$eq6K, null), SelectionManager.FIRST_EDITABLE_CELL, 0);
      }
