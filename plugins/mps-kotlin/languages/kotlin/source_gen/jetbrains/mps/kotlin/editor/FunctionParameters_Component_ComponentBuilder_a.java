...
/*package*/ class FunctionParameters_Component_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  public FunctionParameters_Component_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ro4pkg_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ro4pkg_a0");
  ...
  private static class parametersListHandler_ro4pkg_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public parametersListHandler_ro4pkg_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.parameters$dfEr;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.FunctionParameter$tR;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parametersListHandler_ro4pkg_b0.this.getNode(), LINKS.parameters$dfEr));
      try {
    ...
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_ro4pkg_a1a");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_ro4pkg_c0");
    Style style = new StyleImpl();
