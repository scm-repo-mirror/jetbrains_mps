...
/*package*/ class PackageHeader_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PackageHeader_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_liagl8_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_liagl8_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.packageName$Mxdm;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, true), myNode);
      editorCell.setDefaultText("<root>");
