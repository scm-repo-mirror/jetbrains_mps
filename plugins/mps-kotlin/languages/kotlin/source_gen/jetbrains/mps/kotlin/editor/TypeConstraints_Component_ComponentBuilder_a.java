...
/*package*/ class TypeConstraints_Component_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TypeConstraints_Component_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private static class constraintsListHandler_r5z3hp_b0a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.constraints$BRhr;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.TypeConstraint$NN;
    }
