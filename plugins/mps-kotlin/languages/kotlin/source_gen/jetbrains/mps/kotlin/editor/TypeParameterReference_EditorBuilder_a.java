...
/*package*/ class TypeParameterReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TypeParameterReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_rj8gug_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createRefCell_0());
    if (nodeCondition_rj8gug_a1a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_rj8gug_a1a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isNullable$KWwD);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.parameter$ofYr;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.parameter$ofYr);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.parameter$ofYr);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_rj8gug_b0");
    Style style = new StyleImpl();
