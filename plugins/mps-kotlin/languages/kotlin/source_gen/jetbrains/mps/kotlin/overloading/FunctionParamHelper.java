...
public class FunctionParamHelper {
  ...
  public static Iterable<Argument> toOrderedList(Iterable<ParameterDeclaration> functionParameters, Iterable<Argument> arguments) throws ParamException {
    ...
    List<Tuples._2<Integer, Argument>> zipped = ListSequence.fromList(new ArrayList<Tuples._2<Integer, Argument>>());
    {
      ...
      while (arg_it.hasNext() && param_it.hasNext()) {
        ...
        ListSequence.fromList(zipped).addElement(MultiTuple.<Integer,Argument>from(ListSequence.fromList(parameters).indexOf(param_var), arg_var));
      }
    }
