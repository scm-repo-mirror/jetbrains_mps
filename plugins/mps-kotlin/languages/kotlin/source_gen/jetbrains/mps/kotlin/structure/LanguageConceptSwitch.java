...
public final class LanguageConceptSwitch {
  ...
  public static final int CompiledStubStatement = 27;
  ...
  public static final int FlexibleBlock = 54;
  public static final int FlippedOverloadedBinaryExpression = 55;
  public static final int ForStatement = 56;
  public static final int FunctionBody = 57;
  public static final int FunctionCallExpression = 58;
  public static final int FunctionCallTarget = 59;
  public static final int FunctionDeclaration = 60;
  public static final int FunctionMemberTarget = 61;
  public static final int FunctionParameter = 62;
  ...
  public static final int IDeclarationHolder = 86;
  public static final int IDeclarationScopePart = 87;
  public static final int IElseExpression = 88;
  public static final int IExpression = 89;
  public static final int IExpressionLike = 90;
  public static final int IFunctionCallLike = 91;
  public static final int IFunctionDeclaration = 92;
  public static final int IFunctionIdentifier = 93;
  public static final int IFunctionMemberTarget = 94;
  public static final int IFunctionModifier = 95;
  public static final int IFunctionParameters = 96;
  public static final int IIdentifier = 97;
  public static final int IInferencePart = 98;
  public static final int IInheritExplicitly = 99;
  public static final int IInheritable = 100;
  public static final int IInheritanceModifier = 101;
  public static final int IInheritanceSpecifier = 102;
  public static final int IKotlinRoot = 103;
  public static final int IKotlinRunnable = 104;
  public static final int ILabelTarget = 105;
  public static final int ILabelled = 106;
  public static final int ILambdaAsArgument = 107;
  public static final int ILambdaParameter = 108;
  public static final int ILeftExpression = 109;
  public static final int IMemberTarget = 110;
  public static final int INavigationTarget = 111;
  public static final int INullableType = 112;
  public static final int IObject = 113;
  public static final int IOverloadableOperator = 114;
  public static final int IParameterModifier = 115;
  public static final int IPlatformModifier = 116;
  public static final int IProjectedTypeArguments = 117;
  public static final int IPropertyAssignment = 118;
  public static final int IRegularFunctionCall = 119;
  public static final int IResolvable = 120;
  public static final int IResolvableReference = 121;
  public static final int IReturnType = 122;
  public static final int ISelfHandledAssignment = 123;
  public static final int IStatement = 124;
  public static final int IStatementHolder = 125;
  public static final int IStatementScopePart = 126;
  public static final int IStaticType = 127;
  public static final int IStringLiteral = 128;
  public static final int IStringLiteralContent = 129;
  public static final int IType = 130;
  public static final int ITypeArguments = 131;
  public static final int ITypeConstrained = 132;
  public static final int ITypeParameterReference = 133;
  public static final int ITypeParameters = 134;
  public static final int ITypeProjection = 135;
  public static final int IVariableDeclarationConstraintHolder = 136;
  public static final int IVariableIdentifier = 137;
  public static final int IVisible = 138;
  public static final int IWhenCondition = 139;
  public static final int IWithClassBody = 140;
  public static final int IWithReceiver = 141;
  public static final int IdentityOperator = 142;
  public static final int IfExpression = 143;
  public static final int ImportHeader = 144;
  public static final int IncOperation = 145;
  public static final int IncompleteDeclaration = 146;
  public static final int IndexOperation = 147;
  public static final int InfixCallOperator = 148;
  public static final int InfixFunctionModifier = 149;
  public static final int InlineFunctionModifier = 150;
  public static final int InnerClassModifier = 151;
  public static final int IntegerLiteral = 152;
  public static final int InterfaceDeclaration = 153;
  public static final int InternalVisibility = 154;
  public static final int IntersectionType = 155;
  public static final int IsOperator = 156;
  public static final int KotlinFile = 157;
  public static final int KtScript = 158;
  public static final int Label = 159;
  public static final int LambdaLiteral = 160;
  public static final int LessEqOperation = 161;
  public static final int LessOperation = 162;
  public static final int LocalPropertyDeclaration = 163;
  public static final int LongLiteral = 164;
  public static final int MemberNavigationOperation = 165;
  public static final int MinusOperation = 166;
  public static final int MultiLambdaParameter = 167;
  public static final int MultiLineStringLiteral = 168;
  public static final int NavigationOperation = 169;
  public static final int NoinlineParameterModifier = 170;
  public static final int NotContainedOperation = 171;
  public static final int NotEqualsOperation = 172;
  public static final int NotOperation = 173;
  public static final int NullLiteral = 174;
  public static final int NullSafeOperation = 175;
  public static final int NumericBaseLiteral = 176;
  public static final int ObjectDeclaration = 177;
  public static final int ObjectLiteral = 178;
  public static final int OpenInheritanceModifier = 179;
  public static final int OperatorFunctionModifier = 180;
  public static final int OverloadedAssignment = 181;
  public static final int OverloadedBinaryExpression = 182;
  public static final int OverloadedPostfixUnaryExpression = 183;
  public static final int OverloadedPrefixUnaryExpression = 184;
  public static final int PackageHeader = 185;
  public static final int ParamUseSiteTarget = 186;
  public static final int Parameter = 187;
  public static final int ParameterWithOptionalType = 188;
  public static final int ParenthesizedExpression = 189;
  public static final int PlusOperation = 190;
  public static final int PostfixDecOperation = 191;
  public static final int PostfixIncOperation = 192;
  public static final int PostfixUnaryExpression = 193;
  public static final int PrefixUnaryExpression = 194;
  public static final int PrimaryConstructor = 195;
  public static final int PrivateVisibility = 196;
  public static final int PropertyDeclaration = 197;
  public static final int PropertyDefaultAssignement = 198;
  public static final int PropertyDelegateAssignement = 199;
  public static final int PropertyGetter = 200;
  public static final int PropertySetter = 201;
  public static final int PropertyUseSiteTarget = 202;
  public static final int ProtectedVisibility = 203;
  public static final int PublicVisibility = 204;
  public static final int RangeToOperation = 205;
  public static final int RealLiteral = 206;
  public static final int ReceiverType = 207;
  public static final int ReceiverUseSiteTarget = 208;
  public static final int RemOperation = 209;
  public static final int ReturnExpression = 210;
  public static final int SealedInheritanceModifier = 211;
  public static final int SecondaryConstructor = 212;
  public static final int SetUseSiteTarget = 213;
  public static final int SetparamUseSiteTarget = 214;
  public static final int StarProjection = 215;
  public static final int StringExpressionEvaluation = 216;
  public static final int StringLiteral = 217;
  public static final int StringLiteralRaw = 218;
  public static final int SuperConstructorDelegationCall = 219;
  public static final int SuperExpression = 220;
  public static final int SuperInterfaceSpecifier = 221;
  public static final int SuspendFunctionModifier = 222;
  public static final int TailRecFunctionModifier = 223;
  public static final int ThisConstructorDelegationCall = 224;
  public static final int ThisExpression = 225;
  public static final int ThrowExpression = 226;
  public static final int TimesOperation = 227;
  public static final int TryExpression = 228;
  public static final int TypeAlias = 229;
  public static final int TypeAliasType = 230;
  public static final int TypeConstraint = 231;
  public static final int TypeParameter = 232;
  public static final int TypeParameterReference = 233;
  public static final int TypePostFixUnaryExpression = 234;
  public static final int TypeProjection = 235;
  public static final int TypeTest = 236;
  public static final int UnaryExpression = 237;
  public static final int UnaryMinusOperation = 238;
  public static final int UnaryPlusOperation = 239;
  public static final int UnresolvedParsedReference = 240;
  public static final int UnsignedLiteral = 241;
  public static final int ValueArgument = 242;
  public static final int VariableDeclaration = 243;
  public static final int VariableRefExpression = 244;
  public static final int VisibilityModifier = 245;
  public static final int WhenEntry = 246;
  public static final int WhenExpression = 247;
  public static final int WhileStatement = 248;
