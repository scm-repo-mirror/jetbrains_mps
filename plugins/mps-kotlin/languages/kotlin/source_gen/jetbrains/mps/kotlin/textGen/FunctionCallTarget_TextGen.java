...
public class FunctionCallTarget_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    KotlinTextGen.reference(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.function$Weyv), false, ctx);
