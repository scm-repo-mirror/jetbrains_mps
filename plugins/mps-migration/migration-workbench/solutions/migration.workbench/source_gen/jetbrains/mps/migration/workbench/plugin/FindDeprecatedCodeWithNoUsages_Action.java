...
@GeneratedClass(node = "r:e303f5e6-4651-4e3c-b105-2f02e438900c(jetbrains.mps.migration.workbench.plugin)/2830027776418026292", model = "r:e303f5e6-4651-4e3c-b105-2f02e438900c(jetbrains.mps.migration.workbench.plugin)")
      ...
      public void run(@NotNull final ProgressIndicator indicator) {
        ...
        event.getData(MPSCommonDataKeys.MPS_PROJECT).getRepository().getModelAccess().runReadAction(new Runnable() {
          public void run() {
            ...
            UsagesFormattingUtil.addResults(searchResults, new Pair(CategoryKind.DEFAULT_CATEGORY_KIND, "Deprecated Entities With No Usages"), dep);
          }
        });
      }
      @Override
