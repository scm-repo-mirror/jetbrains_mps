...
/*package*/ class AssertSame_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expectedSingleRoleHandler_1px6hs_b0(myNode, LINKS.expected$QBis, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new actualSingleRoleHandler_1px6hs_d0(myNode, LINKS.actual$QBxt, getEditorContext());
    return provider.createCell();
  }
