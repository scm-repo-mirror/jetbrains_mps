...
/*package*/ class PressKeyStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new keyStrokesListHandler_pkvqak_b0(myNode, getEditorContext());
  ...
  private static class keyStrokesListHandler_pkvqak_b0 extends RefNodeListHandler {
    ...
    public keyStrokesListHandler_pkvqak_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(keyStrokesListHandler_pkvqak_b0.this.getNode(), LINKS.keyStrokes$GW0n));
      try {
