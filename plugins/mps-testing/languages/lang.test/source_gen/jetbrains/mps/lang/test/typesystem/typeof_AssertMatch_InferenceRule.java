...
public class typeof_AssertMatch_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    for (SNode node : ListSequence.fromList(SLinkOperations.getChildren(nodeToCheck, LINKS.before$knqU))) {
      {
    ...
    for (SNode node : ListSequence.fromList(SLinkOperations.getChildren(nodeToCheck, LINKS.after$4ir))) {
      {
        SNode _nodeToCheck_1029348928467 = node;
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590385(jetbrains.mps.lang.test.typesystem)", "1211982429080", true), (SNode) _quotation_createNode_qwyt5f_a1a0c0a0b0b(), false, true, _info_12389875345);
      }
    }
    {
      Iterator<SNode> nodeBefore_it = ListSequence.fromList(SLinkOperations.getChildren(nodeToCheck, LINKS.before$knqU)).iterator();
      Iterator<SNode> nodeAfter_it = ListSequence.fromList(SLinkOperations.getChildren(nodeToCheck, LINKS.after$4ir)).iterator();
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.AssertMatch$YC;
  }
  ...
  private static SNode _quotation_createNode_qwyt5f_a1a0c0a0a0b() {
  ...
  private static SNode _quotation_createNode_qwyt5f_a1a0c0a0b0b() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, "jetbrains.mps.lang.smodel"), 0x108f968b3caL, "SNodeType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept AssertMatch$YC = MetaAdapterFactory.getConcept(0x8585453e6bfb4d80L, 0x98deb16074f1d86cL, 0x11a2f985130L, "jetbrains.mps.lang.test.structure.AssertMatch");
  }
}
