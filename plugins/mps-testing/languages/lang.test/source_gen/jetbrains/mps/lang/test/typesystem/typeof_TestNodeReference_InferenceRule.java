...
public class typeof_TestNodeReference_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode concept = RulesUtil.closestConceptNode(SNodeOperations.getConcept(SNodeOperations.getParent(SLinkOperations.getTarget(nodeToCheck, LINKS.declaration$hXIv))));
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590385(jetbrains.mps.lang.test.typesystem)", "1210676530830", true), (SNode) _quotation_createNode_4fdfzz_a1a0c0b0b(concept), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_4fdfzz_a1a0c0b0b(Object parameter_1) {
