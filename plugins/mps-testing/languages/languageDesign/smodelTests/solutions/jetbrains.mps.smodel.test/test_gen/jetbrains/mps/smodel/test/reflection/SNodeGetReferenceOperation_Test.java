...
public class SNodeGetReferenceOperation_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_byLinkDeclaration() throws Exception {
      ...
      addNodeById("2906110183022122665");
      addNodeById("2906110183022122679");
      SNode rootLinkDeclaration = SLinkOperations.findLinkDeclaration(LINKS.root$7kX0);
      ...
      Assert.assertEquals(LINKS.root$7kX0, SLinkOperations.getRefLink(rootContainerReference));
      ...
      Assert.assertEquals(SLinkOperations.findLinkDeclaration(LINKS.leftChild$9MQx), SLinkOperations.findLinkDeclaration(leftChildReference));
      Assert.assertEquals(SPropertyOperations.getString(SLinkOperations.findLinkDeclaration(LINKS.leftChild$9MQx), PROPS.role$nkts), check_l3bw6i_a21a4l(SLinkOperations.getRefLink(leftChildReference)));
    ...
    public void test_bySpecializedLinkDeclaration() throws Exception {
      ...
      Assert.assertEquals(SLinkOperations.findLinkDeclaration(LINKS.rightChild$9N5y), SLinkOperations.findLinkDeclaration(refByOriginalLink));
      Assert.assertEquals(SPropertyOperations.getString(SLinkOperations.findLinkDeclaration(LINKS.rightChild$9N5y), PROPS.role$nkts), check_l3bw6i_a6a5l(SLinkOperations.getRefLink(refByOriginalLink)));
    ...
    public void test_forNull() throws Exception {
      ...
      Assert.assertNull(SNodeOperations.getReference(nullReferenceContainer, LINKS.rightChild$9N5y));
    ...
    public void test_invalidLinkDeclaration() throws Exception {
      ...
      addNodeById("2906110183022122665");
      addNodeById("2906110183022122679");
      SReferenceLink invalidLink = LINKS.specializedLink$FRN0;
