...
public class EnumerationDatatypes_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_enumProperties_setfirst() throws Exception {
      ...
      addNodeById("7060593544921942801");
      SNode container1 = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x61fc446ba477f2e1L, "jetbrains.mps.lang.smodelTests.structure.TestEnum_Container"));
      SPropertyOperations.setEnum(container1, PROPS.enumWODefault$Z9n, 0x61fc446ba477f2ddL, "name_1");
      SPropertyOperations.setEnum(container1, PROPS.enumWithDefault$YFl, 0x125bc18df9d40efaL, "name_1");
      ...
      SPropertyOperations.assignEnum(container2, PROPS.enumWODefault$Z9n, SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x55fd055f8f014df2L, "jetbrains.mps.lang.smodelTests.structure.TestEnum_WODefault"), 0x61fc446ba477f2ddL, "name_1"));
      SPropertyOperations.assignEnum(container2, PROPS.enumWithDefault$YFl, SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x55fd055f8f014dbfL, "jetbrains.mps.lang.smodelTests.structure.TestEnum_WithDefault"), 0x125bc18df9d40efaL, "name_1"));
    ...
    public void test_enumProperties_remove() throws Exception {
      ...
      SPropertyOperations.remove(container1, PROPS.enumWODefault$Z9n);
      SPropertyOperations.remove(container1, PROPS.enumWithDefault$YFl);

      SNode container2 = SNodeOperations.copyNode(container_proto);
      SPropertyOperations.assignEnum(container2, PROPS.enumWODefault$Z9n, null);
      SPropertyOperations.assignEnum(container2, PROPS.enumWithDefault$YFl, null);
    ...
    public void test_init(SNode container) {
      Assert.assertSame(SPropertyOperations.getEnum(container, PROPS.enumWODefault$Z9n), null);
      Assert.assertSame(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$YFl), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x55fd055f8f014dbfL, "jetbrains.mps.lang.smodelTests.structure.TestEnum_WithDefault"), 0x125bc18df9d40efbL, "name_2_def"));

      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$Z9n), 0x61fc446ba477f2ddL));
      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$Z9n), 0x61fc446ba477f2deL));

      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$YFl), 0x125bc18df9d40efaL));
      Assert.assertTrue(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$YFl), 0x125bc18df9d40efbL));
    }
    public void test_setfirst(SNode container) {
      Assert.assertSame(SPropertyOperations.getEnum(container, PROPS.enumWODefault$Z9n), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x55fd055f8f014df2L, "jetbrains.mps.lang.smodelTests.structure.TestEnum_WODefault"), 0x61fc446ba477f2ddL, "name_1"));
      Assert.assertSame(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$YFl), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x55fd055f8f014dbfL, "jetbrains.mps.lang.smodelTests.structure.TestEnum_WithDefault"), 0x125bc18df9d40efaL, "name_1"));

      Assert.assertTrue(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$Z9n), 0x61fc446ba477f2ddL));
      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$Z9n), 0x61fc446ba477f2deL));

      Assert.assertTrue(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$YFl), 0x125bc18df9d40efaL));
      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$YFl), 0x125bc18df9d40efbL));
    }
  }
