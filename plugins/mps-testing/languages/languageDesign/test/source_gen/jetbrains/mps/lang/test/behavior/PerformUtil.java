...
public class PerformUtil {
  ...
  public static void checkNodeHasMessageWithStatus(SNode operation, MessageStatus messageStatus) {
    ...
    Assert.assertTrue(errorString, (boolean) ICheckForExpectedRule__BehaviorDescriptor.hasExpectedRuleMessage_id4CT6QR8SJl8.invoke(operation, errorReporters, SNodeOperations.getModel(nodeToCheck).getRepository()));
  }
