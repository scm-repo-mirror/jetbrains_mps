...
/*package*/ class CheckDataFlowOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createNonEmptyProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_5hyllo.PropertyAttribute_d001db89);
  ...
  private static final class AUX_5hyllo {
