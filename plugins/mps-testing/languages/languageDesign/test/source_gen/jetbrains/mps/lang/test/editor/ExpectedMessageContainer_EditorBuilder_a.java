...
/*package*/ class ExpectedMessageContainer_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ExpectedMessageContainer_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_if1x99_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_if1x99_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_if1x99_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.EDITABLE, false);
    style.set(StyleAttributes.SELECTABLE, false);
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.text$wLjw;
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "\"");
    editorCell.setCellId("Constant_if1x99_d0");
    Style style = new StyleImpl();
