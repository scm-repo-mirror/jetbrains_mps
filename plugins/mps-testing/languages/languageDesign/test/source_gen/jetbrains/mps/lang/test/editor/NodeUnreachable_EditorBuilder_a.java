...
/*package*/ class NodeUnreachable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createNonEmptyProperty_0() {
    ...
    try {
      ...
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_djld9d.PropertyAttribute_d001db89);
  ...
  private static final class AUX_djld9d {
