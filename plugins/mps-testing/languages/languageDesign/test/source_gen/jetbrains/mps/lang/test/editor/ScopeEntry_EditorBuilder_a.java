...
/*package*/ class ScopeEntry_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.kind$A3Ar;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.kind$A3Ar);
    }
  ...
  private static class nodesListHandler_8oft47_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(nodesListHandler_8oft47_d0.this.getNode(), LINKS.nodes$tFru));
      try {
