...
/*package*/ class ScopeEntry_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.kind$rJB5;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.kind$rJB5);
    }
  ...
  private static class nodesListHandler_8oft47_d0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.nodes$o2jy;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.NamedNodeReference$BZ;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(nodesListHandler_8oft47_d0.this.getNode(), LINKS.nodes$o2jy));
      try {
