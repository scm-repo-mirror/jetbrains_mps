...
/*package*/ class LinkVCSDescriptor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.lnk$DMeS;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.lnk$DMeS);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new strategySingleRoleHandler_o465bc_c0(myNode, LINKS.strategy$bEBL, getEditorContext());
