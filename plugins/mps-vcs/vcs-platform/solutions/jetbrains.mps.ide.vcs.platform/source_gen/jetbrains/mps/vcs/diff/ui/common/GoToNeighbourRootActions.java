...
@GeneratedClass(nodeId = "4652592318748340352", model = "r:07568eb8-30c0-4bb3-9dcb-50ee4b8de59a(jetbrains.mps.vcs.diff.ui.common)")
public abstract class GoToNeighbourRootActions {
  ...
  private class TheAction extends BaseAction implements DumbAware {
    ...
    public TheAction(boolean next) {
      super("Go to " + ((next ? "Next" : "Previous")) + " Root", null, (next ? AllIcons.Actions.Forward : AllIcons.Actions.Back));
