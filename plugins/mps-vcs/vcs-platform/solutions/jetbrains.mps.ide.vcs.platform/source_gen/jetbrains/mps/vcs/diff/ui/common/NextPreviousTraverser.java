...
public class NextPreviousTraverser {
  private static final Logger LOG = Logger.getLogger(NextPreviousTraverser.class);
  ...
  private synchronized void goToY(int y) {
    ...
    if (editorCell != null) {
      ...
      if (LOG.isWarningLevel()) {
        LOG.warning(String.format("Could not find cell for coordinates (1, %d), editor for concept %s", y, qualifiedName));
      }
    }
  }
