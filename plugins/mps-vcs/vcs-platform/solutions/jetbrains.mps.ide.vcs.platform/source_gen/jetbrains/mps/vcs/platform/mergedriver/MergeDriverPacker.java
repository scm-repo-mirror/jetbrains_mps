...
public abstract class MergeDriverPacker {
  ...
  private static final Iterable<String> ideaLibJars = Arrays.asList("asm-all-7.0.1.jar", "xstream-1.4.11.1.jar", "guava-28.2-jre.jar", "jdom.jar", "log4j.jar", "trove4j.jar", "annotations.jar");
