...
public class ClosureLiteraltargetIface_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    private static SNode _quotation_createNode_u745oo_b0a4a3i() {
      ...
      quotedNode_1.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_1, facade.createModelReference("r:115773d0-1d8a-4cef-9476-a19eb511afc3(jetbrains.mps.closures.test.model)"), facade.createNodeId("7178287329507546171")));
      ...
      quotedNode_6.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_6, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~String")));
      quotedNode_4.addChild(LINKS.bound$7gX0, quotedNode_6);
      ...
      quotedNode_7.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_7, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Integer")));
      quotedNode_5.addChild(LINKS.bound$uJC_, quotedNode_7);
      quotedNode_3.addChild(LINKS.bound$uJC_, quotedNode_5);
    ...
    private static SNode _quotation_createNode_u745oo_b0a4a4i() {
      ...
      quotedNode_4.setReference(LINKS.classifier$pQ_R, SReference.create(LINKS.classifier$pQ_R, quotedNode_4, facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~String")));
      quotedNode_2.addChild(LINKS.bound$7gX0, quotedNode_4);
      quotedNode_1.addChild(LINKS.parameter$dQne, quotedNode_2);
