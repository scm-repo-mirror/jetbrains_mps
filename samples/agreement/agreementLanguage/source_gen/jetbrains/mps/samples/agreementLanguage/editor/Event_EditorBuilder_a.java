...
/*package*/ class Event_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.type$Rs9R;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.type$Rs9R);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.taxable$kFqJ;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private static class postingRuleListHandler_ymj9mh_b1a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.postingRule$W$ob;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.PostingRuleTemporalProperty$BT;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(postingRuleListHandler_ymj9mh_b1a.this.getNode(), LINKS.postingRule$W$ob));
      try {
