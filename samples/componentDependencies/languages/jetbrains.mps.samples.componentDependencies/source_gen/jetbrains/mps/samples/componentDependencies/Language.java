...
import jetbrains.mps.samples.componentDependencies.constraints.GeneratedRulesConstraintsAspect;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("3066bc09-2438-4300-a936-5bd59917ae9b");
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == BehaviorAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.samples.componentDependencies.behavior.BehaviorAspectDescriptor());
    }
    if (aspectClass == ConstraintsAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.samples.componentDependencies.constraints.ConstraintsAspectDescriptor());
    }
    if (aspectClass == EditorAspectDescriptor.class) {
      return aspectClass.cast(new EditorAspectDescriptorImpl());
    }
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.samples.componentDependencies.structure.StructureAspectDescriptor());
    }
