...
/*package*/ class ReaderConfiguration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class mappingListHandler_vfprw_b2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.mapping$LxhT;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Mapping$wv;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(mappingListHandler_vfprw_b2a.this.getNode(), LINKS.mapping$LxhT));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Mapping$wv = MetaAdapterFactory.getConcept(0x89e26c5bfc34a60L, 0x9953f68169a4608aL, 0x103f6aabc30L, "jetbrains.mps.samples.readerConfigLanguage.structure.Mapping");
  }
