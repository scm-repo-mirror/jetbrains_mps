...
/*package*/ class AndOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftOperandSingleRoleHandler_1vjwda_a0(myNode, LINKS.leftOperand$yXYE, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightOperandSingleRoleHandler_1vjwda_c0(myNode, LINKS.rightOperand$Wy7J, getEditorContext());
    return provider.createCell();
  }
