...
the Editor cookbook (https://www.jetbrains.com/help/mps/2020.2/editor-cookbook.html). It implements a simple language for specifying drawing commands (line, rectangle):
