...
public final class Component__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String fullName_id4Vpsm2KEoLo(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SNodeOperations.as(SNodeOperations.getParent(__thisNode__), CONCEPTS.INamedConcept$nV), PROPS.name$tAp1) + "->" + SPropertyOperations.getString(__thisNode__, PROPS.name$tAp1);
  }
