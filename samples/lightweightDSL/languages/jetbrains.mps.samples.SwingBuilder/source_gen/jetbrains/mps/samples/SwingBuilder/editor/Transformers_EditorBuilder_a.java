...
/*package*/ class Transformers_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class elementsListHandler_a7oxnt_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(elementsListHandler_a7oxnt_b0.this.getNode(), LINKS.elements$znNT));
      try {
