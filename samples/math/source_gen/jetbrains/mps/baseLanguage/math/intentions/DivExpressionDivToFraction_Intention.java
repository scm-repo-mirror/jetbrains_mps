...
public final class DivExpressionDivToFraction_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      SNodeOperations.replaceWithAnother(node, _quotation_createNode_drx02_a0a0a0(SLinkOperations.getTarget(node, LINKS.leftExpression$rxLZ), SLinkOperations.getTarget(node, LINKS.rightExpression$rxBl)));
    }
    @Override
  ...
  private static SNode _quotation_createNode_drx02_a0a0a0(Object parameter_1, Object parameter_2) {
    ...
    if (quotedNode_4 != null) {
      quotedNode_3.addChild(LINKS.numerator$a$pv, SNodeOperations.copyIfNecessary(quotedNode_4));
    }
    quotedNode_5 = (SNode) parameter_2;
    if (quotedNode_5 != null) {
      quotedNode_3.addChild(LINKS.denominator$e40P, SNodeOperations.copyIfNecessary(quotedNode_5));
    }
    return quotedNode_3;
  }
