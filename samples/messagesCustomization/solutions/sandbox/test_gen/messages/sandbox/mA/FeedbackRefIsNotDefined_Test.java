...
public class FeedbackRefIsNotDefined_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(FeedbackRefIsNotDefined_Test.class).projectPath("${mps_home}").modelRef("r:eb16dd70-ac3a-40ca-8c61-d7f237615dbf(messages.sandbox.mA@tests)").reopenProject(false).build());
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    protected void initTestNodes() {
      prepareTestNodes("7019192671317896965");
    }

    public void test_NodeErrorCheck7019192671317896977() throws Exception {
      initTestNodes();
      runWithinCommand(() -> {
        SNode nodeToCheck = getNodeById("7019192671317896966");
