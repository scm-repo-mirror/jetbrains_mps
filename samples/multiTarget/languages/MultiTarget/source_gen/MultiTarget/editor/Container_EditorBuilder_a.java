...
/*package*/ class Container_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class membersListHandler_xjnu6t_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(membersListHandler_xjnu6t_c0.this.getNode(), LINKS.members$4RHX));
      try {
