...
/*package*/ class Workflow_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.presentation$ORIt;
  ...
  private Iterable<String> getEditorHints0() {
    return (SEnumOperations.isMember(SPropertyOperations.getEnum(myNode, PROPS.presentation$ORIt), 0x3301f82dc7d4d8ffL) ? ListSequence.fromListAndArray(new ArrayList<String>(), "jetbrains.mps.samples.multipleProjections.requestTracking.editor.WorkflowPresentations.tabular") : Collections.<String>emptyList());
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new stateMachineSingleRoleHandler_yhw0dy_a3a(myNode, LINKS.stateMachine$veUD, getEditorContext());
  ...
  private static class stateMachineSingleRoleHandler_yhw0dy_a3a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.stateMachine$veUD, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.stateMachine$veUD, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.stateMachine$veUD);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
      editorCell.getStyle().putAll(style);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.stateMachine$veUD));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink stateMachine$veUD = MetaAdapterFactory.getContainmentLink(0x8d18a45bac7e4d84L, 0xa53975f1d720b09bL, 0x3301f82dc7d2e4f6L, 0x3301f82dc7d2e50fL, "stateMachine");
  }
}
