...
/*package*/ class Note_compact_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class categoryListHandler_1qvl6j_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(categoryListHandler_1qvl6j_d0.this.getNode(), LINKS.category$vQBt));
      try {
  ...
  private static class partsListHandler_1qvl6j_f0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(partsListHandler_1qvl6j_f0.this.getNode(), LINKS.parts$vZk0));
      try {
        EditorCell emptyCell = null;
