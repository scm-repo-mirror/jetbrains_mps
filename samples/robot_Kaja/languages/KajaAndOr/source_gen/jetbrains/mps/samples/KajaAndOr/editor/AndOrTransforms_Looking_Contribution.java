...
public class AndOrTransforms_Looking_Contribution extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Param_tmm9j9_a0(), AUX_tmm9j9.LogicalExpression_64fb6940));
    }
    return result;
  }
  ...
  private class TMP_Param_tmm9j9_a0 extends ParameterizedMenuPart<SConcept, TransformationMenuItem, TransformationMenuContext> {
    ...
    protected Iterable<? extends SConcept> getParameters(TransformationMenuContext _context) {
      return ListSequence.fromList(SConceptOperations.getAllSubConcepts2(AUX_tmm9j9.LogicalOperator_689b9df9, _context.getModel())).where(new IWhereFilter<SConcept>() {
    ...
    private class TMP_Action_tmm9j9_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem, ConstraintsVerifiableActionItem {
        ...
        public SAbstractConcept getOutputConcept() {
          return AUX_tmm9j9.LogicalExpression_64fb6940;
        }
        @Override
        ...
        public void customize(String pattern, EditorMenuItemStyle style) {
          ...
          SAbstractConcept outputConcept = AUX_tmm9j9.LogicalExpression_64fb6940;
  ...
  private static final class AUX_tmm9j9 {
