...
public class Require_Constraints extends BaseConstraintsDescriptor {
  public Require_Constraints() {
    super(AUX_iz8172.Require_9cfb5771);
  }
  ...
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(MetaAdapterFactory.getReferenceLink(0x49a08c51fe543ccL, 0xbd998b46d641d7f5L, 0x3cfcda239f1a1049L, 0x3cfcda239f1a104aL, "library"), this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            final Iterable<SNode> libraries = ListSequence.fromList(SModelOperations.rootsIncludingImported(SNodeOperations.getModel(_context.getContextNode()), AUX_iz8172.Library_9cea916e)).where(new IWhereFilter<SNode>() {
              public boolean accept(final SNode library) {
                return ListSequence.fromList(SNodeOperations.getNodeDescendants(SNodeOperations.getNodeAncestor(_context.getContextNode(), AUX_iz8172.Script_a5f03f85, true, false), AUX_iz8172.Require_9cfb5771, false, new SAbstractConcept[]{})).where(new IWhereFilter<SNode>() {
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return SNodeOperations.isInstanceOf(parentNode, AUX_iz8172.CommandList_68ab082b) && SNodeOperations.isInstanceOf(SNodeOperations.getParent(parentNode), AUX_iz8172.Script_a5f03f85);
  }
  ...
  private static final class AUX_iz8172 {
