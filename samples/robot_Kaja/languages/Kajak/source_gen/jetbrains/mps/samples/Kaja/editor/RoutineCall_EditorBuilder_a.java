...
/*package*/ class RoutineCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_wwx4md_a1a() {
    return SNodeOperations.getNodeAncestor(SLinkOperations.getTarget(myNode, MetaAdapterFactory.getReferenceLink(0x49a08c51fe543ccL, 0xbd998b46d641d7f5L, 0x2de971c785ed6f92L, 0x2de971c785ede3ccL, "definition")), AUX_fajayx.Library_9cea916e, false, false) != null;
  }
  private EditorCell createRefCell_0() {
    ...
    Iterable<SNode> referenceAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_fajayx.LinkAttribute_d001db6f);
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        ...
        setCellContext(editorCell);
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), AUX_fajayx.PropertyAttribute_d001db89);
  ...
  private static final class AUX_fajayx {
