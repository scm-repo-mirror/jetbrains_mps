...
public final class MoneyLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getVariableExpectedName_idhEwJgm_(@NotNull SNode __thisNode__) {
    String text = MoneyLiteral__BehaviorDescriptor.convertAmountAdvanced_idx3u75dl$Hd.invoke(__thisNode__, ((int) SPropertyOperations.getInteger(__thisNode__, PROPS.amount$Du5z)));
    text += NameUtil.pluralize(NameUtil.capitalize(NameUtil.decapitalize(SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.unit$WeR0), PROPS.name$lA7v))));
    return text;
  }
