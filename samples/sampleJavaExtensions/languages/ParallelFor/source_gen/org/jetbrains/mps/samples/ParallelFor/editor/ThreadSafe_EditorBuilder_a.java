...
/*package*/ class ThreadSafe_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public ThreadSafe_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "@thread safe");
