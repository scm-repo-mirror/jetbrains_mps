...
public final class MarkStaticMethodCallAsThreadSafe_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute(AUX_ecgoew.ThreadSafe_dcd8a07b)) == null;
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      AttributeOperations.setAttribute(node, new IAttributeDescriptor.NodeAttribute(AUX_ecgoew.ThreadSafe_dcd8a07b), SNodeFactoryOperations.createNewNode(AUX_ecgoew.ThreadSafe_dcd8a07b, null));
    }
    @Override
  ...
  private static final class AUX_ecgoew {
