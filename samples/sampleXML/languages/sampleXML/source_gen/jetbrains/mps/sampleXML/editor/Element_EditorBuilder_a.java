...
/*package*/ class Element_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class attributeListHandler_76r4mg_c0a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.attribute$_Zl0;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Attribute$Qo;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(attributeListHandler_76r4mg_c0a.this.getNode(), LINKS.attribute$_Zl0));
      try {
  ...
  private static class contentListHandler_76r4mg_b1a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.content$_Zlv;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ElementPart$yW;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentListHandler_76r4mg_b1a.this.getNode(), LINKS.content$_Zlv));
      try {
        EditorCell emptyCell = null;
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Attribute$Qo = MetaAdapterFactory.getConcept(0x772f6dcd8c0d48f7L, 0x869c908e036f7c8eL, 0x11d45f8a8a1L, "jetbrains.mps.sampleXML.structure.Attribute");
    /*package*/ static final SConcept ElementPart$yW = MetaAdapterFactory.getConcept(0x772f6dcd8c0d48f7L, 0x869c908e036f7c8eL, 0x11d45f8a8beL, "jetbrains.mps.sampleXML.structure.ElementPart");
  }
