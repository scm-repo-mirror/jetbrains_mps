...
/*package*/ class Canvas_ScenePreview_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class shapesListHandler_3bcydw_a2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.shapes$NwZ7;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Shape$fH;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(shapesListHandler_3bcydw_a2a.this.getNode(), LINKS.shapes$NwZ7));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Shape$fH = MetaAdapterFactory.getConcept(0x16bafbb4c6cd4cc5L, 0x83327c6de8729b3fL, 0x51dcaa29974fc161L, "jetbrains.mps.samples.Shapes.structure.Shape");
  }
