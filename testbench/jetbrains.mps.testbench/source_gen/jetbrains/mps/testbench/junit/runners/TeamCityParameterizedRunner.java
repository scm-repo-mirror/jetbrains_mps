...
public class TeamCityParameterizedRunner extends BaseMpsRunner {
  ...
  public TeamCityParameterizedRunner(Class<?> klass, RunnerBuilder builder) throws Throwable {
    super(klass);
  ...
  private class TestClassRunnerForParameters extends BlockJUnit4ClassRunner {
    ...
    private Object[] computeParams() throws Exception {
      try {
        ...
        throw new Exception(String.format("%s.%s() must return a Collection of arrays.", getTestClass().getName(), TeamCityParameterizedRunner.getParametersMethod(getTestClass()).getName()));
      }
    }
