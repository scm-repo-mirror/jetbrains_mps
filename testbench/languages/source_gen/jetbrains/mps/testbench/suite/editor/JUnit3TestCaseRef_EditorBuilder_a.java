...
/*package*/ class JUnit3TestCaseRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean _StyleParameter_QueryFunction_oadaxc_a0a0() {
    return SPropertyOperations.getBoolean(getNode(), PROPS.muted$NX4p);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.klass$dECA;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.klass$dECA);
    }
