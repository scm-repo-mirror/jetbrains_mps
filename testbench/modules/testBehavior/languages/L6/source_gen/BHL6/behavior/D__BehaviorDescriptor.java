...
public final class D__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int foo1_id5jWiLvujSmw(@NotNull SNode __thisNode__) {
    return ((int) B__BehaviorDescriptor.foo1_id5jWiLvujSmw.invokeSuper(__thisNode__, CONCEPTS.D$6y));
  }
  /*package*/ static int foo2_id5jWiLvujSzJ(@NotNull SNode __thisNode__) {
    return ((int) B__BehaviorDescriptor.foo2_id5jWiLvujSzJ.invokeSuper(__thisNode__, CONCEPTS.D$6y));
  }
  ...
  /*package*/ static int foo5_id1olXtyGAKsY(@NotNull SNode __thisNode__) {
    return ((int) B__BehaviorDescriptor.foo5_id1olXtyGAKsY.invokeSuper(__thisNode__, CONCEPTS.D$6y));
  }
