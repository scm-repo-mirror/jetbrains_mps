...
public class BHTest_Test {
  ...
  public void test_conversion1() throws Exception {
    ...
    a = (int) A__BehaviorDescriptor.conversion1_id3ZhVC3HVCz2.invoke(nodeA, ((float) Float.valueOf(1)));
  ...
  public void test_conversion2() throws Exception {
    ...
    f = (float) A__BehaviorDescriptor.conversion2_id6rioTyS5hVU.invoke(nodeA, ((int) Integer.valueOf(1)));
  ...
  public void test_boxing2() throws Exception {
    ...
    Assert.assertSame(1, (int) A__BehaviorDescriptor.boxing2_id95AegakrCe.invoke(nodeA, Integer.valueOf(1)));
  }
  @Test
  ...
  public void test_parameterTypes() throws Exception {
    ...
    Assert.assertSame(TestResults.NOT_SPECIFIED_RETURN_VALUE, (int) BHL7.behavior.C__BehaviorDescriptor.argTypeResolve_id1hQsMcvxKXP.invoke(nodeC, Integer.valueOf(1)));
    Assert.assertSame(TestResults.SPECIFIED_RETURN_VALUE, (int) BHL7.behavior.C__BehaviorDescriptor.argTypeResolve_id1hQsMcvxKQo.invoke(nodeC, Integer.valueOf(1)));
  }
  @Test
