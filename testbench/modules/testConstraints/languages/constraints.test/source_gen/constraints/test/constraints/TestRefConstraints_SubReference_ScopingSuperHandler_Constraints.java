...
public class TestRefConstraints_SubReference_ScopingSuperHandler_Constraints extends BaseConstraintsDescriptor {
  public TestRefConstraints_SubReference_ScopingSuperHandler_Constraints() {
    super(AUX_mav7ye.TestRefConstraints_SubReference_ScopingSuperHandler_6663a6a6);
  }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            return ListScope.forNamedElements(ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(_context.getContextNode(), AUX_mav7ye.TestRefConstraints_Container_f07b75a7, true, false), MetaAdapterFactory.getContainmentLink(0x2b80057037584c14L, 0x86fb871266fb9d11L, 0x244a306605641cdfL, 0x244a306605641ce3L, "targets"))).where(new IWhereFilter<SNode>() {
  ...
  private static final class AUX_mav7ye {
