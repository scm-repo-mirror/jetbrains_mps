...
public class TestRefConstraints_SubReference_ScopingSuperHandler_Constraints extends BaseConstraintsDescriptor {
  /*package*/ TestRefConstraints_SubReference_ScopingSuperHandler_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.TestRefConstraints_SubReference_ScopingSuperHandler$RU, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.target$Ukdw, container, true, false);
    }
    @Nullable
    @Override
    public ReferenceScopeProvider getScopeProvider() {
      return new BaseScopeProvider() {
        ...
        public SNodeReference getSearchScopeValidatorNode() {
          return new SNodePointer("r:6789573d-c842-4805-bb3b-05fd4fbf786e(constraints.test.constraints)", "2614955748380029706");
        }
        @Override
        public Scope createScope(final ReferenceConstraintsContext _context) {
          return ListScope.forNamedElements(ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(_context.getContextNode(), CONCEPTS.TestRefConstraints_Container$Wp, true, false), LINKS.targets$T$Wx)).where((it) -> SPropertyOperations.getBoolean(it, PROPS.inScope$PWeu)));
        }
      };
    }
  }
