...
public class TestCaseRef_SubstituteMenu extends SubstituteMenuBase {
  ...
  private class SMP_Param_dnvvk3_a extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
    /*package*/ SMP_Param_dnvvk3_a() {
      super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:aed1d11b-73e5-474f-a263-22833310a33f(jetbrains.mps.testbench.suite.editor)", "1741258697587114303")));
    }
    @NotNull
    @Override
