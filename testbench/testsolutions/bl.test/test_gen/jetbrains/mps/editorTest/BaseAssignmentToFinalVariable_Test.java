...
public class BaseAssignmentToFinalVariable_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_NodeCannotAssignValueToFinalCheck5706606249111788699() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedRuleMessageRunnable(nodeToCheck, MessageStatus.ERROR, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "4705425356437995912"), "", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
    ...
    public void test_ErrorMessagesCheck5706606249111739463() throws Exception {
      final SNode nodeToCheck = getRealNodeById("5706606249111739408");
