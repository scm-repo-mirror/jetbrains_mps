...
public class ShowReflectiveEditor_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(ShowReflectiveEditor_Test.class, "${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)", false));
  ...
  /*package*/ static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      ...
      ReflectiveEditorActionsUtil.runReadInEDTAndWait(getEditorComponent(), () -> getEditorComponent().selectNode(getNodeById("897648160455541334")));
