...
public class InlineVariableBinaryInBinaryOnDeclaration_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(InlineVariableBinaryInBinaryOnDeclaration_Test.class).projectPath("${mps_home}").modelRef("r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest@tests)").reopenProject(false).build());
