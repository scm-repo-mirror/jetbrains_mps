...
@MPSLaunch
public class IntroduceFinalFieldConstructorFomVar_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(IntroduceFinalFieldConstructorFomVar_Test.class, "${mps_home}", "r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest@tests)", false));

  public IntroduceFinalFieldConstructorFomVar_Test() {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_IntroduceFinalField() throws Exception {
      ...
      runWithinCommand(() -> {
        ...
        {
          List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), getNodeById("8599380872151057308"));
          List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), getNodeById("8599380872151057327"));
