...
public class FieldCanBeLocalVar_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_NodeFieldCanBeConvertedIntoCheck6923385624929411102() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedRuleMessageRunnable(nodeToCheck, MessageStatus.WARNING, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "6640766779592666289"), "", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
    ...
    public void test_NodeFieldIsAssignedButNeverCheck6923385624927778168() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedRuleMessageRunnable(nodeToCheck, MessageStatus.WARNING, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "7581428506283755712"), "", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
    public void test_ErrorMessagesCheck6640766779615226140() throws Exception {
      final SNode nodeToCheck = getRealNodeById("6640766779615024588");
    ...
    public void test_ErrorMessagesCheck4400998065754588523() throws Exception {
      final SNode nodeToCheck = getRealNodeById("4400998065754588042");
