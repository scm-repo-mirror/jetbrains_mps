...
public class UnexpectedReturnInAnonymousClass_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_UnexpectedReturnInAnonymousClass() throws Exception {
      runWithinCommand(() -> addNodeById("1217271586587"));
      runWithinCommand(() -> {
    ...
    public void test_NodeReturnExpectedErrorCheck6923385624929494145() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedRuleMessageRunnable(nodeToCheck, MessageStatus.ERROR, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1223640343628"), "", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
    public void test_NodeTypeSystemCheck7854334384284976424() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedTypesystemMessageRunnable(nodeToCheck, MessageStatus.ERROR, "Error: int is expected to be returned from the method", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
    ...
    public void test_ErrorMessagesCheck2501421320959199496() throws Exception {
      final SNode nodeToCheck = getRealNodeById("1215444400359");
