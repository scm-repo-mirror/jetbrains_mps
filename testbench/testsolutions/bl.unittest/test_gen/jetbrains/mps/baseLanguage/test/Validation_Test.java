...
public class Validation_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_NodeRecursiveConstructorInvocationCheck6923385624929443716() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedRuleMessageRunnable(nodeToCheck, MessageStatus.ERROR, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "698255809162976968"), "", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
    ...
    public void test_ErrorMessagesCheck7868761255934329326() throws Exception {
      final SNode nodeToCheck = getRealNodeById("7868761255934329296");
    ...
    public void test_NodeIllegalCombinationOfModifiersCheck6923385624927426848() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedRuleMessageRunnable(nodeToCheck, MessageStatus.ERROR, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "7868761255934417558"), "", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
