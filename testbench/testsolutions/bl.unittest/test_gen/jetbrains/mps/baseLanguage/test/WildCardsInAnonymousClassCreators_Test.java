...
public class WildCardsInAnonymousClassCreators_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_ErrorMessagesCheck8187342170694474094() throws Exception {
      final SNode nodeToCheck = getRealNodeById("8187342170694472081");
    ...
    public void test_NodeSupertypeMayNotSpecifyCheck6923385624928216045() throws Exception {
      ...
      runWithinCommand(() -> new CheckExpectedMessageRunnable.CheckExpectedRuleMessageRunnable(nodeToCheck, MessageStatus.ERROR, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "8187342170686443221"), "", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run());
    }
    ...
    public void test_ErrorMessagesCheck8187342170694475514() throws Exception {
      final SNode nodeToCheck = getRealNodeById("8187342170694475499");
    ...
    public void test_ErrorMessagesCheck8187342170694479318() throws Exception {
      final SNode nodeToCheck = getRealNodeById("8187342170694479303");
