...
public class Where_Select_Test1_Test {
  @Test
...
__switch__:
  ...
  public void test__3() throws Exception {
    if (Sequence.IGNORE_NULL_VALUES) {
      ...
      org.junit.Assert.assertSame(3, Sequence.fromIterable(empty).count());
      org.junit.Assert.assertFalse(Sequence.fromIterable(empty).any(new IWhereFilter<String>() {
