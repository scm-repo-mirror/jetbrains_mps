...
public class PlatformCheckbox_SPACE_InImage_Toggles_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(PlatformCheckbox_SPACE_InImage_Toggles_Test.class).projectPath("${mps_home}").modelRef("r:9dd38274-05d8-45ba-a41e-44ac52909443(jetbrains.mps.lang.editor.forms.test@tests)").reopenProject(false).build());
