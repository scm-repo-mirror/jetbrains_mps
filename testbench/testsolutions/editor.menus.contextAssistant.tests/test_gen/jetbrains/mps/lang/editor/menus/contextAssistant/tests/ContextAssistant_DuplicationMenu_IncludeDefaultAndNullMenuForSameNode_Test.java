...
public class ContextAssistant_DuplicationMenu_IncludeDefaultAndNullMenuForSameNode_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(ContextAssistant_DuplicationMenu_IncludeDefaultAndNullMenuForSameNode_Test.class).projectPath("${mps_home}").modelRef("r:5a4d10fc-2567-46c5-982f-547e9102417b(jetbrains.mps.lang.editor.menus.contextAssistant.tests@tests)").reopenProject(false).build());
