...
@MPSLaunch
public class TestCompletionCustomization_ContextMatcher_CustomActionRererenceWithStyling_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(TestCompletionCustomization_ContextMatcher_CustomActionRererenceWithStyling_Test.class, "${mps_home}", "r:e67a2364-cd3f-43c0-b822-e9e7747803fc(jetbrains.mps.lang.editor.menus.style.tests.tests@tests)", false);

  public TestCompletionCustomization_ContextMatcher_CustomActionRererenceWithStyling_Test() {
    super(ourParamCache);
  }
