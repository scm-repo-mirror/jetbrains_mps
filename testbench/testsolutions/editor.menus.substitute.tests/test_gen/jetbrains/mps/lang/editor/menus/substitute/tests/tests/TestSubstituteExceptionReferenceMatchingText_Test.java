...
@MPSLaunch
public class TestSubstituteExceptionReferenceMatchingText_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(TestSubstituteExceptionReferenceMatchingText_Test.class, "${mps_home}", "r:62873c84-7a76-488a-9b84-4e0ffdbec8db(jetbrains.mps.lang.editor.menus.substitute.tests.tests@tests)", false);

  public TestSubstituteExceptionReferenceMatchingText_Test() {
    super(ourParamCache);
  }
  ...
  /*package*/ static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("7153261420284101273", "");
