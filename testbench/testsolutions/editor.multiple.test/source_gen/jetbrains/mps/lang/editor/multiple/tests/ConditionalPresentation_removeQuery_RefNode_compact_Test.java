...
public class ConditionalPresentation_removeQuery_RefNode_compact_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(ConditionalPresentation_removeQuery_RefNode_compact_Test.class).projectPath("${mps_home}").modelRef("r:dbab6746-af91-4594-857e-d38a36667e17(jetbrains.mps.lang.editor.multiple.tests)").reopenProject(false).build());
