...
public class TypeCellInDecisionTable_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(TypeCellInDecisionTable_Test.class).projectPath("${mps_home}").modelRef("r:c09cbf74-c0bb-4531-bd9d-ade611acf77c(jetbrains.mps.lang.editor.table.decTable.test@tests)").reopenProject(false).build());
