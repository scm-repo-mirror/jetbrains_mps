...
public class InsertColumnBeforeFirst_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(InsertColumnBeforeFirst_Test.class).projectPath("${mps_home}").modelRef("r:67b81510-37ee-448c-9923-c51275863bef(jetbrains.mps.lang.editor.table.hierarchycalTable.test@tests)").reopenProject(false).build());
