...
public class TestEditorMenuTraceCellMenuPropertyPostfixValues_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(TestEditorMenuTraceCellMenuPropertyPostfixValues_Test.class, "${mps_home}", "r:f27d9626-8ef5-4cba-bce0-6aa6369f05ff(jetbrains.mps.lang.editor.completion.test)", false));
  ...
  /*package*/ static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      ...
      getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(() -> {
        ...
        }).first(), LINKS.menuDescriptor$ptP$), LINKS.cellMenuPart$jjJD), CONCEPTS.CellMenuPart_PropertyValues$kb)).first()));
      });
    }
  }
