...
public class TestEditorMenuTraceTransformationMenuWrapSubstituteMenu_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(TestEditorMenuTraceTransformationMenuWrapSubstituteMenu_Test.class, "${mps_home}", "r:f27d9626-8ef5-4cba-bce0-6aa6369f05ff(jetbrains.mps.lang.editor.completion.test)", false));
  ...
  /*package*/ static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      ...
      getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(() -> {
        ...
        SNode sm = EditorMenuTraceTestUtil.substMenuNode(new SNodePointer("r:12055fd0-2d7f-4ac3-93ec-28bb09579a63(jetbrains.mps.lang.editor.editorTest.editor)", "913276302143982464"), getEditorComponent());
        ...
        SNodeReference transformAction = SNodeOperations.getPointer(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(sm, LINKS.parts$yGO4), CONCEPTS.SubstituteMenuPart_Action$RY)).first());
        SNodeReference wrapSubstituteMenuPart = SNodeOperations.getPointer(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(ListSequence.fromList(SLinkOperations.getChildren(tm, LINKS.sections$GXaM)).first(), LINKS.parts$m99D), CONCEPTS.TransformationMenuPart_WrapSubstituteMenu$qC)).first());
