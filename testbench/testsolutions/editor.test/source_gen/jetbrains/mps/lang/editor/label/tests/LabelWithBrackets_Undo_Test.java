...
public class LabelWithBrackets_Undo_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(LabelWithBrackets_Undo_Test.class).projectPath("${mps_home}").modelRef("r:40a702b4-7737-42f4-8412-0355208396f3(jetbrains.mps.lang.editor.label.tests)").reopenProject(false).build());
