    ...
    public void testMethodImpl() throws Exception {
      ...
      getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(new Runnable() {
        public void run() {
          ...
          SNode priority = ListSequence.fromList(SLinkOperations.getChildren(root, LINKS.node$_a4Q)).getElement(1);
          SNode innerLeaf = ListSequence.fromList(SLinkOperations.getChildren(priority, LINKS.node$_a4Q)).getElement(0);
          SNode ignore = ListSequence.fromList(SLinkOperations.getChildren(priority, LINKS.node$_a4Q)).getElement(1);
          SNode ignoreLeaf = ListSequence.fromList(SLinkOperations.getChildren(ignore, LINKS.node$_a4Q)).getElement(0);
