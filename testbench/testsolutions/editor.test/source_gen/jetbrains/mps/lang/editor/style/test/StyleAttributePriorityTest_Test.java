    ...
    public void testMethodImpl() throws Exception {
      ...
      getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(new Runnable() {
        public void run() {
          ...
          SNode priority = ListSequence.fromList(SLinkOperations.getChildren(root, LINKS.node$ZSma)).getElement(1);
          SNode innerLeaf = ListSequence.fromList(SLinkOperations.getChildren(priority, LINKS.node$ZSma)).getElement(0);
          SNode ignore = ListSequence.fromList(SLinkOperations.getChildren(priority, LINKS.node$ZSma)).getElement(1);
          SNode ignoreLeaf = ListSequence.fromList(SLinkOperations.getChildren(ignore, LINKS.node$ZSma)).getElement(0);
