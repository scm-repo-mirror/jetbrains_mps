...
<model ref="r:22217853-e34a-44ea-be62-4ef079cfd49d(jetbrains.mps.transformation.test.inputModels.test_ArgsInTemplateCall)">
  ...
  <node concept="15_jI_" id="bxo68MyhKP">
    ...
    <node concept="3ABbii" id="bxo68MyhKR" role="15EZgy">
      <property role="TrG5h" value="NodeB" />
    </node>
    <node concept="3AMHlM" id="bxo68MyhKU" role="15EZgy">
