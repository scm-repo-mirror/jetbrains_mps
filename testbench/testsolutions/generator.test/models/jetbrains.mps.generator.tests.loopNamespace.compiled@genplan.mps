...
<model ref="r:ebe7fc5d-341b-4ea7-bab7-c3d9181e15bf(jetbrains.mps.generator.tests.loopNamespace.compiled@genplan)">
  ...
  <node concept="2VgMpV" id="2k$Qx00KXiL">
    ...
    <node concept="3uMcMo" id="2k$Qx00KXiN" role="2VgMA7">
      <node concept="3uMdn$" id="1krK_I11rh$" role="3uOsAP">
        <node concept="20RdaH" id="1krK_I11rh_" role="3uMdmt">
          <property role="20Rdg5" value="273843fe-40bc-4b62-bb23-5190701dce0b" />
          <property role="20Rdg7" value="jetbrains.mps.transformation.test.inputLang.generator05" />
        </node>
      </node>
    </node>
  </node>
