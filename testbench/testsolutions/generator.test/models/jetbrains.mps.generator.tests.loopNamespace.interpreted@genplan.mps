...
<model ref="r:c24deeeb-ded8-41ae-8a08-024de72deee4(jetbrains.mps.generator.tests.loopNamespace.interpreted@genplan)">
  ...
  <node concept="2VgMpV" id="2k$Qx00KXiE">
    ...
    <node concept="3uMcMo" id="2k$Qx00KXiG" role="2VgMA7">
      <node concept="lQKw0" id="21u4r8PExa$" role="3uOsAP">
        <node concept="1dCxOk" id="21u4r8PExa_" role="lQKw6">
          <property role="1XweGW" value="6e3ea6c0-1613-4430-8c64-995c8351a1bf" />
          <property role="1XxBO9" value="jetbrains.mps.transformation.test.inputLang.generator04" />
        </node>
      </node>
    </node>
  </node>
