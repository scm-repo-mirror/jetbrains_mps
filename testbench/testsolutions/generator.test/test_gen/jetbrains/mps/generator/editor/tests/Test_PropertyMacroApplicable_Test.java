...
public class Test_PropertyMacroApplicable_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(Test_PropertyMacroApplicable_Test.class).projectPath("${mps_home}").modelRef("r:cbdcb51c-64a3-4f95-8704-5b9a754c9773(jetbrains.mps.generator.editor.tests@tests)").reopenProject(false).build());
