...
public class LoopNamespaceAccessVariable extends BaseGeneratorTest {
  ...
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(LoopNamespaceAccessVariable.class).projectPath(null).modelRef("r:91b523aa-e27e-44c7-a6e4-872f396e361b(jetbrains.mps.generator.tests.loopNamespace@tests)").reopenProject(null).build());
