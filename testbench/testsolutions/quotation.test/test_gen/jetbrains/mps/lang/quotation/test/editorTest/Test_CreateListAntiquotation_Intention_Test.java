...
public class Test_CreateListAntiquotation_Intention_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(Test_CreateListAntiquotation_Intention_Test.class).projectPath("${mps_home}").modelRef("r:05c4fa32-3688-4db6-b828-4373b1de41d9(jetbrains.mps.lang.quotation.test.editorTest@tests)").reopenProject(false).build());
