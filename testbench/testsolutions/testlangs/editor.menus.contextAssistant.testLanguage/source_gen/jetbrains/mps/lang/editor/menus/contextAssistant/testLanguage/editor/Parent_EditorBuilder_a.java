...
/*package*/ class Parent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class childrenListHandler_vx0ep_a1b0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.children$Wkwv;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Child$IS;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(childrenListHandler_vx0ep_a1b0.this.getNode(), LINKS.children$Wkwv));
      try {
    ...
    private EditorCell createConstant_2() {
      ...
      editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.Parent$qu, "jetbrains.mps.lang.editor.menus.contextAssistant.testLanguage.editor.ParentNamedMenu"));
      editorCell.setDefaultText("");
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Parent$qu = MetaAdapterFactory.getConcept(0x9a629f9aabc94c29L, 0xb1b8db7f349f7fbcL, 0x4d6a8b533e60aa4dL, "jetbrains.mps.lang.editor.menus.contextAssistant.testLanguage.structure.Parent");
  }

  private static final class LINKS {
    /*package*/ static final SContainmentLink children$Wkwv = MetaAdapterFactory.getContainmentLink(0x9a629f9aabc94c29L, 0xb1b8db7f349f7fbcL, 0x4d6a8b533e60aa4dL, 0x4d6a8b533e60aa58L, "children");
  }
}
