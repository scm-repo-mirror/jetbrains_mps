...
/*package*/ class TestSideTransform_NodeWithReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.reference$JwFv;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.reference$JwFv);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.reference$JwFv);
    }
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.TestSideTransform_NodeWithReference$DE, "jetbrains.mps.lang.editor.menus.sideTransform.testLanguage.editor.TestSideTransform_NodeWithReference_CustomActions"));
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept TestSideTransform_NodeWithReference$DE = MetaAdapterFactory.getConcept(0x14a4b50159f64c39L, 0xb5de4a5d59477831L, 0x38c885e4a7fcfbb8L, "jetbrains.mps.lang.editor.menus.sideTransform.testLanguage.structure.TestSideTransform_NodeWithReference");
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink reference$JwFv = MetaAdapterFactory.getReferenceLink(0x14a4b50159f64c39L, 0xb5de4a5d59477831L, 0x38c885e4a7fcfbb8L, 0x38c885e4a7fcfbbaL, "reference");
  }
}
