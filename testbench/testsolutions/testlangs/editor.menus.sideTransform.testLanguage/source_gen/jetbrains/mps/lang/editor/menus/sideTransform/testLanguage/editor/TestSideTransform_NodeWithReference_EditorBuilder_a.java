...
/*package*/ class TestSideTransform_NodeWithReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.reference$P41;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.reference$P41);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.reference$P41);
    }
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink reference$P41 = MetaAdapterFactory.getReferenceLink(0x14a4b50159f64c39L, 0xb5de4a5d59477831L, 0x38c885e4a7fcfbb8L, 0x38c885e4a7fcfbbaL, "reference");
  }
}
