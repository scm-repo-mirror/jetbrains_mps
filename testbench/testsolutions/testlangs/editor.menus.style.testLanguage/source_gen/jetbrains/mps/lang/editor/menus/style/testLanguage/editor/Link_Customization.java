...
public class Link_Customization implements EditorMenuItemCustomizer {
  ...
  private static class Link_CustomizationSpecific implements EditorMenuItemCustomizer {
    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemModifyingConceptContextMatcher(AUX_axyluv.TestCompletionCustomization_ParentTestContextMatcher_5aa6e2a6) {
        ...
        protected boolean doMatchesContext_(SNode contextNode, SContainmentLink containmentLink, SReferenceLink referenceLink, SProperty property) {
          return Objects.equals(containmentLink, MetaAdapterFactory.getContainmentLink(0xb4a430be169648bfL, 0xbb724333242e590cL, 0x49b11095109798c7L, 0x406156e80eedf547L, "childInMatchingLink"));
        }
    ...
    private void customize_(SNode contextNode, EditorMenuItemStyle style, CompletionItemInformation itemInformation) {
      ...
      if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), AUX_axyluv.TestCompletionCustomization_ChildInLinkWithPriority_159d112e)) {
  ...
  private static final class AUX_axyluv {
