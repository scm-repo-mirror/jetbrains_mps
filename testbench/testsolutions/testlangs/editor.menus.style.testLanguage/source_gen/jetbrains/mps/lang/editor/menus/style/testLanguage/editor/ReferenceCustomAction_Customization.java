...
public class ReferenceCustomAction_Customization implements EditorMenuItemCustomizer {
  ...
  private static class ReferenceCustomAction_CustomizationSpecific implements EditorMenuItemCustomizer {
    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemModifyingConceptContextMatcher(AUX_pikemb.TestCompletionCustomization_ParentTestContextMatcher_5aa6e2a6) {
    ...
    private void customize_(SNode contextNode, EditorMenuItemStyle style, CompletionItemInformation itemInformation) {
      ...
      if (parameterObject instanceof SNode && SNodeOperations.isInstanceOf(((SNode) parameterObject), AUX_pikemb.INamedConcept_8cd7e247) && Objects.equals(SPropertyOperations.getString(((SNode) parameterObject), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")), "b")) {
  ...
  private static final class AUX_pikemb {
