...
public class NamedSubstituteMenu_EmptyCell extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Action_gllbhd_a(), AUX_gllbhd.TestSubstituteChild_ae263a0f));
    return result;
  }
  ...
  private class SMP_Action_gllbhd_a extends SingleItemSubstituteMenuPart {
    ...
    protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
      SMP_Action_gllbhd_a.Item item = new SMP_Action_gllbhd_a.Item(_context);
      String description;
      try {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      public Item(SubstituteMenuContext context) {
        super(AUX_gllbhd.TestSubstituteChild_ae263a0f, context);
        _context = context;
      }
  ...
  private static final class AUX_gllbhd {
