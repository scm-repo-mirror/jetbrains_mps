...
/*package*/ class MultipleEditorsTestChild_compact_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.compactProperty$ghno;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty compactProperty$ghno = MetaAdapterFactory.getProperty(0x7a80051c66e94bfcL, 0x9698b12adfed3d9fL, 0x5c5c8f07ee27f5c1L, 0x5293debe4ce168efL, "compactProperty");
  }
