...
/*package*/ class ActionTestChild1_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class child1ListHandler_ynwskn_c3a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.child1$dQ8b;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ActionTestChild1Child$uv;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(child1ListHandler_ynwskn_c3a.this.getNode(), LINKS.child1$dQ8b));
      try {
