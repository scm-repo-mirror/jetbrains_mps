...
public class DeleteSpaceBetweenWords_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(DeleteSpaceBetweenWords_Test.class).projectPath("${mps_home}").modelRef("r:6cf522f1-8af4-45dd-b0f5-721b6e5caab5(jetbrains.mps.lang.text.test.editor@tests)").reopenProject(false).build());
