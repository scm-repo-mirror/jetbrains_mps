...
public class LanguageProducer {
  private static final Logger LOG = LogManager.getLogger(LanguageProducer.class);
    ...
    for (String aspectId : aspects2create) {
      ...
      if (ad != null && ad.canCreate(language)) {
        ...
        if (LOG.isEnabledFor(Level.WARN)) {
          LOG.warn(String.format("Failed to initialize aspect '%s' for language %s", aspectId, language.getModuleName()));
        }
      }
    }
  }
