...
@GeneratedClass(nodeId = "3858094006307660254", model = "r:00000000-0000-4000-0000-011c895904a4(jetbrains.mps.ide.actions)")
public class FileSystemNewActions_ActionGroup extends GeneratedActionGroup {
  ...
  public FileSystemNewActions_ActionGroup(@NotNull ApplicationPlugin plugin) {
    super("New", ID, plugin);
    setIsInternal(false);
    setPopup(true);
