...
@GeneratedClass(node = "r:00000000-0000-4000-0000-011c895904a4(jetbrains.mps.ide.actions)/1596727503333709182", model = "r:00000000-0000-4000-0000-011c895904a4(jetbrains.mps.ide.actions)")
public class GoToImplementationBehaviorMethod_Action extends BaseAction {
  ...
  public GoToImplementationBehaviorMethod_Action() {
    super("Concept Method Implementation(s)", "", ICON);
