...
@GeneratedClass(nodeId = "1216119398364", model = "r:00000000-0000-4000-0000-011c895904a4(jetbrains.mps.ide.actions)")
public class ShowClassInHierarchy_Action extends BaseAction {
  ...
  private SNode getContextClassifier(final AnActionEvent event) {
    ...
    SNode outerClass = SNodeOperations.cast(SNodeOperations.getNodeAncestorWhereConceptInList(event.getData(MPSCommonDataKeys.NODE), new SAbstractConcept[]{CONCEPTS.ClassConcept$bK, CONCEPTS.Interface$db}, true, false), CONCEPTS.Classifier$Ix);
    return outerClass;
  }
