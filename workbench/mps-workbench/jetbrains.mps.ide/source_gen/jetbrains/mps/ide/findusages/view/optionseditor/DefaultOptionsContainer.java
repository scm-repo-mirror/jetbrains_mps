...
public class DefaultOptionsContainer {
  ...
  private FindUsagesOptions createDefaultSearchOptions() {
    ScopeOptions scopeOptions = new ScopeOptions(((RuntimeFlags.isInternalMode() ? ScopeOptions.ScopeType.GLOBAL : ScopeOptions.ScopeType.PROJECT)), ScopeOptions.DEFAULT_VALUE, ScopeOptions.DEFAULT_VALUE);
