...
public abstract class AbstractHierarchyViewState {
  ...
  protected DefaultActionGroup createButtonsGroup() {
    ...
    return ActionUtils.groupFromActions(childrenAction, parentAction, thisModelAction, generatorModelsAction, expandAllAction, collapseAllAction, refreshAction, new CloseAction(tool));
  }
