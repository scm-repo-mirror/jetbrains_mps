 ...
 */
public class GeneratorCacheComponent {

  private File generatorCaches;

  public static GeneratorCacheComponent getInstance() {
    return ApplicationManager.getApplication().getService(GeneratorCacheComponent.class);
  }
  ...
  public GenerationCacheContainer getCache() {
    if (generatorCaches == null) {
      ...
      if(!generatorCaches.exists() && !generatorCaches.mkdirs()) {
        throw new IllegalStateException("Can't create cache dir +" + generatorCaches.getPath());
      }
    }
