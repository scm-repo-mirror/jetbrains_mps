...
public class MPSFavoriteModel extends MPSFavoriteNodeBase<SModelReference> {

  private SModelReference mySModelReference;

  public MPSFavoriteModel(Project project, @NotNull SModelReference value,
                   ViewSettings viewSettings) {
    super(project, value, viewSettings);

    mySModelReference = value;
    myPresentableText = value.getName().getLongName();
